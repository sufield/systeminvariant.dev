...
## Per-Command I/O[​](#per-command-io "Direct link to Per-Command I/O")
...
### Command Data Flows[​](#command-data-flows "Direct link to Command Data Flows")
...
## Overwrite Protection[​](#overwrite-protection "Direct link to Overwrite Protection")
...
## Symlink Protection[​](#symlink-protection "Direct link to Symlink Protection")
...
## Path Normalization[​](#path-normalization "Direct link to Path Normalization")
