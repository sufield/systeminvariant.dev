...
## 1. Offline — No Network Access[​](#1-offline--no-network-access "Direct link to 1. Offline — No Network Access")
...
## 2. No Credentials[​](#2-no-credentials "Direct link to 2. No Credentials")
...
## 3. Determinism[​](#3-determinism "Direct link to 3. Determinism")
...
## 4. No Code Execution[​](#4-no-code-execution "Direct link to 4. No Code Execution")
...
## 5. File Output Safety[​](#5-file-output-safety "Direct link to 5. File Output Safety")
...
## 6. Sanitization[​](#6-sanitization "Direct link to 6. Sanitization")
...
## 7. Supply-Chain Integrity[​](#7-supply-chain-integrity "Direct link to 7. Supply-Chain Integrity")
...
For step-by-step verification instructions, see [Verify a Release](/docs/how-to/getting-started/verify-release.md).

## 8. Privileges[​](#8-privileges "Direct link to 8. Privileges")
