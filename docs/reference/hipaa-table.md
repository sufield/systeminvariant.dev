...
See also: [HIPAA per-control CLI evidence](/docs/reference/hipaa-cli.md) for the control-by-control CLI output schemas, and the [HIPAA Compliance how-to](/docs/how-to/compliance/hipaa-compliance.md) for running the HIPAA pack.

## S3 HIPAA pack control spec[​](#s3-hipaa-pack-control-spec "Direct link to S3 HIPAA pack control spec")
...
## CLI output and pass/fail JSON[​](#cli-output-and-passfail-json "Direct link to CLI output and pass/fail JSON")

### HIPAA.ENCRYPT.001 / HIPAA.ENCRYPT.002[​](#hipaaencrypt001--hipaaencrypt002 "Direct link to HIPAA.ENCRYPT.001 / HIPAA.ENCRYPT.002")

Source: AWS `GetBucketEncryption` says S3 returns the default encryption configuration, and by default buckets have SSE-S3 unless configured otherwise. ([AWS Documentation](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketEncryption.html "GetBucketEncryption - Amazon Simple Storage Service"))
...
### HIPAA.PUBLIC.001[​](#hipaapublic001 "Direct link to HIPAA.PUBLIC.001")

Source: AWS `GetPublicAccessBlock` returns the bucket-level public access block config only, and AWS says effective behavior also depends on account-level settings. ([AWS Documentation](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetPublicAccessBlock.html "GetPublicAccessBlock - Amazon Simple Storage Service"))
...
### HIPAA.TRANSPORT.001[​](#hipaatransport001 "Direct link to HIPAA.TRANSPORT.001")

HIPAA transmission security requires protection against unauthorized access during transmission. ([eCFR](https://www.ecfr.gov/current/title-45/subtitle-A/subchapter-C/part-164/subpart-C/section-164.312 "
eCFR :: 45 CFR 164.312 -- Technical safeguards.
")) AWS supports this with bucket policy conditions, including TLS-related conditions. ([AWS Documentation](https://docs.aws.amazon.com/AmazonS3/latest/userguide/UsingEncryptionInTransit.html "Protecting data in transit with encryption"))
...
### HIPAA.AUDIT.001[​](#hipaaaudit001 "Direct link to HIPAA.AUDIT.001")

HIPAA audit controls require mechanisms that record and examine activity. ([eCFR](https://www.ecfr.gov/current/title-45/subtitle-A/subchapter-C/part-164/subpart-C/section-164.312 "
eCFR :: 45 CFR 164.312 -- Technical safeguards.
")) AWS `get-bucket-logging` returns server access logging status. ([AWS Documentation](https://docs.aws.amazon.com/code-library/latest/ug/s3_example_s3_GetBucketLogging_section.html "Use GetBucketLogging with a CLI"))
...
### HIPAA.AUDIT.002[​](#hipaaaudit002 "Direct link to HIPAA.AUDIT.002")

CloudTrail supports S3 object data events, and `get-event-selectors` exposes whether those selectors are configured. ([AWS Documentation](https://docs.aws.amazon.com/cli/latest/reference/cloudtrail/get-event-selectors.html "get-event-selectors - cloudtrail"))
...
### HIPAA.INTEGRITY.001[​](#hipaaintegrity001 "Direct link to HIPAA.INTEGRITY.001")

HIPAA integrity requires protection against improper alteration or destruction. ([eCFR](https://www.ecfr.gov/current/title-45/subtitle-A/subchapter-C/part-164/subpart-C/section-164.312 "
eCFR :: 45 CFR 164.312 -- Technical safeguards.
")) AWS says `GetBucketVersioning` returns the versioning state and MFA Delete status. ([AWS Documentation](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketVersioning.html "GetBucketVersioning - Amazon Simple Storage Service"))
...
### HIPAA.INTEGRITY.002[​](#hipaaintegrity002 "Direct link to HIPAA.INTEGRITY.002")

AWS says Object Lock uses a write-once-read-many model and prevents deletion or overwrite for a fixed time or indefinitely. It also requires versioning. ([AWS Documentation](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-lock-configure.html "Configuring S3 Object Lock - Amazon Simple Storage Service"))
...
## Not fully provable from bucket-only data[​](#not-fully-provable-from-bucket-only-data "Direct link to Not fully provable from bucket-only data")
...
| HIPAA.REVIEW\.001       | HIPAA requires regular review procedures, not just log collection ([eCFR](https://www.ecfr.gov/current/title-45/subtitle-A/subchapter-C/part-164/subpart-C "&#xA;eCFR :: 45 CFR Part 164 Subpart C -- Security Standards for the Protection of Electronic Protected Health Information&#xA;")) |
...
## Source links[​](#source-links "Direct link to Source links")

* HIPAA technical safeguards: ([eCFR](https://www.ecfr.gov/current/title-45/subtitle-A/subchapter-C/part-164/subpart-C/section-164.312 "
  eCFR :: 45 CFR 164.312 -- Technical safeguards.
  "))
* HIPAA activity review requirement: ([eCFR](https://www.ecfr.gov/current/title-45/subtitle-A/subchapter-C/part-164/subpart-C "
  eCFR :: 45 CFR Part 164 Subpart C -- Security Standards for the Protection of Electronic Protected Health Information
  "))
* S3 GetBucketEncryption: ([AWS Documentation](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketEncryption.html "GetBucketEncryption - Amazon Simple Storage Service"))
* S3 GetPublicAccessBlock: ([AWS Documentation](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetPublicAccessBlock.html "GetPublicAccessBlock - Amazon Simple Storage Service"))
* S3 bucket policy examples: ([AWS Documentation](https://docs.aws.amazon.com/AmazonS3/latest/userguide/example-bucket-policies.html "Examples of Amazon S3 bucket policies - Amazon Simple Storage Service"))
* S3 server access logging: ([AWS Documentation](https://docs.aws.amazon.com/code-library/latest/ug/s3_example_s3_GetBucketLogging_section.html "Use GetBucketLogging with a CLI"))
* CloudTrail S3 data events: ([AWS Documentation](https://docs.aws.amazon.com/cli/latest/reference/cloudtrail/get-event-selectors.html "get-event-selectors - cloudtrail"))
* S3 GetBucketVersioning: ([AWS Documentation](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketVersioning.html "GetBucketVersioning - Amazon Simple Storage Service"))
* S3 Object Lock: ([AWS Documentation](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-lock-configure.html "Configuring S3 Object Lock - Amazon Simple Storage Service"))
