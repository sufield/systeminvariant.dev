...
Examples: stave forge preview --snapshot obs.json<br />--field properties.storage.access.public\_read --op eq --value true

stave forge preview --snapshot obs.json --asset-type aws\_s3\_bucket<br />--field properties.storage.encryption.at\_rest\_enabled --op eq --value false
