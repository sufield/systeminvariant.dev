...
## Schema Versions[​](#schema-versions "Direct link to Schema Versions")
...
## Control Contract (`ctrl.v1`)[​](#control-contract-ctrlv1 "Direct link to control-contract-ctrlv1")
...
See [Evaluation Semantics](/docs/reference/evaluation-semantics.md) for predicate operators and matching rules.

***

## Observation Contract (`obs.v0.1`)[​](#observation-contract-obsv01 "Direct link to observation-contract-obsv01")
...
See [Observation Contract](https://github.com/sufield/stave/blob/main/docs/contract/README.md) for the full field dictionary.

***

## Output Contract (`out.v0.1`)[​](#output-contract-outv01 "Direct link to output-contract-outv01")

Evaluation output. Two kinds distinguished by the `kind` field:

### Evaluation output (`kind: "ASSESSMENT"`)[​](#evaluation-output-kind-assessment "Direct link to evaluation-output-kind-assessment")
...
### Verification output (`kind: "ATTESTATION"`)[​](#verification-output-kind-attestation "Direct link to verification-output-kind-attestation")
...
## Finding Contract (`v1`)[​](#finding-contract-v1 "Direct link to finding-contract-v1")
...
### Evidence structure[​](#evidence-structure "Direct link to Evidence structure")
...
### Remediation structure[​](#remediation-structure "Direct link to Remediation structure")
...
## Schema Layout[​](#schema-layout "Direct link to Schema Layout")
...
## Embedded Runtime Schemas[​](#embedded-runtime-schemas "Direct link to Embedded Runtime Schemas")
...
## Validate vs Lint[​](#validate-vs-lint "Direct link to Validate vs Lint")
...
## Deterministic Guarantees[​](#deterministic-guarantees "Direct link to Deterministic Guarantees")

* Offline-only schema loading (embedded files).
* Deterministic diagnostic ordering.
* Stable lint output format: `path:line:col RULE_ID message`.

## Polyglot Validation[​](#polyglot-validation "Direct link to Polyglot Validation")
