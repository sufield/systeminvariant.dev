...
**ID:** `CTL.S3.BUCKET.TAKEOVER.001` **Category:** Compliance **Severity:** Critical
...
* [`CTL.S3.DANGLING.ORIGIN.001`](/docs/reference/invariants-reference/compliance/inv-s3-dangling-origin-001.md) -- CDN-specific variant that checks CloudFront distributions for dangling S3 origins.
