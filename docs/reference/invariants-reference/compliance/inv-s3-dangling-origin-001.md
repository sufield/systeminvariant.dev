...
**ID:** `CTL.S3.DANGLING.ORIGIN.001` **Category:** Compliance **Severity:** Critical
...
* [`CTL.S3.BUCKET.TAKEOVER.001`](/docs/reference/invariants-reference/compliance/inv-s3-bucket-takeover-001.md) -- General-purpose check that any referenced S3 bucket exists and is owned.
* [`CTL.S3.CONTROLS.001`](/docs/reference/invariants-reference/public-access/inv-s3-controls-001.md) -- Ensures Public Access Block is fully enabled on origin buckets.
