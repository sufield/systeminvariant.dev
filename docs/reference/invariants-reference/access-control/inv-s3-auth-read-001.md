...
* [`CTL.S3.PUBLIC.004`](/docs/reference/invariants-reference/public-access/inv-s3-public-004.md) -- No Public Read via ACL (flags `AllUsers` read grants, the fully public equivalent)
* [`CTL.S3.ACCESS.001`](/docs/reference/invariants-reference/access-control/inv-s3-access-001.md) -- No Unauthorized Cross-Account Access (flags external account principals in bucket policies)
