...
**ID:** `CTL.S3.WRITE.CONTENT.001` **Category:** Access Control **Severity:** High
...
* [`CTL.S3.WRITE.SCOPE.001`](/docs/reference/invariants-reference/access-control/inv-s3-write-scope-001.md) -- S3 Signed Upload Must Bind To Exact Object Key (flags prefix-scoped upload keys, a complementary upload hardening check)
