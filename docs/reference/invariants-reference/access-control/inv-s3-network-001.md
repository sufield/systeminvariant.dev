...
**ID:** `CTL.S3.NETWORK.001` **Category:** Access Control **Severity:** High
...
* [`CTL.S3.ACCESS.001`](/docs/reference/invariants-reference/access-control/inv-s3-access-001.md) -- No Unauthorized Cross-Account Access (flags named external account principals)
* [`CTL.S3.ACCESS.002`](/docs/reference/invariants-reference/access-control/inv-s3-access-002.md) -- No Wildcard Action Policies (flags `s3:*` action grants, which compound the risk of unscoped principals)
* [`CTL.S3.PUBLIC.001`](/docs/reference/invariants-reference/public-access/inv-s3-public-001.md) -- No Public S3 Buckets (flags public read/list access at the visibility level)
