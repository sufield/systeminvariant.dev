...
**ID:** `CTL.S3.ACCESS.003` **Category:** Access Control **Severity:** Critical
...
```
{
  "control_id": "CTL.S3.ACCESS.003",
  "control_name": "No External Write Access",
...
* [`CTL.S3.ACCESS.001`](/docs/reference/invariants-reference/access-control/inv-s3-access-001.md) -- No Unauthorized Cross-Account Access (flags any cross-account access, including read)
* [`CTL.S3.WRITE.SCOPE.001`](/docs/reference/invariants-reference/access-control/inv-s3-write-scope-001.md) -- S3 Signed Upload Must Bind To Exact Object Key (flags overly broad write scope in signed upload policies)
* [`CTL.S3.TENANT.ISOLATION.001`](/docs/reference/invariants-reference/access-control/inv-s3-tenant-isolation-001.md) -- Shared-Bucket Tenant Isolation Must Enforce Prefix (flags missing prefix enforcement on shared buckets)
