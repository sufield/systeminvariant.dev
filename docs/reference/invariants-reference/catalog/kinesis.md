...
### CTL.KINESIS.ENCRYPT.001[​](#ctlkinesisencrypt001 "Direct link to CTL.KINESIS.ENCRYPT.001")
...
### CTL.KINESIS.MODE.PROVISIONED.001[​](#ctlkinesismodeprovisioned001 "Direct link to CTL.KINESIS.MODE.PROVISIONED.001")
...
* **Type:** unsafe\_state
* **Domain:** config
* **Compliance:** nist\_800\_53\_r5: SA-8;
...
**Remediation:** Switch the stream to on-demand mode. Use aws kinesis update-stream-mode --stream-arn --stream-mode-details StreamMode=ON\_DEMAND. On-demand mode automatically scales throughput up to the account limits. Review cost implications — on-demand pricing differs from provisioned shard-hour pricing.

***

### CTL.KINESIS.MONITORING.001[​](#ctlkinesismonitoring001 "Direct link to CTL.KINESIS.MONITORING.001")
...
**Remediation:** Enable enhanced monitoring on the stream: aws kinesis enable-enhanced-monitoring --stream-name --shard-level-metrics ALL. Review per-shard metrics in CloudWatch to identify hot shards and configure alarms on ReadProvisionedThroughputExceeded and IteratorAgeMilliseconds per shard.

***

### CTL.KINESIS.RETENTION.001[​](#ctlkinesisretention001 "Direct link to CTL.KINESIS.RETENTION.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: AU-11; soc2: A1.1;
