...
### CTL.CISCO.ACL.EGRESS.001[​](#ctlciscoaclegress001 "Direct link to CTL.CISCO.ACL.EGRESS.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 4.2.1; nist\_800\_53\_r5: SC-7;
...
**Remediation:** Apply egress ACLs to external interfaces permitting only legitimate source address ranges. Run: interface ip access-group out Verify with: show ip access-lists

***

### CTL.CISCO.ACL.VTY.001[​](#ctlciscoaclvty001 "Direct link to CTL.CISCO.ACL.VTY.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 4.1.1; nist\_800\_53\_r5: AC-3;
...
**Remediation:** Apply an access-class ACL to all VTY lines. Run: line vty 0 15 access-class in Verify with: show running-config | section line vty

***

### CTL.CISCO.AUTH.AAA.001[​](#ctlciscoauthaaa001 "Direct link to CTL.CISCO.AUTH.AAA.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_cisco\_ios\_17: 1.2.1; nist\_800\_53\_r5: IA-2;
...
### CTL.CISCO.AUTH.ACCOUNTING.001[​](#ctlciscoauthaccounting001 "Direct link to CTL.CISCO.AUTH.ACCOUNTING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 1.2.5; nist\_800\_53\_r5: AU-2;
...
### CTL.CISCO.AUTH.ENABLE.001[​](#ctlciscoauthenable001 "Direct link to CTL.CISCO.AUTH.ENABLE.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_cisco\_ios\_17: 1.1.1; nist\_800\_53\_r5: IA-5;
...
**Remediation:** Configure enable secret and remove enable password. Run: enable secret no enable password Verify with: show running-config | include enable

***

### CTL.CISCO.AUTH.LOGIN.001[​](#ctlciscoauthlogin001 "Direct link to CTL.CISCO.AUTH.LOGIN.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_cisco\_ios\_17: 1.2.2; nist\_800\_53\_r5: IA-2;
...
### CTL.CISCO.AUTH.SVCENC.001[​](#ctlciscoauthsvcenc001 "Direct link to CTL.CISCO.AUTH.SVCENC.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_cisco\_ios\_17: 1.1.2; nist\_800\_53\_r5: IA-5;
...
### CTL.CISCO.BGP.AUTH.001[​](#ctlciscobgpauth001 "Direct link to CTL.CISCO.BGP.AUTH.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 3.1.1; nist\_800\_53\_r5: SC-8;
...
**Remediation:** Configure MD5 authentication for all BGP neighbors. Run: router bgp neighbor password Verify with: show ip bgp neighbors | include password

***

### CTL.CISCO.BGP.FILTERIN.001[​](#ctlciscobgpfilterin001 "Direct link to CTL.CISCO.BGP.FILTERIN.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 3.1.2; nist\_800\_53\_r5: SC-7;
...
**Remediation:** Apply inbound prefix-list or route-map filters to all BGP neighbors. Run: router bgp neighbor prefix-list in Verify with: show ip bgp neighbors | include filter

***

### CTL.CISCO.BGP.FILTEROUT.001[​](#ctlciscobgpfilterout001 "Direct link to CTL.CISCO.BGP.FILTEROUT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 3.1.3; nist\_800\_53\_r5: SC-7;
...
**Remediation:** Apply outbound prefix-list or route-map filters to all BGP neighbors. Run: router bgp neighbor prefix-list out Verify with: show ip bgp neighbors | include filter

***

### CTL.CISCO.HSRP.AUTH.001[​](#ctlciscohsrpauth001 "Direct link to CTL.CISCO.HSRP.AUTH.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 3.3.1; nist\_800\_53\_r5: SC-8;
...
**Remediation:** Configure HSRP authentication for all groups. Run: interface standby authentication md5 key-string Verify with: show standby | include authentication

***

### CTL.CISCO.INTF.DIRBROADCAST.001[​](#ctlciscointfdirbroadcast001 "Direct link to CTL.CISCO.INTF.DIRBROADCAST.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 4.3.1; nist\_800\_53\_r5: SC-7;
...
**Remediation:** Disable directed broadcast on all interfaces. Run: interface no ip directed-broadcast Verify with: show running-config | include directed-broadcast

***

### CTL.CISCO.MGMT.BANNER.001[​](#ctlciscomgmtbanner001 "Direct link to CTL.CISCO.MGMT.BANNER.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 1.1.1; nist\_800\_53\_r5: AC-8;
...
### CTL.CISCO.MGMT.HTTP.001[​](#ctlciscomgmthttp001 "Direct link to CTL.CISCO.MGMT.HTTP.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 1.2.1; nist\_800\_53\_r5: CM-7;
...
### CTL.CISCO.MGMT.SNMP.001[​](#ctlciscomgmtsnmp001 "Direct link to CTL.CISCO.MGMT.SNMP.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 2.2.1; nist\_800\_53\_r5: SC-8;
...
**Remediation:** Configure SNMP v3 with authentication and privacy. Run: snmp-server group v3 priv snmp-server user v3 auth sha priv aes 256 Remove SNMP v1/v2c community strings: no snmp-server community

***

### CTL.CISCO.MGMT.SNMPCOMM.001[​](#ctlciscomgmtsnmpcomm001 "Direct link to CTL.CISCO.MGMT.SNMPCOMM.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 2.2.2; nist\_800\_53\_r5: IA-5;
...
### CTL.CISCO.MGMT.SSH.001[​](#ctlciscomgmtssh001 "Direct link to CTL.CISCO.MGMT.SSH.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 2.1.2; nist\_800\_53\_r5: SC-8;
...
### CTL.CISCO.MGMT.TELNET.001[​](#ctlciscomgmttelnet001 "Direct link to CTL.CISCO.MGMT.TELNET.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 2.1.1; nist\_800\_53\_r5: SC-8;
...
### CTL.CISCO.NTP.AUTH.001[​](#ctlciscontpauth001 "Direct link to CTL.CISCO.NTP.AUTH.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 2.2.2; nist\_800\_53\_r5: AU-8;
...
**Remediation:** Enable NTP authentication. Run: ntp authenticate ntp authentication-key 1 md5 ntp trusted-key 1 Verify with: show ntp status

***

### CTL.CISCO.NTP.SERVERS.001[​](#ctlciscontpservers001 "Direct link to CTL.CISCO.NTP.SERVERS.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 2.2.1; nist\_800\_53\_r5: AU-8;
...
**Remediation:** Configure NTP with a trusted time source. Run: ntp server Verify with: show ntp status

***

### CTL.CISCO.OSPF.AUTH.001[​](#ctlciscoospfauth001 "Direct link to CTL.CISCO.OSPF.AUTH.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 3.2.1; nist\_800\_53\_r5: SC-8;
...
**Remediation:** Enable OSPF authentication for all areas. Run: router ospf area authentication message-digest Verify with: show ip ospf | include authentication

***

### CTL.CISCO.SVC.BOOTP.001[​](#ctlciscosvcbootp001 "Direct link to CTL.CISCO.SVC.BOOTP.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 2.1.1; nist\_800\_53\_r5: CM-7;
...
### CTL.CISCO.SVC.CDP.001[​](#ctlciscosvccdp001 "Direct link to CTL.CISCO.SVC.CDP.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 2.1.3; nist\_800\_53\_r5: CM-7;
...
### CTL.CISCO.SVC.FINGER.001[​](#ctlciscosvcfinger001 "Direct link to CTL.CISCO.SVC.FINGER.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 2.1.4; nist\_800\_53\_r5: CM-7;
...
### CTL.CISCO.SVC.GRATARP.001[​](#ctlciscosvcgratarp001 "Direct link to CTL.CISCO.SVC.GRATARP.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 2.1.6; nist\_800\_53\_r5: SC-7;
...
### CTL.CISCO.SVC.HTTPD.001[​](#ctlciscosvchttpd001 "Direct link to CTL.CISCO.SVC.HTTPD.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 1.2.2; nist\_800\_53\_r5: SC-8;
...
### CTL.CISCO.SVC.SRCROUTE.001[​](#ctlciscosvcsrcroute001 "Direct link to CTL.CISCO.SVC.SRCROUTE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 2.1.5; nist\_800\_53\_r5: SC-7;
...
### CTL.CISCO.SVC.TCPSMALL.001[​](#ctlciscosvctcpsmall001 "Direct link to CTL.CISCO.SVC.TCPSMALL.001")
...
### CTL.CISCO.SVC.UDPSMALL.001[​](#ctlciscosvcudpsmall001 "Direct link to CTL.CISCO.SVC.UDPSMALL.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_cisco\_ios\_17: 2.1.2; nist\_800\_53\_r5: CM-7;
...
### CTL.CISCO.URPF.001[​](#ctlciscourpf001 "Direct link to CTL.CISCO.URPF.001")
...
**Remediation:** Enable uRPF on all external-facing interfaces. Run: interface ip verify unicast source reachable-via rx Use "rx" (strict mode) on interfaces with a single path, or "any" (loose mode) on interfaces with asymmetric routing. Verify with: show ip verify unicast source
