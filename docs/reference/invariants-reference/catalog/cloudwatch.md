...
### CTL.CLOUDWATCH.ALARM.COMPOSITE.NOACTION.001[​](#ctlcloudwatchalarmcompositenoaction001 "Direct link to CTL.CLOUDWATCH.ALARM.COMPOSITE.NOACTION.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** fedramp\_moderate: AU-6, IR-4; iso\_27001\_2022: A.5.30, A.8.16; nist\_800\_53\_r5: AU-6, IR-4, SI-4; pci\_dss\_v4.0: 10.6, 12.10; soc2: CC7.1, CC7.2, CC7.3;
...
**Remediation:** Add at least one AlarmAction to the composite alarm pointing at the team's alert SNS topic: aws cloudwatch put-composite-alarm --alarm-name --alarm-rule --alarm-actions . Composite alarms typically warrant a higher-priority notification channel than individual child alarms (paging vs ticketing) because the correlation indicates a more severe condition than any single child.

***

### CTL.CLOUDWATCH.ALARM.DECOMMISSIONED.001[​](#ctlcloudwatchalarmdecommissioned001 "Direct link to CTL.CLOUDWATCH.ALARM.DECOMMISSIONED.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: AU-6, SI-4; iso\_27001\_2022: A.5.9, A.8.16; nist\_800\_53\_r5: AU-6, CM-8, IR-4, SI-4; pci\_dss\_v4.0: 10.6; soc2: CC7.2, CC7.3, CC8.1;

CloudWatch alarm monitors a metric for a resource that has been decommissioned — an EC2 instance terminated, an RDS instance deleted, a Lambda function removed. The metric stops publishing, the alarm enters INSUFFICIENT\_DATA permanently, and the alarm clutters the inventory while monitoring nothing. Different from ALARM.INSUFFICIENTDATA.001 which checks the symptom (current state); this checks the root cause (the monitored resource is gone).

**Remediation:** Confirm the dimensioned resource is gone (e.g., the InstanceId is not in the EC2 inventory, the FunctionName is not in Lambda). Delete the alarm: aws cloudwatch delete-alarms --alarm-names . If the resource was replaced (new InstanceId for the same logical role), update the alarm's dimensions to the new resource rather than leaving the old alarm dead.

***

### CTL.CLOUDWATCH.ALARM.DISABLED.001[​](#ctlcloudwatchalarmdisabled001 "Direct link to CTL.CLOUDWATCH.ALARM.DISABLED.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** cis\_aws\_v3.0: 4.5; fedramp\_moderate: SI-4; iso\_27001\_2022: A.5.16, A.8.16; nist\_800\_53\_r5: AU-6, IR-4, IR-5, SI-4; pci\_dss\_v4.0: 10.5, 10.6; soc2: CC7.1, CC7.2, CC7.3;
...
**Remediation:** Re-enable actions: aws cloudwatch enable-alarm-actions --alarm-names . Audit the historical reason for the disablement — common cause is a maintenance window where actions were silenced and never re-enabled. Add a follow-up alarm or process check that surfaces long-running ActionsEnabled=false states so the same lapse doesn't recur.

***

### CTL.CLOUDWATCH.ALARM.EMAILONLY.001[​](#ctlcloudwatchalarmemailonly001 "Direct link to CTL.CLOUDWATCH.ALARM.EMAILONLY.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** fedramp\_moderate: IR-4, IR-6; iso\_27001\_2022: A.5.24, A.5.30; nist\_800\_53\_r5: AU-5, IR-4, IR-6, SI-4; pci\_dss\_v4.0: 12.10; soc2: CC7.2, CC7.3;
...
### CTL.CLOUDWATCH.ALARM.GHOST.001[​](#ctlcloudwatchalarmghost001 "Direct link to CTL.CLOUDWATCH.ALARM.GHOST.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** fedramp\_moderate: AU-5; hipaa: 164.312(b); nist\_800\_53\_r5: AU-5; soc2: CC7.1;
...
### CTL.CLOUDWATCH.ALARM.INSUFFICIENTDATA.001[​](#ctlcloudwatchalarminsufficientdata001 "Direct link to CTL.CLOUDWATCH.ALARM.INSUFFICIENTDATA.001")

**CloudWatch Alarm in INSUFFICIENT\_DATA State for 30+ Days**

* **Severity:** high
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SI-4; iso\_27001\_2022: A.5.16, A.8.16; nist\_800\_53\_r5: AU-6, SI-4, CM-3; pci\_dss\_v4.0: 10.6; soc2: CC7.1, CC7.2;

CloudWatch alarm has been in INSUFFICIENT\_DATA state for more than 30 days. INSUFFICIENT\_DATA means the metric is not publishing data points — the alarm cannot evaluate because there's nothing to evaluate. Common causes: monitored resource was deleted, metric namespace or dimensions changed, CloudTrail or the metric filter's log group was deleted. The alarm exists in the console as an active alarm in a neutral state; brief INSUFFICIENT\_DATA is normal during metric-publication gaps but 30+ days means the data source is permanently gone.
...
### CTL.CLOUDWATCH.ALARM.MISSINGDATA.NOTBREACHING.001[​](#ctlcloudwatchalarmmissingdatanotbreaching001 "Direct link to CTL.CLOUDWATCH.ALARM.MISSINGDATA.NOTBREACHING.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** cis\_aws\_v3.0: 4.1; fedramp\_moderate: SI-4; iso\_27001\_2022: A.5.16, A.8.16; nist\_800\_53\_r5: AU-6, AU-9, SI-4; pci\_dss\_v4.0: 10.5, 10.6; soc2: CC7.1, CC7.2;
...
**Remediation:** Change TreatMissingData on the alarm: aws cloudwatch put-metric-alarm --treat-missing-data breaching (preferred for security — missing data is treated as ALARM) or --treat-missing-data missing (alarm goes to INSUFFICIENT\_DATA which is observable). Pair with CTL.CLOUDWATCH.ALARM.INSUFFICIENTDATA.001 so a permanently-INSUFFICIENT\_DATA security alarm surfaces.

***

### CTL.CLOUDWATCH.ALARM.NOACTION.001[​](#ctlcloudwatchalarmnoaction001 "Direct link to CTL.CLOUDWATCH.ALARM.NOACTION.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SI-4; iso\_27001\_2022: A.5.16, A.8.16; nist\_800\_53\_r5: AU-6, IR-4, IR-5, SI-4; pci\_dss\_v4.0: 10.6; soc2: CC7.1, CC7.2;
...
**Remediation:** Add an AlarmAction pointing at an SNS topic that pages the relevant on-call (aws cloudwatch put-metric-alarm --alarm-actions ). For composite or aggregate alarms, OK and InsufficientData actions can also be useful for state-change auditing — but at minimum, every alarm needs an AlarmAction.

***

### CTL.CLOUDWATCH.ALARM.NOALARMACTION.001[​](#ctlcloudwatchalarmnoalarmaction001 "Direct link to CTL.CLOUDWATCH.ALARM.NOALARMACTION.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SI-4; iso\_27001\_2022: A.5.16, A.8.16; nist\_800\_53\_r5: AU-6, IR-4, SI-4; pci\_dss\_v4.0: 10.6; soc2: CC7.1, CC7.2;

CloudWatch alarm has OKAction or InsufficientDataAction configured but no AlarmAction. The alarm notifies when things are fine (OK) or when data is missing (INSUFFICIENT\_DATA) but not when the threshold is breached (ALARM). Reversed-action misconfiguration: the team is notified when the metric recovers but not when it breaches.

**Remediation:** Add an AlarmAction: aws cloudwatch put-metric-alarm --alarm-actions . The OK and InsufficientData actions remain useful for state-change auditing; the AlarmAction is the one that actually pages on-call.

***

### CTL.CLOUDWATCH.ALARM.SAMETOPIC.BLAST.001[​](#ctlcloudwatchalarmsametopicblast001 "Direct link to CTL.CLOUDWATCH.ALARM.SAMETOPIC.BLAST.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** fedramp\_moderate: AU-6, IR-4; iso\_27001\_2022: A.5.30, A.8.16; nist\_800\_53\_r5: AU-6, IR-4, SI-4; pci\_dss\_v4.0: 10.6; soc2: CC7.2, CC7.3;
...
### CTL.CLOUDWATCH.CROSSACCOUNT.DESTINATION.OPEN.001[​](#ctlcloudwatchcrossaccountdestinationopen001 "Direct link to CTL.CLOUDWATCH.CROSSACCOUNT.DESTINATION.OPEN.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 1.4; fedramp\_moderate: AC-3, AU-9; iso\_27001\_2022: A.5.15, A.8.15; nist\_800\_53\_r5: AC-3, AC-4, AU-9; pci\_dss\_v4.0: 7.2; soc2: CC6.1, CC6.6, CC7.1;
...
**Remediation:** Replace the destination policy with an explicit account allow-list, or add an aws:PrincipalOrgID condition restricting sources to the organization. Apply via aws logs put-destination-policy --destination-name --access-policy . Audit any subscription filters already targeting the destination from accounts not currently expected — those streams may have been established while the policy was open.

***

### CTL.CLOUDWATCH.CROSSACCOUNT.NOCENTRALIZED.001[​](#ctlcloudwatchcrossaccountnocentralized001 "Direct link to CTL.CLOUDWATCH.CROSSACCOUNT.NOCENTRALIZED.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** cis\_aws\_v3.0: 1.4, 3.1; fedramp\_moderate: AU-4, AU-9; iso\_27001\_2022: A.5.36, A.8.15; nist\_800\_53\_r5: AU-4, AU-6, AU-9; pci\_dss\_v4.0: 10.5; soc2: CC6.1, CC7.1;
...
### CTL.CLOUDWATCH.CROSSACCOUNT.RETENTION.INCONSISTENT.001[​](#ctlcloudwatchcrossaccountretentioninconsistent001 "Direct link to CTL.CLOUDWATCH.CROSSACCOUNT.RETENTION.INCONSISTENT.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** hipaa: 164.312(b), 164.316(b)(2)(i); iso\_27001\_2022: A.5.16, A.8.10; nist\_800\_53\_r5: AU-11, SI-12; pci\_dss\_v4.0: 10.5.1, 10.7; soc2: CC6.1, CC7.1;
...
**Remediation:** Decide on the canonical retention horizon for the data class (security audit, ops debug, application access) and apply it consistently to source and destination log groups: aws logs put-retention-policy --log-group-name --retention-in-days . Use Organizations SCPs or config-as-code to keep retention aligned automatically as new log groups are provisioned.

***

### CTL.CLOUDWATCH.GHOST.ALARM.LAMBDA.001[​](#ctlcloudwatchghostalarmlambda001 "Direct link to CTL.CLOUDWATCH.GHOST.ALARM.LAMBDA.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: IR-4; iso\_27001\_2022: A.5.16, A.8.16; nist\_800\_53\_r5: AU-6, IR-4, CM-2, CM-3; pci\_dss\_v4.0: 10.6, 12.10; soc2: CC7.1, CC7.2;
...
**Remediation:** Either redeploy the Lambda function (same ARN) or repoint the alarm action at an active remediation function (aws cloudwatch put-metric-alarm --alarm-actions ). If the automated remediation is no longer needed, replace with an SNS notification action so the alarm surfaces to humans instead of failing silently.

***

### CTL.CLOUDWATCH.GHOST.COMPOSITE.CHILD.001[​](#ctlcloudwatchghostcompositechild001 "Direct link to CTL.CLOUDWATCH.GHOST.COMPOSITE.CHILD.001")
...
CloudWatch composite alarm references one or more child alarms that have been deleted. The composite alarm evaluates a rule combining child alarm states (e.g., "ALARM(child1) AND ALARM(child2)"). When a child is deleted, the composite cannot evaluate the rule — it goes to INSUFFICIENT\_DATA or evaluates incorrectly. Composite alarms are commonly used for high-fidelity production alerts that combine multiple signals; a ghost child silently breaks the combination.
...
### CTL.CLOUDWATCH.GHOST.METRICFILTER.LOGGROUP.001[​](#ctlcloudwatchghostmetricfilterloggroup001 "Direct link to CTL.CLOUDWATCH.GHOST.METRICFILTER.LOGGROUP.001")
...
### CTL.CLOUDWATCH.GHOST.SUBSCRIPTION.KINESIS.001[​](#ctlcloudwatchghostsubscriptionkinesis001 "Direct link to CTL.CLOUDWATCH.GHOST.SUBSCRIPTION.KINESIS.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AU-6; iso\_27001\_2022: A.5.16, A.8.16; nist\_800\_53\_r5: AU-6, CM-2, CM-3; pci\_dss\_v4.0: 10.5, 10.6; soc2: CC7.1, CC7.2;
...
**Remediation:** Either recreate the Kinesis stream with the same ARN and reattach (aws logs put-subscription-filter --destination-arn ), or repoint the filter at an existing stream, or delete the subscription filter if the downstream consumer is gone for good. Audit downstream — the SIEM / analytics pipeline expecting these events has been blind for the gap window.

***

### CTL.CLOUDWATCH.GHOST.SUBSCRIPTION.LAMBDA.001[​](#ctlcloudwatchghostsubscriptionlambda001 "Direct link to CTL.CLOUDWATCH.GHOST.SUBSCRIPTION.LAMBDA.001")
...
### CTL.CLOUDWATCH.INCOMPLETE.001[​](#ctlcloudwatchincomplete001 "Direct link to CTL.CLOUDWATCH.INCOMPLETE.001")
...
**Remediation:** Ensure the extractor calls aws logs describe-log-groups and maps the retentionInDays to the log\_group observation properties.

***

### CTL.CLOUDWATCH.LOG.DATAPROTECTION.001[​](#ctlcloudwatchlogdataprotection001 "Direct link to CTL.CLOUDWATCH.LOG.DATAPROTECTION.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: SC-28; scs\_c02: 10.3; soc2: CC6.7;
...
**Remediation:** Create a data protection policy: aws logs put-data-protection-policy --log-group-name --policy-document file://policy.json.

***

### CTL.CLOUDWATCH.LOG.EXPORT.001[​](#ctlcloudwatchlogexport001 "Direct link to CTL.CLOUDWATCH.LOG.EXPORT.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** mitre\_attack: T1530; nist\_800\_53\_r5: AU-9;
...
### CTL.CLOUDWATCH.LOG.RETENTION.001[​](#ctlcloudwatchlogretention001 "Direct link to CTL.CLOUDWATCH.LOG.RETENTION.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** mitre\_attack: T1530; nist\_800\_53\_r5: AU-11;
...
**Remediation:** Set a retention policy appropriate for the log type: aws logs put-retention-policy --log-group-name --retention-in-days 90

***

### CTL.CLOUDWATCH.LOG.RETENTION365.001[​](#ctlcloudwatchlogretention365001 "Direct link to CTL.CLOUDWATCH.LOG.RETENTION365.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AU-11; gdpr: Art.30; nist\_800\_53\_r5: AU-11; pci\_dss\_v4.0: 10.7;
...
**Remediation:** Set retention to at least 365 days: aws logs put-retention-policy --log-group-name --retention-in-days 365

***

### CTL.CLOUDWATCH.LOGGROUP.ENCRYPT.CMK.001[​](#ctlcloudwatchloggroupencryptcmk001 "Direct link to CTL.CLOUDWATCH.LOGGROUP.ENCRYPT.CMK.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 3.7; fedramp\_moderate: SC-13, SC-28; hipaa: 164.312(a)(2)(iv), 164.312(e)(2)(ii); iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: SC-13, SC-28; pci\_dss\_v4.0: 3.5.1; soc2: CC6.1, CC6.7;
...
**Remediation:** Associate a customer-managed KMS key with the log group: aws logs associate-kms-key --log-group-name --kms-key-id . The key policy must grant logs..amazonaws.com kms:Encrypt, kms:Decrypt, kms:ReEncrypt\*, kms:GenerateDataKey\*, and kms:Describe\* with a kms:EncryptionContext condition scoping to the log group ARN. After association, only entries written after association are encrypted with the CMK; existing entries remain encrypted with the previous key.

***

### CTL.CLOUDWATCH.LOGGROUP.ORPHAN.001[​](#ctlcloudwatchloggrouporphan001 "Direct link to CTL.CLOUDWATCH.LOGGROUP.ORPHAN.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** iso\_27001\_2022: A.5.9, A.8.10; nist\_800\_53\_r5: CM-8, SI-12; soc2: CC6.1, A1.2;
...
**Remediation:** Confirm no service still depends on the log group (search Lambda function configurations, ECS task definitions, API Gateway log destinations, custom application code for the log group name). If confirmed orphaned, archive any stored data to S3 via aws logs create-export-task and delete the log group: aws logs delete-log-group --log-group-name . If the data is not needed, delete directly. Stop paying storage cost on data nothing reads.

***

### CTL.CLOUDWATCH.LOGGROUP.POLICY.CROSSACCOUNT.001[​](#ctlcloudwatchloggrouppolicycrossaccount001 "Direct link to CTL.CLOUDWATCH.LOGGROUP.POLICY.CROSSACCOUNT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 1.4; fedramp\_moderate: AC-3, AU-9; iso\_27001\_2022: A.5.15, A.8.15; nist\_800\_53\_r5: AC-3, AC-4, AU-9; pci\_dss\_v4.0: 7.2; soc2: CC6.1, CC6.6;
...
**Remediation:** Add an aws:PrincipalOrgID condition to the resource policy restricting access to the organization. If specific external accounts legitimately need access, enumerate them as Principal and document the exception. Replace the policy via aws logs put-resource-policy --policy-name --policy-document .

***

### CTL.CLOUDWATCH.LOGGROUP.POLICY.PUBLIC.001[​](#ctlcloudwatchloggrouppolicypublic001 "Direct link to CTL.CLOUDWATCH.LOGGROUP.POLICY.PUBLIC.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 3.4; fedramp\_moderate: AC-3, AU-9; hipaa: 164.312(b), 164.312(c)(1); iso\_27001\_2022: A.5.15, A.8.15; nist\_800\_53\_r5: AC-3, AU-9; pci\_dss\_v4.0: 10.5; soc2: CC6.1, CC7.1;
...
**Remediation:** Replace Principal: \* with the specific service principal that needs to write (e.g., cloudtrail.amazonaws.com, vpc-flow-logs.amazonaws.com) and add an aws:SourceArn condition limiting writes to a specific resource. For cross-account writes, enumerate Principal accounts explicitly or add an aws:PrincipalOrgID condition. Apply the policy via aws logs put-resource-policy --policy-name --policy-document .

***

### CTL.CLOUDWATCH.LOGGROUP.RETENTION.SHORT.001[​](#ctlcloudwatchloggroupretentionshort001 "Direct link to CTL.CLOUDWATCH.LOGGROUP.RETENTION.SHORT.001")
...
**Remediation:** Confirm the source service is gone and not being recreated under a different name. Delete the metric filter (aws logs delete-metric-filter --log-group-name --filter-name ) and any alarms that used the metric. If the log group itself is also orphaned, delete it (LOGGROUP.ORPHAN catches that separately).

***

### CTL.CLOUDWATCH.METRICFILTER.NOALARM.001[​](#ctlcloudwatchmetricfilternoalarm001 "Direct link to CTL.CLOUDWATCH.METRICFILTER.NOALARM.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** cis\_aws\_v3.0: 3.4, 4.1; fedramp\_moderate: AU-6, SI-4; iso\_27001\_2022: A.8.16; nist\_800\_53\_r5: AU-6, SI-4; pci\_dss\_v4.0: 10.6; soc2: CC7.1, CC7.2;
...
### CTL.CLOUDWATCH.METRICFILTER.NODEFAULT.001[​](#ctlcloudwatchmetricfilternodefault001 "Direct link to CTL.CLOUDWATCH.METRICFILTER.NODEFAULT.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** fedramp\_moderate: AU-6, SI-4; iso\_27001\_2022: A.8.16; nist\_800\_53\_r5: AU-6, SI-4; pci\_dss\_v4.0: 10.6; soc2: CC7.1, CC7.2;

CloudWatch metric filter does not have a default value configured. When no log events match the filter pattern in an evaluation period, the metric publishes NO data point — not zero, no data. Alarms based on the metric enter INSUFFICIENT\_DATA instead of evaluating the threshold. Combined with TreatMissingData: notBreaching (CW-1), the alarm stays in OK state silently. Combined with TreatMissingData: missing, the alarm enters INSUFFICIENT\_DATA permanently if no events ever match.
...
### CTL.CLOUDWATCH.MONITOR.ACCESSKEY.001[​](#ctlcloudwatchmonitoraccesskey001 "Direct link to CTL.CLOUDWATCH.MONITOR.ACCESSKEY.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.4; nist\_800\_53\_r5: AU-6; owasp\_nhi: NHI8; soc2: CC7.2;
...
### CTL.CLOUDWATCH.MONITOR.ANON.VPC.001[​](#ctlcloudwatchmonitoranonvpc001 "Direct link to CTL.CLOUDWATCH.MONITOR.ANON.VPC.001")
...
### CTL.CLOUDWATCH.MONITOR.ASSUMEROLE.001[​](#ctlcloudwatchmonitorassumerole001 "Direct link to CTL.CLOUDWATCH.MONITOR.ASSUMEROLE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.4; nist\_800\_53\_r5: SI-4; owasp\_nhi: NHI8; soc2: CC7.2;
...
### CTL.CLOUDWATCH.MONITOR.AUTHFAIL.001[​](#ctlcloudwatchmonitorauthfail001 "Direct link to CTL.CLOUDWATCH.MONITOR.AUTHFAIL.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.6; owasp\_nhi: NHI8; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.BOUNDARY.001[​](#ctlcloudwatchmonitorboundary001 "Direct link to CTL.CLOUDWATCH.MONITOR.BOUNDARY.001")
...
### CTL.CLOUDWATCH.MONITOR.CMK.001[​](#ctlcloudwatchmonitorcmk001 "Direct link to CTL.CLOUDWATCH.MONITOR.CMK.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.7; owasp\_nhi: NHI8; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.CONFIG.001[​](#ctlcloudwatchmonitorconfig001 "Direct link to CTL.CLOUDWATCH.MONITOR.CONFIG.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.9; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.CROSSACCOUNT.001[​](#ctlcloudwatchmonitorcrossaccount001 "Direct link to CTL.CLOUDWATCH.MONITOR.CROSSACCOUNT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AU-12; nist\_800\_53\_r5: AU-12; owasp\_nhi: NHI8; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.ESCALATION.001[​](#ctlcloudwatchmonitorescalation001 "Direct link to CTL.CLOUDWATCH.MONITOR.ESCALATION.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.4; fedramp\_moderate: AU-12; nist\_800\_53\_r5: AU-12; owasp\_nhi: NHI8; soc2: CC7.1;

A CloudWatch metric filter and alarm must monitor IAM privilege escalation API calls. These are the specific API actions that enable an attacker to elevate permissions after initial access: CreatePolicyVersion, SetDefaultPolicyVersion, AttachUserPolicy, AttachRolePolicy, AttachGroupPolicy, PutUserPolicy, PutRolePolicy, PutGroupPolicy, CreateAccessKey, CreateLoginProfile, UpdateLoginProfile, UpdateAssumeRolePolicy, and PassRole (as a parameter in RunInstances, CreateFunction, CreateStack, etc.). The existing iam\_policy\_changes metric filter (CIS 4.4) covers general policy modifications but does not specifically surface the escalation-enabling subset. This control verifies that a dedicated escalation-focused filter and alarm exist.

**Remediation:** Create a CloudWatch log metric filter on the CloudTrail log group matching escalation-relevant API calls: { ($.eventName = CreatePolicyVersion) || ($.eventName = SetDefaultPolicyVersion) || ($.eventName = AttachUserPolicy) || ($.eventName = AttachRolePolicy) || ($.eventName = PutUserPolicy) || ($.eventName = PutRolePolicy) || ($.eventName = CreateAccessKey) || ($.eventName = CreateLoginProfile) || ($.eventName = UpdateAssumeRolePolicy) }. Then create a CloudWatch alarm with an SNS notification action.

***

### CTL.CLOUDWATCH.MONITOR.GW\.001[​](#ctlcloudwatchmonitorgw001 "Direct link to CTL.CLOUDWATCH.MONITOR.GW.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.12; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.IAMPOLICY.001[​](#ctlcloudwatchmonitoriampolicy001 "Direct link to CTL.CLOUDWATCH.MONITOR.IAMPOLICY.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.4; owasp\_nhi: NHI8; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.IMDS.001[​](#ctlcloudwatchmonitorimds001 "Direct link to CTL.CLOUDWATCH.MONITOR.IMDS.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: AU-12; owasp\_nhi: NHI8; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.LAMBDA.ERRORS.001[​](#ctlcloudwatchmonitorlambdaerrors001 "Direct link to CTL.CLOUDWATCH.MONITOR.LAMBDA.ERRORS.001")
...
### CTL.CLOUDWATCH.MONITOR.MFADEVICE.001[​](#ctlcloudwatchmonitormfadevice001 "Direct link to CTL.CLOUDWATCH.MONITOR.MFADEVICE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-4; nist\_800\_53\_r5: SI-4; owasp\_nhi: NHI8; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.NACL.001[​](#ctlcloudwatchmonitornacl001 "Direct link to CTL.CLOUDWATCH.MONITOR.NACL.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.11; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.NOMFA.001[​](#ctlcloudwatchmonitornomfa001 "Direct link to CTL.CLOUDWATCH.MONITOR.NOMFA.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.2; owasp\_nhi: NHI8; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.ORG.001[​](#ctlcloudwatchmonitororg001 "Direct link to CTL.CLOUDWATCH.MONITOR.ORG.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.15; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.PASSROLE.001[​](#ctlcloudwatchmonitorpassrole001 "Direct link to CTL.CLOUDWATCH.MONITOR.PASSROLE.001")
...
### CTL.CLOUDWATCH.MONITOR.ROOT.001[​](#ctlcloudwatchmonitorroot001 "Direct link to CTL.CLOUDWATCH.MONITOR.ROOT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.3; owasp\_nhi: NHI8; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.ROUTE.001[​](#ctlcloudwatchmonitorroute001 "Direct link to CTL.CLOUDWATCH.MONITOR.ROUTE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.13; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.S3POLICY.001[​](#ctlcloudwatchmonitors3policy001 "Direct link to CTL.CLOUDWATCH.MONITOR.S3POLICY.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.8; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.SCP.001[​](#ctlcloudwatchmonitorscp001 "Direct link to CTL.CLOUDWATCH.MONITOR.SCP.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.15; nist\_800\_53\_r5: SI-4; soc2: CC7.2;
...
### CTL.CLOUDWATCH.MONITOR.SG.001[​](#ctlcloudwatchmonitorsg001 "Direct link to CTL.CLOUDWATCH.MONITOR.SG.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.10; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.STS.ANOMALOUS.001[​](#ctlcloudwatchmonitorstsanomalous001 "Direct link to CTL.CLOUDWATCH.MONITOR.STS.ANOMALOUS.001")
...
### CTL.CLOUDWATCH.MONITOR.TRAIL.001[​](#ctlcloudwatchmonitortrail001 "Direct link to CTL.CLOUDWATCH.MONITOR.TRAIL.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.5; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.TRAIL.ACCESS.001[​](#ctlcloudwatchmonitortrailaccess001 "Direct link to CTL.CLOUDWATCH.MONITOR.TRAIL.ACCESS.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: AU-9; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.TRUST.001[​](#ctlcloudwatchmonitortrust001 "Direct link to CTL.CLOUDWATCH.MONITOR.TRUST.001")
...
### CTL.CLOUDWATCH.MONITOR.UNAUTH.001[​](#ctlcloudwatchmonitorunauth001 "Direct link to CTL.CLOUDWATCH.MONITOR.UNAUTH.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.1; owasp\_nhi: NHI8; soc2: CC7.1;
...
### CTL.CLOUDWATCH.MONITOR.VPC.001[​](#ctlcloudwatchmonitorvpc001 "Direct link to CTL.CLOUDWATCH.MONITOR.VPC.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 4.14; soc2: CC7.1;
...
### CTL.CLOUDWATCH.ORPHAN.DASHBOARD.001[​](#ctlcloudwatchorphandashboard001 "Direct link to CTL.CLOUDWATCH.ORPHAN.DASHBOARD.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** iso\_27001\_2022: A.5.9; nist\_800\_53\_r5: CM-2, SA-22; soc2: CC8.1;
...
**Remediation:** Confirm no team or process depends on the dashboard (search internal documentation, on-call runbooks, and team wikis for the dashboard name or URL). If unused, delete: aws cloudwatch delete-dashboards --dashboard-names . If the dashboard is still relevant but underused, surface it in team standups so the audience knows it exists.

***

### CTL.CLOUDWATCH.ORPHAN.LOGGROUP.SERVICE.001[​](#ctlcloudwatchorphanloggroupservice001 "Direct link to CTL.CLOUDWATCH.ORPHAN.LOGGROUP.SERVICE.001")
...
CloudWatch Logs log group follows a standard service prefix (/aws/lambda/, /aws/ecs/, /aws/apigateway/) but the corresponding service resource has been deleted. The log group keeps historical events from the deleted service and persists indefinitely unless explicitly deleted. Cost accrues, governance attention scales with the number of orphans, and the log group may be reused for an unrelated service later (confusing log content).

**Remediation:** Confirm the service resource (Lambda function, ECS cluster, API Gateway) was intentionally decommissioned. If logs are needed for compliance, archive to S3 (aws logs create-export-task) before deleting. Then delete: aws logs delete-log-group --log-group-name . Note that the different service prefixes have different deletion patterns — Lambda log groups can auto-recreate when a function with the same name is redeployed, so deleting must coincide with confirming the function will not return.

***

### CTL.CLOUDWATCH.RETENTION.001[​](#ctlcloudwatchretention001 "Direct link to CTL.CLOUDWATCH.RETENTION.001")
...
### CTL.CLOUDWATCH.SUBSCRIPTION.CROSSACCOUNT.NOENCRYPT.001[​](#ctlcloudwatchsubscriptioncrossaccountnoencrypt001 "Direct link to CTL.CLOUDWATCH.SUBSCRIPTION.CROSSACCOUNT.NOENCRYPT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-8, SC-13; hipaa: 164.312(e)(1), 164.312(e)(2)(ii); iso\_27001\_2022: A.8.20, A.8.24; nist\_800\_53\_r5: AU-9, SC-8, SC-13; pci\_dss\_v4.0: 4.2; soc2: CC6.1, CC6.7;
...
### CTL.CLOUDWATCH.SUBSCRIPTION.CROSSACCOUNT.NOORG.001[​](#ctlcloudwatchsubscriptioncrossaccountnoorg001 "Direct link to CTL.CLOUDWATCH.SUBSCRIPTION.CROSSACCOUNT.NOORG.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** cis\_aws\_v3.0: 1.4; fedramp\_moderate: AC-3, AC-6; iso\_27001\_2022: A.5.15; nist\_800\_53\_r5: AC-3, AC-6, AU-9; pci\_dss\_v4.0: 7.2; soc2: CC6.1, CC6.6;
...
### CTL.CLOUDWATCH.SUBSCRIPTION.FILTER.NOALARM.001[​](#ctlcloudwatchsubscriptionfilternoalarm001 "Direct link to CTL.CLOUDWATCH.SUBSCRIPTION.FILTER.NOALARM.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** fedramp\_moderate: AU-5; iso\_27001\_2022: A.8.15, A.8.16; nist\_800\_53\_r5: AU-5, SI-4; pci\_dss\_v4.0: 10.7; soc2: CC7.1, CC7.2;
...
### CTL.CLOUDWATCH.SUBSCRIPTION.GHOST.FIREHOSE.001[​](#ctlcloudwatchsubscriptionghostfirehose001 "Direct link to CTL.CLOUDWATCH.SUBSCRIPTION.GHOST.FIREHOSE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 3.4; fedramp\_moderate: AU-9, SI-4; iso\_27001\_2022: A.8.15, A.8.16; nist\_800\_53\_r5: AU-9, CM-2, CM-3, SI-4; pci\_dss\_v4.0: 10.5, 10.6; soc2: CC7.1, CC8.1;
...
**Remediation:** Either recreate the Firehose delivery stream with the same ARN, repoint the subscription filter at an existing Firehose, or delete the orphan filter: aws logs delete-subscription-filter --log-group-name --filter-name . After fix, confirm by triggering a matching log event and verifying it lands in the Firehose's downstream destination.
