...
### CTL.KMS.ALARM.CREATEGRANT.001[​](#ctlkmsalarmcreategrant001 "Direct link to CTL.KMS.ALARM.CREATEGRANT.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** fedramp\_moderate: SI-4; iso\_27001\_2022: A.8.16; nist\_800\_53\_r5: SI-4; pci\_dss\_v4.0: 10.4.1; soc2: CC7.2;
...
### CTL.KMS.ALARM.CROSSACCOUNT.001[​](#ctlkmsalarmcrossaccount001 "Direct link to CTL.KMS.ALARM.CROSSACCOUNT.001")
...
### CTL.KMS.ALARM.DECRYPT.FAILURE.001[​](#ctlkmsalarmdecryptfailure001 "Direct link to CTL.KMS.ALARM.DECRYPT.FAILURE.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** fedramp\_moderate: SI-4; iso\_27001\_2022: A.8.16; nist\_800\_53\_r5: SI-4; pci\_dss\_v4.0: 10.4.1; soc2: CC7.3;
...
### CTL.KMS.ALARM.DECRYPT.VOLUME.001[​](#ctlkmsalarmdecryptvolume001 "Direct link to CTL.KMS.ALARM.DECRYPT.VOLUME.001")
...
### CTL.KMS.ALARM.DELETION.001[​](#ctlkmsalarmdeletion001 "Direct link to CTL.KMS.ALARM.DELETION.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** cis\_aws\_v3.0: 4.7; fedramp\_moderate: SI-4; hipaa: 164.312(b); iso\_27001\_2022: A.8.16; nist\_800\_53\_r5: SI-4; pci\_dss\_v4.0: 10.4.1; soc2: CC7.2;
...
### CTL.KMS.ALARM.DISABLE.001[​](#ctlkmsalarmdisable001 "Direct link to CTL.KMS.ALARM.DISABLE.001")
...
### CTL.KMS.ALARM.POLICYCHANGE.001[​](#ctlkmsalarmpolicychange001 "Direct link to CTL.KMS.ALARM.POLICYCHANGE.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** cis\_aws\_v3.0: 4.6; fedramp\_moderate: SI-4; hipaa: 164.312(b); iso\_27001\_2022: A.8.16; nist\_800\_53\_r5: SI-4; pci\_dss\_v4.0: 10.4.1; soc2: CC7.2;
...
### CTL.KMS.ALARM.ROTATION.FAILURE.001[​](#ctlkmsalarmrotationfailure001 "Direct link to CTL.KMS.ALARM.ROTATION.FAILURE.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** fedramp\_moderate: SI-4; iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: SI-4; owasp\_nhi: NHI7; pci\_dss\_v4.0: 10.4.1; soc2: CC7.2;
...
### CTL.KMS.ALIAS.GHOST.001[​](#ctlkmsaliasghost001 "Direct link to CTL.KMS.ALIAS.GHOST.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: CM-2; nist\_800\_53\_r5: CM-2; pci\_dss\_v4.0: 3.6.1; soc2: CC6.1;
...
### CTL.KMS.ALIAS.ORPHAN.001[​](#ctlkmsaliasorphan001 "Direct link to CTL.KMS.ALIAS.ORPHAN.001")
...
### CTL.KMS.CONCENTRATION.001[​](#ctlkmsconcentration001 "Direct link to CTL.KMS.CONCENTRATION.001")
...
* **Type:** unsafe\_state
* **Domain:** storage
* **Compliance:** nist\_800\_53\_r5: SC-12; soc2: A1.1;
...
### CTL.KMS.CONCENTRATION.002[​](#ctlkmsconcentration002 "Direct link to CTL.KMS.CONCENTRATION.002")
...
* **Type:** unsafe\_state
* **Domain:** storage
* **Compliance:** fedramp\_moderate: SC-12(1); nist\_800\_53\_r5: SC-12(1); soc2: A1.1;
...
### CTL.KMS.CROSSACCOUNT.BLASTRADIUS.001[​](#ctlkmscrossaccountblastradius001 "Direct link to CTL.KMS.CROSSACCOUNT.BLASTRADIUS.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-3; iso\_27001\_2022: A.5.15, A.8.24; nist\_800\_53\_r5: AC-3, AC-4, AC-6; owasp\_nhi: NHI6; pci\_dss\_v4.0: 3.5, 7.1; soc2: CC6.1, CC6.6;
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-2; iso\_27001\_2022: A.5.16, A.8.24; nist\_800\_53\_r5: AC-2, AC-3; owasp\_nhi: NHI1; pci\_dss\_v4.0: 3.5, 7.2.4; soc2: CC6.1, CC8.1;
...
**Remediation:** Confirm the account's status with AWS Organizations (aws organizations describe-account --account-id ). If the account was closed or transferred, remove the principal from the key policy (aws kms put-key-policy --key-id --policy-name default --policy ). Investigate any other artifacts that referenced the same account ID — IAM trust policies, S3 bucket policies, SCPs — to ensure the decommission is complete. If the account was migrated inside the organization to a new ID, repoint the policy to the new ID rather than leaving both.

***

### CTL.KMS.DELETION.MINWAIT.001[​](#ctlkmsdeletionminwait001 "Direct link to CTL.KMS.DELETION.MINWAIT.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SC-12(1); hipaa: 164.312(a)(1); nist\_800\_53\_r5: SC-12(1); pci\_dss\_v4.0: 3.6.1.4; soc2: A1.1;
...
### CTL.KMS.ENTROPY.EXTERNAL.ORIGIN.001[​](#ctlkmsentropyexternalorigin001 "Direct link to CTL.KMS.ENTROPY.EXTERNAL.ORIGIN.001")
...
A customer-managed KMS key uses imported external key material (Origin: EXTERNAL). Imported material may have been generated with insufficient entropy on an external system — a laptop, an on-prem HSM of unknown configuration, or a weak RNG. AWS-generated keys (Origin: AWS\_KMS) and CloudHSM-generated keys (Origin: AWS\_CLOUDHSM) use FIPS 140-2 validated HSMs with a hardware RNG; the entropy quality of imported material is unverifiable — Stave can see that a key was imported, not how its bytes were produced. Advisory (low severity), not a hard failure: imported material is a legitimate pattern for key portability and multi-cloud/BYOK key management. This control flags customer-managed EXTERNAL-origin keys for review — confirm the external source used a CSPRNG backed by a hardware RNG. AWS-managed keys (is\_aws\_managed) are skipped: they always use AWS-generated material. The PendingImport state does not clear the concern — the intent is still to use imported material whose entropy is unverifiable. Entropy controls inspired by NCC Group "Time as an Attack Surface" white paper — extended to cover key material and key pair algorithm entropy properties.

**Remediation:** Prefer AWS-generated material: create the key with Origin AWS\_KMS (or AWS\_CLOUDHSM). If imported material is required for portability/BYOK, confirm the external source used a CSPRNG backed by a validated hardware RNG and document the exception.

***

### CTL.KMS.FIPS.001[​](#ctlkmsfips001 "Direct link to CTL.KMS.FIPS.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-13;

KMS keys must have AWS\_KMS origin, confirming they are generated and stored in FIPS 140-2 Level 2 validated hardware security modules. Keys with EXTERNAL or CUSTOM\_KEY\_STORE origin may not meet FedRAMP FIPS 140 cryptography requirements.

**Remediation:** Create a new key with AWS\_KMS origin (default). Rotate data encrypted with the non-compliant key to the new key.

***

### CTL.KMS.GRANT.BROAD.001[​](#ctlkmsgrantbroad001 "Direct link to CTL.KMS.GRANT.BROAD.001")
...
### CTL.KMS.GRANT.EXCESSIVE.001[​](#ctlkmsgrantexcessive001 "Direct link to CTL.KMS.GRANT.EXCESSIVE.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: AC-6; iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: AC-6; owasp\_nhi: NHI5; pci\_dss\_v4.0: 7.2.1; soc2: CC6.1;
...
### CTL.KMS.GRANT.ORPHAN.001[​](#ctlkmsgrantorphan001 "Direct link to CTL.KMS.GRANT.ORPHAN.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: AC-2; nist\_800\_53\_r5: AC-2; owasp\_nhi: NHI1; pci\_dss\_v4.0: 7.2.4; soc2: CC6.1;
...
**Remediation:** Retire the orphan grant with aws kms retire-grant --grant-id GRANT\_ID --key-id KEY. Audit the IAM lifecycle workflow that deleted the role to ensure grant retirement is part of the decommission runbook (the role-delete tooling should call ListGrantsForPrincipal across keys it had grants on, then RetireGrant for each).

***

### CTL.KMS.GRANT.STALE.001[​](#ctlkmsgrantstale001 "Direct link to CTL.KMS.GRANT.STALE.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** nist\_800\_53\_r5: AC-6; pci\_dss\_v4.0: 3.7.5; soc2: CC6.1;
...
### CTL.KMS.IMPORTED.EXPIRY.001[​](#ctlkmsimportedexpiry001 "Direct link to CTL.KMS.IMPORTED.EXPIRY.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** fedramp\_moderate: SC-12(1); nist\_800\_53\_r5: SC-12(1); owasp\_nhi: NHI7; pci\_dss\_v4.0: 3.6.1.2; soc2: CC6.1;
...
### CTL.KMS.INCOMPLETE.001[​](#ctlkmsincomplete001 "Direct link to CTL.KMS.INCOMPLETE.001")
...
### CTL.KMS.ISOLATION.001[​](#ctlkmsisolation001 "Direct link to CTL.KMS.ISOLATION.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-12; hipaa: 164.312(a)(2)(iv); iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: SC-12, SC-28; pci\_dss\_v4.0: 3.6.1; soc2: CC6.7;
...
### CTL.KMS.LIFECYCLE.CROSSENV.001[​](#ctlkmslifecyclecrossenv001 "Direct link to CTL.KMS.LIFECYCLE.CROSSENV.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SC-12; iso\_27001\_2022: A.5.10, A.8.24; nist\_800\_53\_r5: AC-4, SC-12, SC-28; pci\_dss\_v4.0: 3.5, 7.2.4; soc2: CC6.1, CC6.7;
...
**Remediation:** Create per-environment keys with environment-encoded aliases (alias/prod--key, alias/dev--key). Re-encrypt non-production data under the non-production key and update resource references; production data should remain on a production-only key whose policy does not authorize non-production principals. Once split, gate future key use with provisioning pipelines that enforce environment alignment between key and resource. Use environment tags (env=prod, env=dev) consistently across resources so the drift can be re-detected.

***

### CTL.KMS.LIFECYCLE.DORMANT.001[​](#ctlkmslifecycledormant001 "Direct link to CTL.KMS.LIFECYCLE.DORMANT.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: AC-2; hipaa: 164.312(a)(1); nist\_800\_53\_r5: AC-2; owasp\_nhi: NHI1; pci\_dss\_v4.0: 7.2.4; soc2: CC6.1;
...
### CTL.KMS.LIFECYCLE.NOALIAS.001[​](#ctlkmslifecyclenoalias001 "Direct link to CTL.KMS.LIFECYCLE.NOALIAS.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: CM-2; iso\_27001\_2022: A.5.9, A.8.24; nist\_800\_53\_r5: CM-2, CM-3; soc2: CC6.1, CC8.1;
...
**Remediation:** Attach an alias that names the key's purpose (aws kms create-alias --alias-name alias/ --target-key-id ). Use a stable naming convention — alias/-- — and gate new key creation on alias presence in your provisioning pipeline. Update IAM policies and resource configurations to reference the alias rather than the key ID, so that key rotations and replacements do not require policy edits.

***

### CTL.KMS.LIFECYCLE.ROTATION.PERIOD.001[​](#ctlkmslifecyclerotationperiod001 "Direct link to CTL.KMS.LIFECYCLE.ROTATION.PERIOD.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SC-12; iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: CM-2, CM-3, SC-12; owasp\_nhi: NHI7; pci\_dss\_v4.0: 3.6; soc2: CC6.1, CC8.1;
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-12(2); hipaa: 164.312(a)(1); nist\_800\_53\_r5: SC-12(2); pci\_dss\_v4.0: 3.6.1.2; soc2: CC6.1;

KMS key with EXTERNAL origin has key material whose expiration date has passed. The key still exists, but new Encrypt and GenerateDataKey calls fail with KMSInvalidStateException because the cryptographic material is past its valid-to date. Existing ciphertext can still be decrypted (KMS retains expired material for decryption), so historical workloads continue to work — but any new write path fails immediately. The failure pattern is asymmetric and confusing: read paths succeed, write paths fail, the key is enabled, the key has material. The fix is to import fresh key material via aws kms import-key-material with a new --valid-to or --expiration-model KEY\_MATERIAL\_DOES\_NOT\_EXPIRE. Distinct from CTL.KMS.IMPORTED.EXPIRY.001 (no expiration set): here the expiration was set and has been reached.

**Remediation:** Import fresh key material with aws kms import-key-material. Fetch import parameters (aws kms get-parameters-for-import), wrap the fresh key bytes with the returned wrapping key, and submit them with the import token. Choose a deliberate expiration: either a future --valid-to that aligns with the key- rotation runbook, or KEY\_MATERIAL\_DOES\_NOT\_EXPIRE if the key must never auto-expire. Update the rotation runbook so the next expiration is detected before it is reached, not after.

***

### CTL.KMS.MULTIREGION.NONCOMPLIANT.REGION.001[​](#ctlkmsmultiregionnoncompliantregion001 "Direct link to CTL.KMS.MULTIREGION.NONCOMPLIANT.REGION.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SC-12; gdpr: Art.44; iso\_27001\_2022: A.5.34, A.8.24; nist\_800\_53\_r5: SC-12, SC-13, CP-6; pci\_dss\_v4.0: 3.5; soc2: CC6.1;
...
**Remediation:** Identify the offending replica (aws kms describe-key --key-id in the suspect region), confirm with legal/compliance whether residency requirements extend to key material, and either schedule the replica for deletion (aws kms schedule-key-deletion in the non-compliant region) or relocate the workload to permit residency. If business requirements demand cryptographic operations in the region, escalate to revisit residency scope rather than ignore the gap.

***

### CTL.KMS.MULTIREGION.NOREPLICA.001[​](#ctlkmsmultiregionnoreplica001 "Direct link to CTL.KMS.MULTIREGION.NOREPLICA.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SC-12; iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: SC-12, CP-6; soc2: CC6.1;
...
**Remediation:** Either replicate the key to the regions that need it (aws kms replicate-key --key-id --replica-region ) or remove multi-region configuration by recreating the key as single-region. Multi-region configuration without replicas is rarely intentional — investigate the original design and align the configuration with the actual usage.

***

### CTL.KMS.MULTIREGION.POLICY.MISMATCH.001[​](#ctlkmsmultiregionpolicymismatch001 "Direct link to CTL.KMS.MULTIREGION.POLICY.MISMATCH.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-3; iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: AC-3, SC-12; pci\_dss\_v4.0: 3.5; soc2: CC6.1;
...
### CTL.KMS.PENDING.DELETION.001[​](#ctlkmspendingdeletion001 "Direct link to CTL.KMS.PENDING.DELETION.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-12(1); nist\_800\_53\_r5: SC-12(1); owasp\_nhi: NHI1; soc2: A1.1;
...
### CTL.KMS.POLICY.001[​](#ctlkmspolicy001 "Direct link to CTL.KMS.POLICY.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-3; ffiec: ISH-4; gdpr: Art.32; hipaa: 164.312(a)(1); iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: AC-3; nist\_csf\_2.0: PR.DS; pci\_dss\_v4.0: 3.4.1; soc2: CC6.1;
...
### CTL.KMS.POLICY.ADMIN.BROAD.001[​](#ctlkmspolicyadminbroad001 "Direct link to CTL.KMS.POLICY.ADMIN.BROAD.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-6(5); iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: AC-6(5); owasp\_nhi: NHI5; pci\_dss\_v4.0: 3.6.1; soc2: CC6.1;
...
### CTL.KMS.POLICY.CONDITION.001[​](#ctlkmspolicycondition001 "Direct link to CTL.KMS.POLICY.CONDITION.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: AC-3; pci\_dss\_v4.0: 3.4.1; soc2: CC6.1;
...
### CTL.KMS.POLICY.CROSSACCOUNT.001[​](#ctlkmspolicycrossaccount001 "Direct link to CTL.KMS.POLICY.CROSSACCOUNT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-3; iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: AC-3; owasp\_nhi: NHI6; pci\_dss\_v4.0: 3.4.1; soc2: CC6.1;
...
### CTL.KMS.POLICY.DECRYPT.BROAD.001[​](#ctlkmspolicydecryptbroad001 "Direct link to CTL.KMS.POLICY.DECRYPT.BROAD.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 3.6; fedramp\_moderate: AC-3; hipaa: 164.312(a)(1); iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: AC-3; owasp\_nhi: NHI5; pci\_dss\_v4.0: 3.6.1; soc2: CC6.1;
...
### CTL.KMS.POLICY.GHOSTREF.001[​](#ctlkmspolicyghostref001 "Direct link to CTL.KMS.POLICY.GHOSTREF.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-3; hipaa: 164.312(a)(1); nist\_800\_53\_r5: AC-3; owasp\_nhi: NHI1; pci\_dss\_v4.0: 7.2.1; soc2: CC6.1;
...
### CTL.KMS.POLICY.GRANTWITHGRANT.001[​](#ctlkmspolicygrantwithgrant001 "Direct link to CTL.KMS.POLICY.GRANTWITHGRANT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-3; iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: AC-3; owasp\_nhi: NHI9; pci\_dss\_v4.0: 7.2.1; soc2: CC6.1;
...
### CTL.KMS.POLICY.NOCONTEXT.001[​](#ctlkmspolicynocontext001 "Direct link to CTL.KMS.POLICY.NOCONTEXT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-3; iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: AC-3; owasp\_nhi: NHI9; pci\_dss\_v4.0: 3.6.1.4; soc2: CC6.1;
...
**Remediation:** Add kms:EncryptionContext or kms:EncryptionContextKeys conditions to usage statements in the key policy. Choose context keys that match how the calling application uses the key (e.g., tenant\_id, object\_id, application). Verify producers and consumers pass the same context values; mismatched context fails Decrypt.

***

### CTL.KMS.POLICY.NOVIASERVICE.001[​](#ctlkmspolicynoviaservice001 "Direct link to CTL.KMS.POLICY.NOVIASERVICE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-3; iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: AC-3; owasp\_nhi: NHI9; pci\_dss\_v4.0: 3.4.1; soc2: CC6.1;

KMS key with key\_usage=ENCRYPT\_DECRYPT has no kms:ViaService condition on its usage statements. Without ViaService, the key is usable directly via the KMS Decrypt/Encrypt APIs — not just through AWS services (S3, RDS, EBS, Secrets Manager). A principal with kms:Decrypt can call KMS Decrypt directly with any ciphertext encrypted by the key, bypassing the calling service's access controls. ViaService restricts key usage to operations performed through specific AWS services (kms:ViaService = s3.us-east-1.amazonaws.com means the key can only be used through S3 in us-east-1). Narrows CTL.KMS.POLICY.CONDITION.001 to the specific case where ViaService is missing, even when other protective conditions (CallerAccount, EncryptionContext) are present. Only applies to ENCRYPT\_DECRYPT keys; SIGN\_VERIFY and GENERATE\_VERIFY\_MAC keys do not use ViaService.

**Remediation:** Add kms:ViaService conditions to all usage statements in the key policy. Use service-and-region-qualified values such as "s3.us-east-1.amazonaws.com" or "secretsmanager.us-east-1.amazonaws.com" rather than service-only patterns. ViaService does not apply to keys used for SIGN\_VERIFY or GENERATE\_VERIFY\_MAC; this control only fires on ENCRYPT\_DECRYPT keys.

***

### CTL.KMS.ROTATION.001[​](#ctlkmsrotation001 "Direct link to CTL.KMS.ROTATION.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 3.6; fedramp\_moderate: SC-12; ffiec: ISH-4; gdpr: Art.32; iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: SC-12; nist\_csf\_2.0: PR.DS; owasp\_nhi: NHI7; pci\_dss\_v4.0: 3.6.1; soc2: CC6.7;
...
**Remediation:** Enable key rotation: aws kms enable-key-rotation --key-id

***

### CTL.KMS.SEPARATION.001[​](#ctlkmsseparation001 "Direct link to CTL.KMS.SEPARATION.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** fedramp\_moderate: AC-5; hipaa: 164.312(a)(1); nist\_800\_53\_r5: AC-5; pci\_dss\_v4.0: 7.2.2; soc2: CC6.3;
...
### CTL.KMS.STATE.DISABLED.001[​](#ctlkmsstatedisabled001 "Direct link to CTL.KMS.STATE.DISABLED.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-12; hipaa: 164.312(a)(1); iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: SC-12; pci\_dss\_v4.0: 3.6.1; soc2: CC6.1;
...
### CTL.KMS.STATE.PENDINGDELETION.001[​](#ctlkmsstatependingdeletion001 "Direct link to CTL.KMS.STATE.PENDINGDELETION.001")
...
### CTL.KMS.STATE.PENDINGIMPORT.001[​](#ctlkmsstatependingimport001 "Direct link to CTL.KMS.STATE.PENDINGIMPORT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-12; hipaa: 164.312(a)(1); nist\_800\_53\_r5: SC-12; pci\_dss\_v4.0: 3.6.1; soc2: CC6.1;
