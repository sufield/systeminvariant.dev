...
### CTL.AD.ACCOUNT.DELEGATION.001[​](#ctladaccountdelegation001 "Direct link to CTL.AD.ACCOUNT.DELEGATION.001")
...
### CTL.AD.ACCOUNT.DESONLY.001[​](#ctladaccountdesonly001 "Direct link to CTL.AD.ACCOUNT.DESONLY.001")
...
### CTL.AD.ACCOUNT.GUEST.001[​](#ctladaccountguest001 "Direct link to CTL.AD.ACCOUNT.GUEST.001")
...
### CTL.AD.ACCOUNT.NOEXPIRY.001[​](#ctladaccountnoexpiry001 "Direct link to CTL.AD.ACCOUNT.NOEXPIRY.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_ad: 5.4; owasp\_nhi: NHI7;
...
### CTL.AD.ACCOUNT.NOPASSWD.001[​](#ctladaccountnopasswd001 "Direct link to CTL.AD.ACCOUNT.NOPASSWD.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_ad: 5.5;

No account should have the PASSWD\_NOTREQD flag set. Accounts with this flag can authenticate with an empty password.

**Remediation:** Clear the PASSWD\_NOTREQD flag on all accounts. Get-ADUser -Filter {PasswordNotRequired -eq $true} | Set-ADUser -PasswordNotRequired $false

***

### CTL.AD.ACCOUNT.REVENC.001[​](#ctladaccountrevenc001 "Direct link to CTL.AD.ACCOUNT.REVENC.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_ad: 1.1.5; nist\_800\_53\_r5: IA-5;
...
### CTL.AD.ACCOUNT.STALE.001[​](#ctladaccountstale001 "Direct link to CTL.AD.ACCOUNT.STALE.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_ad: 5.1; owasp\_nhi: NHI1;
...
### CTL.AD.ADMINSDHOLDER.001[​](#ctladadminsdholder001 "Direct link to CTL.AD.ADMINSDHOLDER.001")
...
### CTL.AD.AUDIT.ACCTMGMT.001[​](#ctladauditacctmgmt001 "Direct link to CTL.AD.AUDIT.ACCTMGMT.001")
...
### CTL.AD.AUDIT.LOGON.001[​](#ctladauditlogon001 "Direct link to CTL.AD.AUDIT.LOGON.001")
...
### CTL.AD.AUDIT.OBJACCESS.001[​](#ctladauditobjaccess001 "Direct link to CTL.AD.AUDIT.OBJACCESS.001")
...
### CTL.AD.AUDIT.PRIVUSE.001[​](#ctladauditprivuse001 "Direct link to CTL.AD.AUDIT.PRIVUSE.001")
...
### CTL.AD.BUILTIN.LIMIT.001[​](#ctladbuiltinlimit001 "Direct link to CTL.AD.BUILTIN.LIMIT.001")
...
### CTL.AD.CRED.GUARD.001[​](#ctladcredguard001 "Direct link to CTL.AD.CRED.GUARD.001")
...
### CTL.AD.DOMAIN.ADMIN.COUNT.001[​](#ctladdomainadmincount001 "Direct link to CTL.AD.DOMAIN.ADMIN.COUNT.001")
...
### CTL.AD.KERB.CLOCKSKEW\.001[​](#ctladkerbclockskew001 "Direct link to CTL.AD.KERB.CLOCKSKEW.001")
...
### CTL.AD.KERB.SERVICE.001[​](#ctladkerbservice001 "Direct link to CTL.AD.KERB.SERVICE.001")
...
### CTL.AD.KERB.TICKET.AGE.001[​](#ctladkerbticketage001 "Direct link to CTL.AD.KERB.TICKET.AGE.001")
...
### CTL.AD.KERBEROAST.001[​](#ctladkerberoast001 "Direct link to CTL.AD.KERBEROAST.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_ad: 5.3; nist\_800\_53\_r5: AC-6;
...
**Remediation:** Remove SPNs from privileged accounts or move the service to a Group Managed Service Account (gMSA) with automatic password rotation. Run: setspn -D or migrate to gMSA.

***

### CTL.AD.KRBTGT.ROTATION.001[​](#ctladkrbtgtrotation001 "Direct link to CTL.AD.KRBTGT.ROTATION.001")
...
### CTL.AD.LAPS.001[​](#ctladlaps001 "Direct link to CTL.AD.LAPS.001")
...
### CTL.AD.LDAP.CHANNELBIND.001[​](#ctladldapchannelbind001 "Direct link to CTL.AD.LDAP.CHANNELBIND.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_ad: 2.3.11.9; nist\_800\_53\_r5: SC-8;
...
### CTL.AD.LDAP.SIGNING.001[​](#ctladldapsigning001 "Direct link to CTL.AD.LDAP.SIGNING.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_ad: 2.3.11.8; nist\_800\_53\_r5: SC-8;
...
### CTL.AD.LOCK.DURATION.001[​](#ctladlockduration001 "Direct link to CTL.AD.LOCK.DURATION.001")
...
### CTL.AD.LOCK.THRESHOLD.001[​](#ctladlockthreshold001 "Direct link to CTL.AD.LOCK.THRESHOLD.001")
...
### CTL.AD.LOCK.WINDOW\.001[​](#ctladlockwindow001 "Direct link to CTL.AD.LOCK.WINDOW.001")
...
### CTL.AD.NTLM.LEVEL.001[​](#ctladntlmlevel001 "Direct link to CTL.AD.NTLM.LEVEL.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_ad: 2.3.11.7; nist\_800\_53\_r5: IA-2;
...
### CTL.AD.PASS.COMPLEXITY.001[​](#ctladpasscomplexity001 "Direct link to CTL.AD.PASS.COMPLEXITY.001")
...
### CTL.AD.PASS.HISTORY.001[​](#ctladpasshistory001 "Direct link to CTL.AD.PASS.HISTORY.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_ad: 1.1.2; nist\_800\_53\_r5: IA-5;
...
### CTL.AD.PASS.MAXAGE.001[​](#ctladpassmaxage001 "Direct link to CTL.AD.PASS.MAXAGE.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_ad: 1.1.3; owasp\_nhi: NHI7;
...
### CTL.AD.PASS.MINAGE.001[​](#ctladpassminage001 "Direct link to CTL.AD.PASS.MINAGE.001")
...
### CTL.AD.PASS.MINLEN.001[​](#ctladpassminlen001 "Direct link to CTL.AD.PASS.MINLEN.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_ad: 1.1.1; nist\_800\_53\_r5: IA-5;
...
### CTL.AD.PASS.REVENC.001[​](#ctladpassrevenc001 "Direct link to CTL.AD.PASS.REVENC.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_ad: 1.1.6; nist\_800\_53\_r5: IA-5;
...
### CTL.AD.PRIV.NESTED.001[​](#ctladprivnested001 "Direct link to CTL.AD.PRIV.NESTED.001")
...
### CTL.AD.PROTUSERS.001[​](#ctladprotusers001 "Direct link to CTL.AD.PROTUSERS.001")
...
### CTL.AD.RECYCLEBIN.001[​](#ctladrecyclebin001 "Direct link to CTL.AD.RECYCLEBIN.001")
...
### CTL.AD.SMB.SIGNING.001[​](#ctladsmbsigning001 "Direct link to CTL.AD.SMB.SIGNING.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** cis\_ad: 2.3.8.1; nist\_800\_53\_r5: SC-8;
...
### CTL.AD.STALE.ADMIN.001[​](#ctladstaleadmin001 "Direct link to CTL.AD.STALE.ADMIN.001")
...
### CTL.AD.TRUST.SELECTIVE.001[​](#ctladtrustselective001 "Direct link to CTL.AD.TRUST.SELECTIVE.001")
...
### CTL.AD.TRUST.SIDFILTER.001[​](#ctladtrustsidfilter001 "Direct link to CTL.AD.TRUST.SIDFILTER.001")
...
**Remediation:** Enable SID filtering on all external trusts. netdom trust /domain: /quarantine:yes
