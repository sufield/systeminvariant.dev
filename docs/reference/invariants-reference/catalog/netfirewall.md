...
Network Firewall stateless default action for fragmented packets must be aws:drop or aws:forward\_to\_sfe. Fragmented packets are a common evasion technique — passing them uninspected bypasses deep packet inspection.

**Remediation:** Set StatelessFragmentDefaultActions to aws:drop or aws:forward\_to\_sfe.

***

### CTL.NETFIREWALL.DEFAULT.FULL.001[​](#ctlnetfirewalldefaultfull001 "Direct link to CTL.NETFIREWALL.DEFAULT.FULL.001")
...
Network Firewall stateless default action for full packets must be aws:drop or aws:forward\_to\_sfe, not aws:pass. Default PASS means all traffic not matching stateless rules flows uninspected.

**Remediation:** Set StatelessDefaultActions to aws:drop or aws:forward\_to\_sfe.

***

### CTL.NETFIREWALL.DELETEPROT.001[​](#ctlnetfirewalldeleteprot001 "Direct link to CTL.NETFIREWALL.DELETEPROT.001")
...
### CTL.NETFIREWALL.LOG.001[​](#ctlnetfirewalllog001 "Direct link to CTL.NETFIREWALL.LOG.001")
...
### CTL.NETFIREWALL.MODE.001[​](#ctlnetfirewallmode001 "Direct link to CTL.NETFIREWALL.MODE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-7; hipaa: 164.312(c)(1); nist\_800\_53\_r5: SC-7; pci\_dss\_v4.0: 1.2.1; soc2: CC6.6;
...
### CTL.NETFIREWALL.MULTIAZ.001[​](#ctlnetfirewallmultiaz001 "Direct link to CTL.NETFIREWALL.MULTIAZ.001")
...
### CTL.NETFIREWALL.POLICY.RULEGROUP.001[​](#ctlnetfirewallpolicyrulegroup001 "Direct link to CTL.NETFIREWALL.POLICY.RULEGROUP.001")
...
### CTL.NETFIREWALL.ROUTING.001[​](#ctlnetfirewallrouting001 "Direct link to CTL.NETFIREWALL.ROUTING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-7; hipaa: 164.312(e)(1); nist\_800\_53\_r5: SC-7; pci\_dss\_v4.0: 1.2.1; soc2: CC6.6;
...
### CTL.NETFIREWALL.RULEGROUP.ENCRYPT.001[​](#ctlnetfirewallrulegroupencrypt001 "Direct link to CTL.NETFIREWALL.RULEGROUP.ENCRYPT.001")
...
**Remediation:** Recreate the rule group with an EncryptionConfiguration specifying Type CUSTOMER\_KMS and the KMS key ARN. Existing rule groups cannot be updated in place — export the rules, delete, and recreate.

***

### CTL.NETFIREWALL.RULES.PERMISSIVE.001[​](#ctlnetfirewallrulespermissive001 "Direct link to CTL.NETFIREWALL.RULES.PERMISSIVE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-7; nist\_800\_53\_r5: SC-7; pci\_dss\_v4.0: 1.2.1; soc2: CC6.6;
...
### CTL.NETFIREWALL.RULES.STATEFUL.001[​](#ctlnetfirewallrulesstateful001 "Direct link to CTL.NETFIREWALL.RULES.STATEFUL.001")
...
### CTL.NETFIREWALL.TLS.001[​](#ctlnetfirewalltls001 "Direct link to CTL.NETFIREWALL.TLS.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-4; hipaa: 164.312(e)(1); nist\_800\_53\_r5: SI-4; pci\_dss\_v4.0: 11.5.1; soc2: CC7.1;
