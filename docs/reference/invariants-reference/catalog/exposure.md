...
### CTL.EXPOSURE.ANON.001[​](#ctlexposureanon001 "Direct link to CTL.EXPOSURE.ANON.001")
...
### CTL.EXPOSURE.ANON.002[​](#ctlexposureanon002 "Direct link to CTL.EXPOSURE.ANON.002")
...
### CTL.EXPOSURE.ANON.003[​](#ctlexposureanon003 "Direct link to CTL.EXPOSURE.ANON.003")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-7; nist\_800\_53\_r5: SC-7; pci\_dss\_v4.0: 6.4.1; soc2: CC6.6;
...
### CTL.EXPOSURE.ANON.004[​](#ctlexposureanon004 "Direct link to CTL.EXPOSURE.ANON.004")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: SI-3; pci\_dss\_v4.0: 6.4.2;
...
### CTL.EXPOSURE.ANON.INCOMPLETE.001[​](#ctlexposureanonincomplete001 "Direct link to CTL.EXPOSURE.ANON.INCOMPLETE.001")
...
### CTL.EXPOSURE.ANON.PARTIAL.001[​](#ctlexposureanonpartial001 "Direct link to CTL.EXPOSURE.ANON.PARTIAL.001")
...
### CTL.EXPOSURE.EXFIL.001[​](#ctlexposureexfil001 "Direct link to CTL.EXPOSURE.EXFIL.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-7; hipaa: 164.312(a)(1); nist\_800\_53\_r5: SC-7; pci\_dss\_v4.0: 3.4.1; soc2: CC6.7;
...
### CTL.EXPOSURE.EXFIL.002[​](#ctlexposureexfil002 "Direct link to CTL.EXPOSURE.EXFIL.002")
...
### CTL.EXPOSURE.EXFIL.INCOMPLETE.001[​](#ctlexposureexfilincomplete001 "Direct link to CTL.EXPOSURE.EXFIL.INCOMPLETE.001")
...
Data exfiltration path assessment requires the exfiltration kind discriminator and the path\_to\_internet\_exists field. The extractor could not determine whether the compute instance has internet egress.
...
### CTL.EXPOSURE.SOVEREIGNTY.001[​](#ctlexposuresovereignty001 "Direct link to CTL.EXPOSURE.SOVEREIGNTY.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-4; gdpr: Art.44; nist\_800\_53\_r5: AC-4;
...
### CTL.EXPOSURE.SOVEREIGNTY.INCOMPLETE.001[​](#ctlexposuresovereigntyincomplete001 "Direct link to CTL.EXPOSURE.SOVEREIGNTY.INCOMPLETE.001")
...
Sovereignty assessment requires the cross\_border\_access\_detected field. The extractor could not determine whether the resource is accessible from outside its jurisdiction.
