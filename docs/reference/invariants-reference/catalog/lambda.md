...
### CTL.LAMBDA.ALARM.ERRORS.001[​](#ctllambdaalarmerrors001 "Direct link to CTL.LAMBDA.ALARM.ERRORS.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** fedramp\_moderate: SI-4; nist\_800\_53\_r5: SI-4; pci\_dss\_v4.0: 10.4.1; soc2: CC7.2;
...
**Remediation:** Create a CloudWatch alarm on AWS/Lambda Errors with an SNS notification action — aws cloudwatch put-metric-alarm --metric-name Errors --namespace AWS/Lambda --dimensions Name=FunctionName,Value=.

***

### CTL.LAMBDA.ALARM.ITERATORAGE.001[​](#ctllambdaalarmiteratorage001 "Direct link to CTL.LAMBDA.ALARM.ITERATORAGE.001")
...
### CTL.LAMBDA.ALARM.THROTTLES.001[​](#ctllambdaalarmthrottles001 "Direct link to CTL.LAMBDA.ALARM.THROTTLES.001")
...
### CTL.LAMBDA.CODESIGN.001[​](#ctllambdacodesign001 "Direct link to CTL.LAMBDA.CODESIGN.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** aws\_security\_hub: Lambda.5; mitre\_attack: T1059; nist\_800\_53\_r5: SI-7;
...
**Remediation:** Create an AWS Signer signing profile, create a code signing config referencing the profile, and attach it to the function: aws lambda put-function-code-signing-config --function-name --code-signing-config-arn

***

### CTL.LAMBDA.CODESIGN.ENFORCE.001[​](#ctllambdacodesignenforce001 "Direct link to CTL.LAMBDA.CODESIGN.ENFORCE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-7; hipaa: 164.312(c)(1); nist\_800\_53\_r5: SI-7; pci\_dss\_v4.0: 6.3.2; soc2: CC7.1;
...
### CTL.LAMBDA.CONCURRENCY.001[​](#ctllambdaconcurrency001 "Direct link to CTL.LAMBDA.CONCURRENCY.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-5; hipaa: 164.308(a)(7); nist\_800\_53\_r5: SC-5; pci\_dss\_v4.0: 1.3.2; soc2: A1.1;
...
**Remediation:** Set reserved concurrency via aws lambda put-function-concurrency --reserved-concurrent-executions . Choose a value that bounds the function's maximum invocations while leaving headroom for other critical functions.

***

### CTL.LAMBDA.CONFIG.CONCURRENCY.NOLIMIT.001[​](#ctllambdaconfigconcurrencynolimit001 "Direct link to CTL.LAMBDA.CONFIG.CONCURRENCY.NOLIMIT.001")
...
**Remediation:** Set reserved concurrency to a value that bounds the function's maximum simultaneous executions and preserves headroom for other functions in the account via aws lambda put-function-concurrency --reserved-concurrent-executions . If public invocability is not intended, remove the public surface first (Function URL AuthType to AWS\_IAM, or attach an authorizer to the API Gateway route).

***

### CTL.LAMBDA.CONFIG.MEMORY.EXCESSIVE.001[​](#ctllambdaconfigmemoryexcessive001 "Direct link to CTL.LAMBDA.CONFIG.MEMORY.EXCESSIVE.001")
...
**Remediation:** Reduce the timeout to the lowest value that accommodates the function's actual runtime — most workloads complete in well under 60 seconds — via aws lambda update-function-configuration --timeout . If 900s is required (long-running ETL, batch processing), tag the function stave/lambda-timeout-justified with the reason.

***

### CTL.LAMBDA.DLQ.001[​](#ctllambdadlq001 "Direct link to CTL.LAMBDA.DLQ.001")
...
### CTL.LAMBDA.DLQ.MISSING.001[​](#ctllambdadlqmissing001 "Direct link to CTL.LAMBDA.DLQ.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: CP-10; hipaa: 164.308(a)(7); nist\_800\_53\_r5: CP-10; soc2: A1.2;
...
**Remediation:** Configure a dead-letter queue via aws lambda update-function-configuration --dead-letter-config TargetArn=, or attach an EventInvokeConfig OnFailure destination via aws lambda put-function-event-invoke-config.

***

### CTL.LAMBDA.ENCRYPT.KMS.POLICY.001[​](#ctllambdaencryptkmspolicy001 "Direct link to CTL.LAMBDA.ENCRYPT.KMS.POLICY.001")
...
### CTL.LAMBDA.ENV.ENCRYPT.001[​](#ctllambdaenvencrypt001 "Direct link to CTL.LAMBDA.ENV.ENCRYPT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-28; hipaa: 164.312(a)(2)(iv); nist\_800\_53\_r5: SC-28; pci\_dss\_v4.0: 3.4.1; soc2: CC6.7;
...
### CTL.LAMBDA.ENV.EXCESSIVE.001[​](#ctllambdaenvexcessive001 "Direct link to CTL.LAMBDA.ENV.EXCESSIVE.001")
...
### CTL.LAMBDA.ENV.KMS.EXTERNAL.001[​](#ctllambdaenvkmsexternal001 "Direct link to CTL.LAMBDA.ENV.KMS.EXTERNAL.001")
...
* **Type:** unsafe\_state
* **Domain:** encryption
* **Compliance:** nist\_800\_53\_r5: SC-12; pci\_dss\_v4: 3.6;
...
### CTL.LAMBDA.ENV.SECRETS.001[​](#ctllambdaenvsecrets001 "Direct link to CTL.LAMBDA.ENV.SECRETS.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-28; hipaa: 164.312(a)(2)(iv); nist\_800\_53\_r5: SC-28; owasp\_nhi: NHI2; pci\_dss\_v4.0: 3.5.1; soc2: CC6.1;
...
### CTL.LAMBDA.ENV.VISIBLE.VERSIONS.001[​](#ctllambdaenvvisibleversions001 "Direct link to CTL.LAMBDA.ENV.VISIBLE.VERSIONS.001")
...
* **Type:** unsafe\_state
* **Domain:** secrets
* **Compliance:** nist\_800\_53\_r5: MP-6; owasp\_nhi: NHI2; pci\_dss\_v4: 3.5;
...
### CTL.LAMBDA.ESM.BISECT.001[​](#ctllambdaesmbisect001 "Direct link to CTL.LAMBDA.ESM.BISECT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-11; nist\_800\_53\_r5: SI-11; soc2: A1.2;
...
### CTL.LAMBDA.ESM.NODLQ.001[​](#ctllambdaesmnodlq001 "Direct link to CTL.LAMBDA.ESM.NODLQ.001")
...
**Remediation:** Add a failure destination to the event source mapping via aws lambda update-event-source-mapping --destination-config OnFailure={Destination=}.

***

### CTL.LAMBDA.GHOST.DEST.S3.001[​](#ctllambdaghostdests3001 "Direct link to CTL.LAMBDA.GHOST.DEST.S3.001")
...
**Remediation:** Update the Lambda destination configuration to an existing S3 bucket or remove the destination if no longer needed: aws lambda put-function-event-invoke-config --function-name --destination-config OnSuccess={Destination=arn:aws:s3:::}.

***

### CTL.LAMBDA.GHOST.DLQ.001[​](#ctllambdaghostdlq001 "Direct link to CTL.LAMBDA.GHOST.DLQ.001")
...
### CTL.LAMBDA.GHOST.KMS.001[​](#ctllambdaghostkms001 "Direct link to CTL.LAMBDA.GHOST.KMS.001")
...
* **Type:** unsafe\_state
* **Domain:** encryption
* **Compliance:** nist\_800\_53\_r5: SC-12;
...
### CTL.LAMBDA.GHOST.ROLE.001[​](#ctllambdaghostrole001 "Direct link to CTL.LAMBDA.GHOST.ROLE.001")
...
### CTL.LAMBDA.GHOST.VPC.001[​](#ctllambdaghostvpc001 "Direct link to CTL.LAMBDA.GHOST.VPC.001")
...
### CTL.LAMBDA.INVOKE.PUBLIC.001[​](#ctllambdainvokepublic001 "Direct link to CTL.LAMBDA.INVOKE.PUBLIC.001")
...
**Remediation:** Remove the public invoke permission from the function policy: aws lambda remove-permission --function-name --statement-id

***

### CTL.LAMBDA.LAYER.GHOST.001[​](#ctllambdalayerghost001 "Direct link to CTL.LAMBDA.LAYER.GHOST.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: SI-7; soc2: CC6.1;
...
### CTL.LAMBDA.LAYER.ORIGIN.001[​](#ctllambdalayerorigin001 "Direct link to CTL.LAMBDA.LAYER.ORIGIN.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-7; gdpr: Art.32; nist\_800\_53\_r5: SI-7; soc2: CC7.1;
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: IA-5; owasp\_nhi: NHI2; pci\_dss\_v4.0: 8.3.4; soc2: CC6.1;
...
### CTL.LAMBDA.LIFECYCLE.DORMANT.001[​](#ctllambdalifecycledormant001 "Direct link to CTL.LAMBDA.LIFECYCLE.DORMANT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: CM-2; hipaa: 164.308(a)(1)(ii)(B); nist\_800\_53\_r5: CM-2; soc2: CC6.1;
...
### CTL.LAMBDA.LIFECYCLE.NOTRIGGER.001[​](#ctllambdalifecyclenotrigger001 "Direct link to CTL.LAMBDA.LIFECYCLE.NOTRIGGER.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: CM-3; hipaa: 164.308(a)(1)(ii)(B); nist\_800\_53\_r5: CM-3; soc2: CC8.1;
...
### CTL.LAMBDA.LIFECYCLE.ORPHANLOG.001[​](#ctllambdalifecycleorphanlog001 "Direct link to CTL.LAMBDA.LIFECYCLE.ORPHANLOG.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** mitre\_attack: T1526; nist\_800\_53\_r5: AC-6;
...
### CTL.LAMBDA.LOG.001[​](#ctllambdalog001 "Direct link to CTL.LAMBDA.LOG.001")
...
### CTL.LAMBDA.LOG.ENCRYPT.001[​](#ctllambdalogencrypt001 "Direct link to CTL.LAMBDA.LOG.ENCRYPT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AU-9; hipaa: 164.312(a)(2)(iv); nist\_800\_53\_r5: AU-9; pci\_dss\_v4.0: 10.3.2; soc2: CC6.1;
...
**Remediation:** Associate a CMK with the log group via aws logs associate-kms-key --log-group-name /aws/lambda/ --kms-key-id . Ensure the CMK key policy permits logs..amazonaws.com to use the key.

***

### CTL.LAMBDA.LOG.MISSING.001[​](#ctllambdalogmissing001 "Direct link to CTL.LAMBDA.LOG.MISSING.001")
...
### CTL.LAMBDA.LOG.RETENTION.001[​](#ctllambdalogretention001 "Direct link to CTL.LAMBDA.LOG.RETENTION.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AU-11; hipaa: 164.312(b); nist\_800\_53\_r5: AU-11; pci\_dss\_v4.0: 10.5.1; soc2: CC7.2;
...
**Remediation:** Set CloudWatch log group retention to 365 days or more via aws logs put-retention-policy --log-group-name /aws/lambda/ --retention-in-days 365.

***

### CTL.LAMBDA.MARKER.BEDROCK.TOOL.001[​](#ctllambdamarkerbedrocktool001 "Direct link to CTL.LAMBDA.MARKER.BEDROCK.TOOL.001")
...
### CTL.LAMBDA.MICROVM.AUTHTOKEN.EXPIRY.001[​](#ctllambdamicrovmauthtokenexpiry001 "Direct link to CTL.LAMBDA.MICROVM.AUTHTOKEN.EXPIRY.001")
...
lambda:CreateMicrovmAuthToken mints a bearer token for a MicroVM and takes an expiration parameter. AWS best practice is a 15–30 minute lifetime; a long-lived token is a stolen-credential window (an 8-hour token gives an attacker an 8-hour foothold). If a role that can create auth tokens has no IAM policy condition constraining the expiration — or constrains it above 30 minutes — any caller can mint long-lived tokens. This control reads collector-resolved signals, not raw policy JSON. The collector resolves the role's effective permissions (inline + attached managed + boundary, expanding lambda:\* which includes CreateMicrovmAuthToken) into role.microvm\_authtoken\_create, and inspects the Allow statement's Condition for a numeric upper bound on the expiration condition key, emitting role.microvm\_authtoken\_expiry\_constrained and (when present) role.microvm\_authtoken\_expiry\_max\_minutes. Note on condition keys: the exact IAM condition key for MicroVM token expiration may not yet be published by AWS. The collector matches whatever key AWS uses (e.g. lambda:AuthTokenExpirationInMinutes); if it cannot resolve a constraint it MUST emit expiry\_constrained=false — fail-loud, treated as unconstrained (FAIL), never a silent PASS.
...
### CTL.LAMBDA.MICROVM.AUTHTOKEN.PORTSCOPE.001[​](#ctllambdamicrovmauthtokenportscope001 "Direct link to CTL.LAMBDA.MICROVM.AUTHTOKEN.PORTSCOPE.001")
...
lambda:CreateMicrovmAuthToken takes an allowedPorts parameter. A token minted without port scoping grants access to EVERY listening port on the MicroVM — the application port, debug ports, metrics, internal services, and critically the lifecycle hook port (the internal Lambda↔MicroVM API exposing /suspend, /terminate). An unscoped token lets its holder disrupt production or extract state. The lifecycle hook port (configured separately from the app port, per AWS) must never be reachable by an external auth token. Reads collector-resolved signals. The collector resolves role.microvm\_authtoken\_create (effective, incl. the lambda:\* wildcard), whether the Allow statement constrains allowed ports (role.microvm\_authtoken\_port\_scoped), and whether the allowed set includes the MicroVM's configured lifecycle hook port (role.microvm\_authtoken\_allows\_lifecycle\_port — cross-referenced against the MicroVM lifecycle-port config). Safe default / fail-loud: if no port constraint is resolvable (including when AWS has not yet published an allowed-ports condition key), the collector emits port\_scoped=false → FAIL. An unscoped token is unsafe regardless of whether the constraint mechanism exists yet.
...
### CTL.LAMBDA.MICROVM.BASEIMAGE.001[​](#ctllambdamicrovmbaseimage001 "Direct link to CTL.LAMBDA.MICROVM.BASEIMAGE.001")
...
### CTL.LAMBDA.MICROVM.BUILDROLE.001[​](#ctllambdamicrovmbuildrole001 "Direct link to CTL.LAMBDA.MICROVM.BUILDROLE.001")
...
### CTL.LAMBDA.MICROVM.CONNORIGIN.001[​](#ctllambdamicrovmconnorigin001 "Direct link to CTL.LAMBDA.MICROVM.CONNORIGIN.001")
...
### CTL.LAMBDA.MICROVM.CONNROLE.001[​](#ctllambdamicrovmconnrole001 "Direct link to CTL.LAMBDA.MICROVM.CONNROLE.001")
...
### CTL.LAMBDA.MICROVM.DATAEVENTS.001[​](#ctllambdamicrovmdataevents001 "Direct link to CTL.LAMBDA.MICROVM.DATAEVENTS.001")
...
### CTL.LAMBDA.MICROVM.ENTROPY.001[​](#ctllambdamicrovmentropy001 "Direct link to CTL.LAMBDA.MICROVM.ENTROPY.001")
...
### CTL.LAMBDA.MICROVM.EXECROLE.001[​](#ctllambdamicrovmexecrole001 "Direct link to CTL.LAMBDA.MICROVM.EXECROLE.001")
...
### CTL.LAMBDA.MICROVM.IDENTITY.001[​](#ctllambdamicrovmidentity001 "Direct link to CTL.LAMBDA.MICROVM.IDENTITY.001")
...
### CTL.LAMBDA.MICROVM.IDLE.001[​](#ctllambdamicrovmidle001 "Direct link to CTL.LAMBDA.MICROVM.IDLE.001")
...
### CTL.LAMBDA.MICROVM.INGRESSAUTH.001[​](#ctllambdamicrovmingressauth001 "Direct link to CTL.LAMBDA.MICROVM.INGRESSAUTH.001")
...
### CTL.LAMBDA.MICROVM.OBSERVABILITY.ROLES.001[​](#ctllambdamicrovmobservabilityroles001 "Direct link to CTL.LAMBDA.MICROVM.OBSERVABILITY.ROLES.001")
...
### CTL.LAMBDA.MICROVM.RUNTIME.001[​](#ctllambdamicrovmruntime001 "Direct link to CTL.LAMBDA.MICROVM.RUNTIME.001")
...
### CTL.LAMBDA.MICROVM.S3PUBLIC.001[​](#ctllambdamicrovms3public001 "Direct link to CTL.LAMBDA.MICROVM.S3PUBLIC.001")
...
### CTL.LAMBDA.MICROVM.S3VERSION.001[​](#ctllambdamicrovms3version001 "Direct link to CTL.LAMBDA.MICROVM.S3VERSION.001")
...
### CTL.LAMBDA.MICROVM.SG.001[​](#ctllambdamicrovmsg001 "Direct link to CTL.LAMBDA.MICROVM.SG.001")
...
### CTL.LAMBDA.MICROVM.SHELLAUTH.001[​](#ctllambdamicrovmshellauth001 "Direct link to CTL.LAMBDA.MICROVM.SHELLAUTH.001")
...
Lambda MicroVMs have first-class interactive shell access via lambda:CreateMicrovmShellAuthToken, which returns a bearer token granting an interactive shell inside a running MicroVM. Any non-break-glass IAM role holding this permission turns a single compromised credential into an interactive shell inside production compute, bypassing every application-layer control. Only explicitly designated break-glass roles may hold it. This control evaluates a derived signal, not raw policy JSON. The collector resolves the role's EFFECTIVE permissions (inline + attached managed policies + permission boundaries, expanding lambda:\* — which includes the shell token action) and emits role.microvm\_shell\_auth. It also resolves role.is\_break\_glass (tag break-glass:true, or name matching *break-glass* / *emergency*) and role.workload\_type (agent | cicd | human | service). This HIGH control fires for ordinary roles (human/service); agent and CI/CD roles are escalated to CRITICAL by CTL.LAMBDA.MICROVM.SHELLAUTH.ELEVATED.001, so the two never double-fire. Fail-loud: the collector MUST emit role.microvm\_shell\_auth explicitly (false when no grant); if effective-permission resolution fails it must surface that (e.g. present:false or an explicit marker), never omit the field — a missing signal must not read as a silent PASS.
...
### CTL.LAMBDA.MICROVM.SHELLAUTH.ELEVATED.001[​](#ctllambdamicrovmshellauthelevated001 "Direct link to CTL.LAMBDA.MICROVM.SHELLAUTH.ELEVATED.001")
...
An agent execution role or a CI/CD role holding lambda:CreateMicrovmShellAuthToken is CRITICAL, not merely high: a prompt-injected AI agent or a compromised pipeline credential would gain an interactive shell inside production MicroVMs. These workload classes should never have interactive shell access under any circumstance — there is no legitimate break-glass case for a non-human automation identity. This is the CRITICAL-severity counterpart to CTL.LAMBDA.MICROVM.SHELLAUTH.001 (HIGH, ordinary roles). ctrl.v1 controls carry a single static severity, so the HIGH/CRITICAL escalation is expressed as two disjoint controls: this one fires only when role.workload\_type is agent or cicd, the HIGH one only when it is neither — they never both fire on the same role. The collector resolves role.microvm\_shell\_auth (effective, incl. attached managed policies and the lambda:\* wildcard), role.is\_break\_glass, and role.workload\_type (from the agent taxonomy and CI/CD trust-policy heuristics). Fail-loud: role.microvm\_shell\_auth must be emitted explicitly; a resolution failure must surface, never read as a silent PASS.
...
### CTL.LAMBDA.MICROVM.SHELLINGRESS.001[​](#ctllambdamicrovmshellingress001 "Direct link to CTL.LAMBDA.MICROVM.SHELLINGRESS.001")

**Production MicroVM Must Not Be Launched With the SHELL\_INGRESS Connector**
...
Interactive shell access to a MicroVM (lambda:CreateMicrovmShellAuthToken) fails with ValidationException unless the MicroVM was launched with the SHELL\_INGRESS network connector (arn:aws:lambda::aws:network-connector:aws-network-connector:SHELL\_INGRESS). Without that connector, shell access is STRUCTURALLY IMPOSSIBLE regardless of IAM. A production MicroVM launched with SHELL\_INGRESS has shell access enabled at the infrastructure level. This is the stronger of the two shell controls: MICROVM-021 (infrastructure) > CTL.LAMBDA.MICROVM.SHELLAUTH.001 (IAM) in assurance — IAM restricts who MAY create a shell token; the connector decides whether a shell is possible AT ALL. Defense in depth: remove the connector in production and no IAM mistake can grant a shell. The collector emits microvm.shell\_ingress\_connector (any launched connector ARN matches the SHELL\_INGRESS pattern) and microvm.is\_production (tag environment=production/prod, or a production account/OU). Dev/staging MicroVMs with SHELL\_INGRESS are intentionally out of scope for this control (acceptable for development); only production fires.

**Remediation:** Relaunch the production MicroVM without the SHELL\_INGRESS connector. Shell access then becomes impossible by construction — CreateMicrovmShellAuthToken returns ValidationException — independent of any IAM grant.

***

### CTL.LAMBDA.MICROVM.SNAPSHOTSECRET.001[​](#ctllambdamicrovmsnapshotsecret001 "Direct link to CTL.LAMBDA.MICROVM.SNAPSHOTSECRET.001")
...
### CTL.LAMBDA.MICROVM.SUBNET.001[​](#ctllambdamicrovmsubnet001 "Direct link to CTL.LAMBDA.MICROVM.SUBNET.001")
...
### CTL.LAMBDA.MICROVM.TAGSESSION.MISSING.001[​](#ctllambdamicrovmtagsessionmissing001 "Direct link to CTL.LAMBDA.MICROVM.TAGSESSION.MISSING.001")
...
### CTL.LAMBDA.MICROVM.TAGSESSION.WILDCARD.001[​](#ctllambdamicrovmtagsessionwildcard001 "Direct link to CTL.LAMBDA.MICROVM.TAGSESSION.WILDCARD.001")
...
### CTL.LAMBDA.MICROVM.WILDCARD.001[​](#ctllambdamicrovmwildcard001 "Direct link to CTL.LAMBDA.MICROVM.WILDCARD.001")
...
AWS placed the MicroVM actions inside the existing lambda: namespace, so any role granted lambda:\* now ALSO holds lambda:RunMicrovm, lambda:CreateMicrovmAuthToken, lambda:CreateMicrovmShellAuthToken (interactive shell), lambda:TerminateMicrovm/SuspendMicrovm (lifecycle control), and lambda:CreateMicrovmImage. Most organizations granted lambda:\* for ordinary Lambda-function management long before MicroVMs existed — those policies were never reviewed for MicroVM blast radius because MicroVMs did not exist when they were written. The blast radius expanded silently. This HIGH control flags a non-MicroVM-admin role holding lambda:\* (human or service workloads); agent and CI/CD roles are escalated to CRITICAL by CTL.LAMBDA.MICROVM.WILDCARD.ELEVATED.001, so the two never double-fire. The collector resolves role.has\_lambda\_wildcard from EFFECTIVE permissions — inline AND attached managed policies (e.g. AWS-published AWSLambda\_FullAccess, which grants lambda:\*) AND boundaries — plus role.is\_microvm\_admin (tag microvm-admin:true or name *microvm-admin*) and role.workload\_type. Expect findings in most Lambda-heavy accounts; that is the point.

**Remediation:** Replace lambda:\* with the explicit Lambda actions the role actually needs (e.g. lambda:InvokeFunction, lambda:UpdateFunctionCode). If the role is genuinely a MicroVM administrator, tag it microvm-admin=true to make the grant deliberate and reviewed. Check attached managed policies (AWSLambda\_FullAccess grants lambda:\*), not just inline.

***

### CTL.LAMBDA.MICROVM.WILDCARD.ELEVATED.001[​](#ctllambdamicrovmwildcardelevated001 "Direct link to CTL.LAMBDA.MICROVM.WILDCARD.ELEVATED.001")
...
An agent execution role or a CI/CD role holding lambda:\* is CRITICAL: the wildcard — granted for ordinary Lambda management before MicroVMs existed — now includes lambda:CreateMicrovmShellAuthToken (interactive shell), lambda:RunMicrovm, and lambda:Terminate/SuspendMicrovm. A prompt-injected agent or a compromised pipeline credential gains full MicroVM control, including a production shell, through a permission nobody reviewed for MicroVM blast radius. CRITICAL counterpart to CTL.LAMBDA.MICROVM.WILDCARD.001 (HIGH). ctrl.v1 severity is static per control, so the escalation is two disjoint controls: this fires only when role.workload\_type is agent or cicd; the HIGH one only when it is neither. role.has\_lambda\_wildcard is resolved from effective permissions (inline AND attached managed policies such as AWSLambda\_FullAccess AND boundaries) — so a scoped-looking inline policy does not hide a wildcard granted by an attached managed policy.

**Remediation:** Replace lambda:\* with the explicit, minimal Lambda actions the automation needs. Automation identities must never hold the MicroVM shell/run/lifecycle actions; there is no microvm-admin exception for an agent or pipeline role. Inspect attached managed policies (AWSLambda\_FullAccess), not just inline.

***

### CTL.LAMBDA.OVERPERM.S3PHI.001[​](#ctllambdaoverperms3phi001 "Direct link to CTL.LAMBDA.OVERPERM.S3PHI.001")
...
### CTL.LAMBDA.PASSROLE.001[​](#ctllambdapassrole001 "Direct link to CTL.LAMBDA.PASSROLE.001")
...
### CTL.LAMBDA.POLICY.ACCUMULATED.001[​](#ctllambdapolicyaccumulated001 "Direct link to CTL.LAMBDA.POLICY.ACCUMULATED.001")
...
### CTL.LAMBDA.POLICY.CROSSACCOUNT.001[​](#ctllambdapolicycrossaccount001 "Direct link to CTL.LAMBDA.POLICY.CROSSACCOUNT.001")
...
* **Type:** unsafe\_state
* **Domain:** access
* **Compliance:** nist\_800\_53\_r5: AC-3; pci\_dss\_v4: 7.2;
...
### CTL.LAMBDA.ROLE.LEASTPRIV.001[​](#ctllambdaroleleastpriv001 "Direct link to CTL.LAMBDA.ROLE.LEASTPRIV.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-6; hipaa: 164.312(a)(1); nist\_800\_53\_r5: AC-6; pci\_dss\_v4.0: 7.2.1; soc2: CC6.1;
...
### CTL.LAMBDA.ROLE.SHARED.001[​](#ctllambdaroleshared001 "Direct link to CTL.LAMBDA.ROLE.SHARED.001")
...
### CTL.LAMBDA.RUNTIME.001[​](#ctllambdaruntime001 "Direct link to CTL.LAMBDA.RUNTIME.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: CM-6; hipaa: 164.312(a)(2)(iv); nist\_800\_53\_r5: CM-6; pci\_dss\_v4.0: 2.2.1; soc2: CC7.1;
...
### CTL.LAMBDA.RUNTIME.EOL.001[​](#ctllambdaruntimeeol001 "Direct link to CTL.LAMBDA.RUNTIME.EOL.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** aws\_security\_hub: Lambda.2; mitre\_attack: T1203; nist\_800\_53\_r5: SI-2;
...
### CTL.LAMBDA.SCIM.TAKEOVER.001[​](#ctllambdascimtakeover001 "Direct link to CTL.LAMBDA.SCIM.TAKEOVER.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** nist\_800\_53\_r5: AC-3, AC-6, SC-7; owasp\_nhi: NHI5; pci\_dss\_v4.0: 7.2.1; soc2: CC6.1, CC6.6;

A SCIM integration handler sits at the centre of a critical compound exposure: the SCIM endpoint it serves is publicly reachable with no effective gateway authentication, its execution role is overprivileged, and the SCIM bearer token is reachable. An attacker who obtains the token (from a Lambda env var, or a secret readable by a compromised role) hits the public endpoint and operates with the overprivileged handler's permissions — creating admin users, setting passwords, modifying attributes. Full provisioning takeover. This is the chain no individual control sees. It composes existing detections (it does NOT duplicate them): the unauthenticated endpoint is also caught by CTL.APIGATEWAY.AUTH.001, the env-var token by CTL.LAMBDA.ENV.SECRETS.001, the overprivileged role by CTL.LAMBDA.ROLE.LEASTPRIV.001. The FN trap is an AWS\_IAM-authorized endpoint whose API Gateway resource policy allows Principal:"\*" — IAM auth with a permissive resource policy is effectively no auth (reuses CTL.APIGATEWAY.AUTH.IAM.UNRESTRICTED.001). Computed by examples/scim-provisioning-takeover/ (Soufflé + Z3, which agree). Stave covers the infrastructure misconfiguration surface; the SCIM handler's code behaviour (parser differentials, verification bypass, re-provisioning fallback) requires application-level testing — see docs/contract/scim.md. Infrastructure control inspired by Doyensec "SCIM Hunting — Beyond SSO".
...
### CTL.LAMBDA.SECRETS.BROKEN.REF.001[​](#ctllambdasecretsbrokenref001 "Direct link to CTL.LAMBDA.SECRETS.BROKEN.REF.001")
...
* **Type:** unsafe\_state
* **Domain:** secrets
* **Compliance:** nist\_800\_53\_r5: AC-3; owasp\_nhi: NHI2; pci\_dss\_v4: 7.2;
...
### CTL.LAMBDA.SECRETS.NOTMANAGED.001[​](#ctllambdasecretsnotmanaged001 "Direct link to CTL.LAMBDA.SECRETS.NOTMANAGED.001")
...
### CTL.LAMBDA.SECRETS.SSM.INSECURE.001[​](#ctllambdasecretsssminsecure001 "Direct link to CTL.LAMBDA.SECRETS.SSM.INSECURE.001")
...
* **Type:** unsafe\_state
* **Domain:** secrets
* **Compliance:** nist\_800\_53\_r5: SC-28; owasp\_nhi: NHI2, NHI9; pci\_dss\_v4: 3.4;
...
### CTL.LAMBDA.TIMEOUT.001[​](#ctllambdatimeout001 "Direct link to CTL.LAMBDA.TIMEOUT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-5; hipaa: 164.308(a)(7); nist\_800\_53\_r5: SC-5; soc2: A1.1;
...
### CTL.LAMBDA.TRACE.001[​](#ctllambdatrace001 "Direct link to CTL.LAMBDA.TRACE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AU-12; hipaa: 164.312(b); nist\_800\_53\_r5: AU-12; pci\_dss\_v4.0: 10.2.1; soc2: CC7.1;
...
### CTL.LAMBDA.TRIGGER.APIGATEWAY.NOAUTH.001[​](#ctllambdatriggerapigatewaynoauth001 "Direct link to CTL.LAMBDA.TRIGGER.APIGATEWAY.NOAUTH.001")
...
* **Type:** unsafe\_state
* **Domain:** access
* **Compliance:** fedramp\_moderate: AC-3; hipaa: 164.312(a)(1); nist\_800\_53\_r5: AC-3; pci\_dss\_v4.0: 6.4.2; soc2: CC6.1;
...
**Remediation:** Attach an authorizer to the route — IAM auth (AuthType AWS\_IAM), Cognito user pool authorizer, Lambda authorizer, or API key requirement. For public APIs that must remain unauthenticated, document the exposure and reduce blast radius by tightening the function's execution-role permissions.

***

### CTL.LAMBDA.TRIGGER.CONFUSEDDEPUTY.001[​](#ctllambdatriggerconfuseddeputy001 "Direct link to CTL.LAMBDA.TRIGGER.CONFUSEDDEPUTY.001")
...
* **Type:** unsafe\_state
* **Domain:** access
* **Compliance:** fedramp\_moderate: AC-3; hipaa: 164.312(a)(1); nist\_800\_53\_r5: AC-3; pci\_dss\_v4.0: 1.2.1; soc2: CC6.1;
...
### CTL.LAMBDA.TRIGGER.GHOST.001[​](#ctllambdatriggerghost001 "Direct link to CTL.LAMBDA.TRIGGER.GHOST.001")
...
### CTL.LAMBDA.UPDATECODE.SCOPE.001[​](#ctllambdaupdatecodescope001 "Direct link to CTL.LAMBDA.UPDATECODE.SCOPE.001")
...
### CTL.LAMBDA.URL.AUTH.001[​](#ctllambdaurlauth001 "Direct link to CTL.LAMBDA.URL.AUTH.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-3; hipaa: 164.312(a)(1); nist\_800\_53\_r5: AC-3; pci\_dss\_v4.0: 7.2.1; soc2: CC6.1;
...
**Remediation:** Set the function URL AuthType to AWS\_IAM to require IAM signature authentication for all invocations. If the function URL is not needed, remove it entirely via aws lambda delete-function-url-config. Note that Lambda resource-based policy restrictions do not apply to function URL invocations — AuthType is the only authentication gate for function URLs.

***

### CTL.LAMBDA.URL.CORS.001[​](#ctllambdaurlcors001 "Direct link to CTL.LAMBDA.URL.CORS.001")
...
**Remediation:** Update the function URL config via "aws lambda update-function-url-config --function-name --cors '...'" with either AllowCredentials set to false or an AllowOrigins list that enumerates specific origins. If the function handles sensitive operations, also confirm AuthType is AWS\_IAM (see CTL.LAMBDA.URL.AUTH.001).

***

### CTL.LAMBDA.VPC.ENDPOINTS.001[​](#ctllambdavpcendpoints001 "Direct link to CTL.LAMBDA.VPC.ENDPOINTS.001")
...
### CTL.LAMBDA.VPC.SENSITIVE.001[​](#ctllambdavpcsensitive001 "Direct link to CTL.LAMBDA.VPC.SENSITIVE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-7; hipaa: 164.312(e)(1); nist\_800\_53\_r5: SC-7; pci\_dss\_v4.0: 1.3.1; soc2: CC6.6;
...
### CTL.LAMBDA.VPC.SUBNET.001[​](#ctllambdavpcsubnet001 "Direct link to CTL.LAMBDA.VPC.SUBNET.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-7; nist\_800\_53\_r5: SC-7; pci\_dss\_v4.0: 1.3.1; soc2: CC6.6;
