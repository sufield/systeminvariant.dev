...
### CTL.APIGATEWAY.ACCESSLOG.CMK.001[​](#ctlapigatewayaccesslogcmk001 "Direct link to CTL.APIGATEWAY.ACCESSLOG.CMK.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** fedramp\_moderate: AU-9, SC-12, SC-28; hipaa: 164.312(a)(2)(iv), 164.312(e)(2)(ii); iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: AU-9, SC-12, SC-13, SC-28; pci\_dss\_v4.0: 3.5, 10.5; soc2: CC6.1, CC6.7;
...
**Remediation:** Associate a customer-managed KMS key with the log group: aws logs associate-kms-key --log-group-name --kms-key-id arn:aws:kms:REGION:ACCOUNT:key/. The key policy must allow the CloudWatch Logs service principal in the appropriate region to encrypt and decrypt; AWS publishes the required policy snippet. New log streams are encrypted under the new key; existing log streams remain encrypted under whatever key was active when they were written.

***

### CTL.APIGATEWAY.ACCESSLOG.FORMAT.INCOMPLETE.001[​](#ctlapigatewayaccesslogformatincomplete001 "Direct link to CTL.APIGATEWAY.ACCESSLOG.FORMAT.INCOMPLETE.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** fedramp\_moderate: AU-4, AU-11; iso\_27001\_2022: A.5.33, A.8.10; nist\_800\_53\_r5: AU-4, AU-11, SI-12; pci\_dss\_v4.0: 10.5, 10.7; soc2: CC7.2, A1.1;
...
**Remediation:** Set the log group retention to the period the compliance framework requires (or the operator-chosen window, whichever is longer): aws logs put-retention-policy --log-group-name /aws/apigateway/ --retention-in-days 365. Common values: 90 (general security), 365 (SOC 2), 2557 (HIPAA 7 years). For longer-than-CloudWatch retention windows, configure subscription filters to ship into S3 with object lifecycle policies and Glacier transitions.

***

### CTL.APIGATEWAY.ACCESSLOG.S3.NODELETE.001[​](#ctlapigatewayaccesslogs3nodelete001 "Direct link to CTL.APIGATEWAY.ACCESSLOG.S3.NODELETE.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** cis\_aws\_v3.0: 3.6; fedramp\_moderate: AU-9, AU-11; iso\_27001\_2022: A.5.33, A.8.10, A.8.15; nist\_800\_53\_r5: AU-9, AU-11; pci\_dss\_v4.0: 10.5, 10.7; soc2: CC6.1, CC7.2, CC8.1;
...
### CTL.APIGATEWAY.ACCOUNT.THROTTLE.DEFAULT.001[​](#ctlapigatewayaccountthrottledefault001 "Direct link to CTL.APIGATEWAY.ACCOUNT.THROTTLE.DEFAULT.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SC-5, CM-2; iso\_27001\_2022: A.5.30, A.8.6; nist\_800\_53\_r5: SC-5, CM-2; pci\_dss\_v4.0: 6.4.1; soc2: A1.1, CC6.6, CC8.1;
...
**Remediation:** Either record an operator review confirming the default is appropriate (annotate via account tags or an SSM parameter documenting the review date and reviewer), or adjust the account-level throttle to match the portfolio. aws apigateway update-account with --patch-operations op=replace,path=/throttleSettings/rateLimit,value=. For accounts hosting public APIs, lower bounds force per- stage throttling decisions to be deliberate; for backend- integration accounts, much lower limits often suit the actual traffic profile.

***

### CTL.APIGATEWAY.ALARM.4XX.001[​](#ctlapigatewayalarm4xx001 "Direct link to CTL.APIGATEWAY.ALARM.4XX.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** fedramp\_moderate: AU-6, IR-4, SI-4; iso\_27001\_2022: A.5.25, A.8.16; nist\_800\_53\_r5: AU-6, IR-4, SI-4; pci\_dss\_v4.0: 10.4, 10.7, 11.5; soc2: CC7.2, CC7.3;
...
### CTL.APIGATEWAY.ALARM.5XX.001[​](#ctlapigatewayalarm5xx001 "Direct link to CTL.APIGATEWAY.ALARM.5XX.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** fedramp\_moderate: AU-6, IR-4, SI-4; iso\_27001\_2022: A.5.25, A.8.16; nist\_800\_53\_r5: AU-6, IR-4, SI-4; pci\_dss\_v4.0: 10.4, 10.7; soc2: CC7.2, CC7.3;
...
### CTL.APIGATEWAY.ALARM.CONFIGCHANGE.001[​](#ctlapigatewayalarmconfigchange001 "Direct link to CTL.APIGATEWAY.ALARM.CONFIGCHANGE.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** cis\_aws\_v3.0: 4.7; fedramp\_moderate: AU-6, AU-12, SI-4; iso\_27001\_2022: A.5.25, A.8.16; nist\_800\_53\_r5: AU-6, AU-12, SI-4; pci\_dss\_v4.0: 10.4, 12.10; soc2: CC7.2, CC8.1;
...
### CTL.APIGATEWAY.ALARM.COUNT.DDOS.001[​](#ctlapigatewayalarmcountddos001 "Direct link to CTL.APIGATEWAY.ALARM.COUNT.DDOS.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** fedramp\_moderate: AU-6, IR-4, SC-5; iso\_27001\_2022: A.5.25, A.8.6, A.8.16; nist\_800\_53\_r5: AU-6, IR-4, SC-5, SI-4; pci\_dss\_v4.0: 10.4, 11.5; soc2: CC7.2, A1.1;
...
### CTL.APIGATEWAY.ALARM.LATENCY.001[​](#ctlapigatewayalarmlatency001 "Direct link to CTL.APIGATEWAY.ALARM.LATENCY.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** fedramp\_moderate: AU-6, IR-4, SI-4; iso\_27001\_2022: A.5.25, A.8.6, A.8.16; nist\_800\_53\_r5: AU-6, IR-4, SI-4; pci\_dss\_v4.0: 10.4; soc2: CC7.2, A1.1, A1.2;
...
**Remediation:** Create alarms on AWS/ApiGateway namespace for both Latency and IntegrationLatency, dimensioned by ApiName/Stage. P99 threshold tied to the SLO is the standard pattern; a P50 threshold flags broader degradation. aws cloudwatch put-metric-alarm with --metric-name Latency --extended-statistic p99 --threshold . Document the SLO in the runbook so on-call has the right action when the alarm fires.

***

### CTL.APIGATEWAY.ALARM.RESOURCEPOLICY.CHANGE.001[​](#ctlapigatewayalarmresourcepolicychange001 "Direct link to CTL.APIGATEWAY.ALARM.RESOURCEPOLICY.CHANGE.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** cis\_aws\_v3.0: 4.7; fedramp\_moderate: AU-6, AU-12, SI-4, AC-3; iso\_27001\_2022: A.5.25, A.8.16; nist\_800\_53\_r5: AU-6, AU-12, SI-4, AC-3; pci\_dss\_v4.0: 10.4, 7.1; soc2: CC6.1, CC7.2, CC8.1;
...
### CTL.APIGATEWAY.ALARM.THROTTLE.001[​](#ctlapigatewayalarmthrottle001 "Direct link to CTL.APIGATEWAY.ALARM.THROTTLE.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** fedramp\_moderate: AU-6, IR-4, SC-5; iso\_27001\_2022: A.5.25, A.8.6, A.8.16; nist\_800\_53\_r5: AU-6, IR-4, SC-5, SI-4; pci\_dss\_v4.0: 10.4; soc2: CC7.2, A1.1;
...
### CTL.APIGATEWAY.API.NOCUSTOMDOMAIN.001[​](#ctlapigatewayapinocustomdomain001 "Direct link to CTL.APIGATEWAY.API.NOCUSTOMDOMAIN.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: CM-2, SC-7; iso\_27001\_2022: A.5.10, A.8.16; nist\_800\_53\_r5: CM-2, SC-7; soc2: CC6.1, CC6.6, CC8.1;
...
**Remediation:** Provision a custom domain with an ACM certificate matching the operator's preferred hostname: aws apigateway create-domain-name --domain-name api.example.com --regional-certificate-arn --endpoint-configuration types=REGIONAL. Map it to the API stage: aws apigateway create-base-path-mapping --domain-name api.example.com --rest-api-id --stage . Pair with the existing CTL.APIGATEWAY.ENDPOINT.DEFAULT.001 control which flags whether the default endpoint is also disabled.

***

### CTL.APIGATEWAY.APIKEY.SOURCE.HEADER.LOGGED.001[​](#ctlapigatewayapikeysourceheaderlogged001 "Direct link to CTL.APIGATEWAY.APIKEY.SOURCE.HEADER.LOGGED.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** fedramp\_moderate: AU-9, IA-5, SC-28; hipaa: 164.312(a)(2)(iv); iso\_27001\_2022: A.5.16, A.8.15; nist\_800\_53\_r5: AU-9, IA-5, SC-28; pci\_dss\_v4.0: 3.5, 8.3, 10.5; soc2: CC6.1, CC6.7;
...
**Remediation:** Remove $context.identity.apiKey and any header expansion that captures x-api-key from the access log format: aws apigateway update-stage with --patch-operations op=replace,path=/accessLogSettings/format,value=. If audit needs to know which key authenticated the request, log $context.identity.apiKeyId (the AWS-managed identifier) rather than the secret value. Consider migrating from API keys to a stronger primitive (Cognito, IAM, JWT) for any API where the key authenticates a human or production system.

***

### CTL.APIGATEWAY.AUTH.001[​](#ctlapigatewayauth001 "Direct link to CTL.APIGATEWAY.AUTH.001")
...
### CTL.APIGATEWAY.AUTH.APIKEY.SOLE.001[​](#ctlapigatewayauthapikeysole001 "Direct link to CTL.APIGATEWAY.AUTH.APIKEY.SOLE.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** fedramp\_moderate: IA-2; nist\_800\_53\_r5: IA-2; pci\_dss\_v4.0: 8.2; soc2: CC6.1;
...
**Remediation:** Attach an authorizer (IAM, Cognito, Lambda authorizer, or JWT) to the route. The API key, if still needed, then serves its intended purpose — usage tracking, throttling, and quota enforcement — alongside the authorizer's identity check. If the route is intentionally public, remove the api\_key\_required flag so the lack of auth is explicit rather than disguised by a key that grants no real protection.

***

### CTL.APIGATEWAY.AUTH.COGNITO.MULTICLIENT.001[​](#ctlapigatewayauthcognitomulticlient001 "Direct link to CTL.APIGATEWAY.AUTH.COGNITO.MULTICLIENT.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** fedramp\_moderate: AC-2, AC-3, AC-6; iso\_27001\_2022: A.5.15, A.5.16; nist\_800\_53\_r5: AC-2, AC-3, AC-6, IA-2; pci\_dss\_v4.0: 7.1, 7.2, 8.3; soc2: CC6.1, CC6.3;
...
**Remediation:** Configure the Cognito authorizer's identity validation to pin the specific app client IDs that should be accepted. In a Lambda authorizer fronting Cognito, validate the token's client\_id (id token) or aud (access token) claim against an allowlist. For HTTP API JWT authorizers, set the audience field to the specific client IDs. Document which app clients legitimately reach this API and reject tokens from others.

***

### CTL.APIGATEWAY.AUTH.COGNITO.SCOPE.MISSING.001[​](#ctlapigatewayauthcognitoscopemissing001 "Direct link to CTL.APIGATEWAY.AUTH.COGNITO.SCOPE.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** fedramp\_moderate: AC-2, AC-3, AC-6; iso\_27001\_2022: A.5.15, A.8.3; nist\_800\_53\_r5: AC-2, AC-3, AC-6, IA-2; pci\_dss\_v4.0: 7.1, 7.2; soc2: CC6.1, CC6.3;
...
### CTL.APIGATEWAY.AUTH.IAM.UNRESTRICTED.001[​](#ctlapigatewayauthiamunrestricted001 "Direct link to CTL.APIGATEWAY.AUTH.IAM.UNRESTRICTED.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** fedramp\_moderate: AC-2, AC-3, AC-6; iso\_27001\_2022: A.5.15, A.8.3; nist\_800\_53\_r5: AC-2, AC-3, AC-6; pci\_dss\_v4.0: 7.1, 7.2; soc2: CC6.1, CC6.3;

REST API method uses AWS\_IAM authorization, but no resource policy restricts which IAM principals can invoke. With AWS\_IAM alone, every IAM principal in the AWS account that holds execute-api:Invoke on this API's ARN can call the method. In large accounts that's hundreds or thousands of principals — far beyond the intended caller set. AWS\_IAM is the authentication layer; the authorization layer is the resource policy. Without a resource policy that names specific principals or scopes invocation by VPC, source IP, or organization, the method is effectively open to every IAM identity that can hit it.

**Remediation:** Attach a resource policy that names the specific principals permitted to invoke (Principal: AWS: arn:aws:iam::ACCOUNT:role/X) or scopes by source VPC / source IP / aws:PrincipalOrgID. aws apigateway update-rest-api with --patch-operations op=replace,path=/policy,value=. For private APIs, scope by aws:SourceVpce. For public-internet APIs, scope by aws:PrincipalOrgID to the organization that should reach the API.

***

### CTL.APIGATEWAY.AUTH.JWT.AUDIENCE.001[​](#ctlapigatewayauthjwtaudience001 "Direct link to CTL.APIGATEWAY.AUTH.JWT.AUDIENCE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: IA-2; nist\_800\_53\_r5: IA-2; pci\_dss\_v4.0: 8.2; soc2: CC6.2;
...
### CTL.APIGATEWAY.AUTH.WEBSOCKET.001[​](#ctlapigatewayauthwebsocket001 "Direct link to CTL.APIGATEWAY.AUTH.WEBSOCKET.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-3; nist\_800\_53\_r5: AC-3; pci\_dss\_v4.0: 8.2; soc2: CC6.1;
...
### CTL.APIGATEWAY.AUTHORIZER.LAMBDA.CACHE.LONG.001[​](#ctlapigatewayauthorizerlambdacachelong001 "Direct link to CTL.APIGATEWAY.AUTHORIZER.LAMBDA.CACHE.LONG.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** fedramp\_moderate: AC-2, AC-3, IA-2; iso\_27001\_2022: A.5.16, A.8.2; nist\_800\_53\_r5: AC-2, AC-3, IA-2; pci\_dss\_v4.0: 8.2, 8.3; soc2: CC6.1, CC6.2;
...
**Remediation:** Lower the authorizer's authorizer\_result\_ttl\_in\_seconds to 300 or less (default is 300). For high-revocation-rate workloads consider 60 seconds or disable the cache entirely (TTL = 0) and accept the per-request authorizer invocation cost. aws apigateway update-authorizer with --patch-operations op=replace,path=/authorizerResultTtlInSeconds,value=300.

***

### CTL.APIGATEWAY.CACHE.ENCRYPT.001[​](#ctlapigatewaycacheencrypt001 "Direct link to CTL.APIGATEWAY.CACHE.ENCRYPT.001")
...
### CTL.APIGATEWAY.CACHE.KEY.MISSING.001[​](#ctlapigatewaycachekeymissing001 "Direct link to CTL.APIGATEWAY.CACHE.KEY.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-5, SI-10; iso\_27001\_2022: A.5.10, A.8.16; nist\_800\_53\_r5: SC-5, SI-10; pci\_dss\_v4.0: 6.4.2; soc2: CC6.1, CC7.1;
...
**Remediation:** Configure cache key parameters on the method that match the request attributes which legitimately vary the response. aws apigateway put-method with cacheKeyParameters listing method.request.querystring., method.request.path., method.request.header.. For per-user caches, key on the auth-derived caller (method.request.header.Authorization or a custom header). For endpoints whose response should not be cached at all, disable caching on the method instead of caching with no keys.

***

### CTL.APIGATEWAY.CACHE.TTL.001[​](#ctlapigatewaycachettl001 "Direct link to CTL.APIGATEWAY.CACHE.TTL.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: AC-3; nist\_800\_53\_r5: AC-3; soc2: CC6.3;
...
### CTL.APIGATEWAY.CORS.001[​](#ctlapigatewaycors001 "Direct link to CTL.APIGATEWAY.CORS.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-4; nist\_800\_53\_r5: AC-4; pci\_dss\_v4.0: 6.4.1; soc2: CC6.1;
...
**Remediation:** Either set AllowCredentials to false and keep the wildcard (if the API is genuinely open and cookies/auth headers are not required), or replace the wildcard in AllowOrigins with the explicit set of origins that need credentialed access. Update via "aws apigatewayv2 update-api --api-id --cors-configuration ...".

***

### CTL.APIGATEWAY.CORS.NOTCONFIGURED.001[​](#ctlapigatewaycorsnotconfigured001 "Direct link to CTL.APIGATEWAY.CORS.NOTCONFIGURED.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: CM-2, SC-7; iso\_27001\_2022: A.5.10, A.8.16; nist\_800\_53\_r5: CM-2, SC-7; soc2: CC6.1, CC6.6;
...
### CTL.APIGATEWAY.DOMAIN.CERT.EXPIRY.WARN.001[​](#ctlapigatewaydomaincertexpirywarn001 "Direct link to CTL.APIGATEWAY.DOMAIN.CERT.EXPIRY.WARN.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-8, SC-12, SC-17; iso\_27001\_2022: A.5.16, A.8.24; nist\_800\_53\_r5: SC-8, SC-12, SC-17; owasp\_nhi: NHI7; pci\_dss\_v4.0: 4.2; soc2: CC6.1, CC6.7, CC8.1;
...
### CTL.APIGATEWAY.DOMAIN.CERT.NOTACM.001[​](#ctlapigatewaydomaincertnotacm001 "Direct link to CTL.APIGATEWAY.DOMAIN.CERT.NOTACM.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SC-12, SC-17; iso\_27001\_2022: A.5.16, A.8.24; nist\_800\_53\_r5: SC-12, SC-17, CM-2; pci\_dss\_v4.0: 4.2; soc2: CC6.7, CC8.1;
...
### CTL.APIGATEWAY.DOMAIN.TLS.001[​](#ctlapigatewaydomaintls001 "Direct link to CTL.APIGATEWAY.DOMAIN.TLS.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: SC-8;
...
**Remediation:** Update the custom domain security policy to TLS\_1\_2. In the API Gateway console or via the AWS CLI, set the security policy on the domain name to TLS\_1\_2. Verify that all API clients support TLS 1.2 before applying the change. Monitor CloudWatch access logs for connection failures after the update to identify clients that need upgrading.

***

### CTL.APIGATEWAY.DOMAIN.TLS.POLICY.STALE.001[​](#ctlapigatewaydomaintlspolicystale001 "Direct link to CTL.APIGATEWAY.DOMAIN.TLS.POLICY.STALE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-8, SC-13; iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: SC-8, SC-13; pci\_dss\_v4.0: 4.2; soc2: CC6.1, CC6.7;

API Gateway custom domain is configured with a TLS security policy older than the current AWS-recommended policy (e.g., TLS\_1\_2\_2018 instead of TLS\_1\_2\_2021). Newer policies remove weaker cipher suites and add modern AEAD ciphers. The TLS minimum version itself may be 1.2 — passing the basic minimum-version check — but the cipher list is the older recommendation. Clients negotiating with an older policy pick up cipher suites AWS has since deprecated; the cumulative cipher mix has weakened relative to current guidance.

**Remediation:** Update the custom domain security policy to the current AWS recommendation (TLS\_1\_2\_2021 at the time of writing): aws apigateway update-domain-name --domain-name --patch-operations op=replace,path=/securityPolicy,value=TLS\_1\_2\_2021. Track AWS announcements for newer policy releases and update in step. Verify that all clients negotiate successfully after the change; older clients may need TLS-stack upgrades to negotiate with the modern cipher list.

***

### CTL.APIGATEWAY.EDGE.NOCLOUDFRONT.001[​](#ctlapigatewayedgenocloudfront001 "Direct link to CTL.APIGATEWAY.EDGE.NOCLOUDFRONT.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SC-7, CM-2; iso\_27001\_2022: A.5.15, A.8.16; nist\_800\_53\_r5: SC-7, CM-2; pci\_dss\_v4.0: 1.2, 6.4.2; soc2: CC6.1, CC6.6;
...
### CTL.APIGATEWAY.ENDPOINT.DEFAULT.001[​](#ctlapigatewayendpointdefault001 "Direct link to CTL.APIGATEWAY.ENDPOINT.DEFAULT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-4; nist\_800\_53\_r5: AC-4; pci\_dss\_v4.0: 1.3; soc2: CC6.6;
...
### CTL.APIGATEWAY.EXECLOG.DATALOG.001[​](#ctlapigatewayexeclogdatalog001 "Direct link to CTL.APIGATEWAY.EXECLOG.DATALOG.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** fedramp\_moderate: AU-9, SC-28; hipaa: 164.312(a)(2)(iv), 164.312(c)(1); iso\_27001\_2022: A.5.33, A.8.10, A.8.15; nist\_800\_53\_r5: AU-9, SC-28, SI-12; pci\_dss\_v4.0: 3.5, 8.3, 10.5; soc2: CC6.1, CC6.7;
...
### CTL.APIGATEWAY.EXECLOG.DATAMASK.MISSING.001[​](#ctlapigatewayexeclogdatamaskmissing001 "Direct link to CTL.APIGATEWAY.EXECLOG.DATAMASK.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** fedramp\_moderate: AU-9, SC-28, SI-12; hipaa: 164.312(a)(2)(iv), 164.312(c)(1); iso\_27001\_2022: A.5.33, A.8.10, A.8.15; nist\_800\_53\_r5: AU-9, SC-28, SI-12; pci\_dss\_v4.0: 3.5, 8.3, 10.5; soc2: CC6.1, CC6.7;

REST API stage has data trace enabled in execution logs (full request and response bodies captured) without any parameter masking declared. When data trace is on and a legitimate diagnostic window justifies the exposure, masking rules can redact known-sensitive parameter names (password, token, ssn, credit\_card, authorization) before logs are written. Without masking, every body field — including credentials in form-style POSTs, PII in user-update payloads, payment data — persists at rest in CloudWatch. The existing DATALOG control flags data trace being on at all; this control catches the case where data trace is legitimately needed but masking isn't applied alongside.
...
### CTL.APIGATEWAY.EXECLOG.LEVEL.INFO.001[​](#ctlapigatewayexecloglevelinfo001 "Direct link to CTL.APIGATEWAY.EXECLOG.LEVEL.INFO.001")
...
### CTL.APIGATEWAY.GATEWAYRESPONSE.SERVERHEADER.001[​](#ctlapigatewaygatewayresponseserverheader001 "Direct link to CTL.APIGATEWAY.GATEWAYRESPONSE.SERVERHEADER.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-7; iso\_27001\_2022: A.5.15, A.8.16; nist\_800\_53\_r5: SC-7, SI-10; pci\_dss\_v4.0: 6.4.2; soc2: CC6.1, CC6.6;
...
**Remediation:** Customize the gateway responses to override or remove the Server header: aws apigateway update-gateway-response with --patch-operations op=remove,path=/responseParameters/gatewayresponse.header.Server for each response type that should be overridden, or op=replace setting Server to an opaque value. The default set of gateway responses (DEFAULT\_4XX, DEFAULT\_5XX, UNAUTHORIZED, ACCESS\_DENIED, etc.) all share the same header behavior; customize the parents to apply universally.

***

### CTL.APIGATEWAY.GHOST.AUTHORIZER.001[​](#ctlapigatewayghostauthorizer001 "Direct link to CTL.APIGATEWAY.GHOST.AUTHORIZER.001")
...
### CTL.APIGATEWAY.GHOST.CERT.001[​](#ctlapigatewayghostcert001 "Direct link to CTL.APIGATEWAY.GHOST.CERT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-17; hipaa: 164.312(e)(1); nist\_800\_53\_r5: SC-17; pci\_dss\_v4.0: 4.2.1; soc2: CC6.7;
...
### CTL.APIGATEWAY.GHOST.LAMBDA.001[​](#ctlapigatewayghostlambda001 "Direct link to CTL.APIGATEWAY.GHOST.LAMBDA.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: CM-2; nist\_800\_53\_r5: CM-2; soc2: CC8.1;
...
### CTL.APIGATEWAY.GHOST.LOGDEST.001[​](#ctlapigatewayghostlogdest001 "Direct link to CTL.APIGATEWAY.GHOST.LOGDEST.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: AU-12; hipaa: 164.312(b); nist\_800\_53\_r5: AU-12; pci\_dss\_v4.0: 10.2; soc2: CC7.2;
...
### CTL.APIGATEWAY.GHOST.USAGEPLAN.001[​](#ctlapigatewayghostusageplan001 "Direct link to CTL.APIGATEWAY.GHOST.USAGEPLAN.001")
...
### CTL.APIGATEWAY.GHOST.VPCLINK.001[​](#ctlapigatewayghostvpclink001 "Direct link to CTL.APIGATEWAY.GHOST.VPCLINK.001")
...
### CTL.APIGATEWAY.HTTPAPI.DEFAULT.ROUTE.001[​](#ctlapigatewayhttpapidefaultroute001 "Direct link to CTL.APIGATEWAY.HTTPAPI.DEFAULT.ROUTE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-3, CM-2, SC-7; iso\_27001\_2022: A.5.15, A.8.16; nist\_800\_53\_r5: AC-3, CM-2, SC-7; pci\_dss\_v4.0: 1.2, 6.4.2; soc2: CC6.1, CC6.6;
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** fedramp\_moderate: IA-2; hipaa: 164.312(d); nist\_800\_53\_r5: IA-2; pci\_dss\_v4.0: 8.3.1; soc2: CC6.1;
...
### CTL.APIGATEWAY.HTTPAPI.JWT.SCOPE.MISSING.001[​](#ctlapigatewayhttpapijwtscopemissing001 "Direct link to CTL.APIGATEWAY.HTTPAPI.JWT.SCOPE.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** fedramp\_moderate: AC-2, AC-3, AC-6; iso\_27001\_2022: A.5.15, A.8.3; nist\_800\_53\_r5: AC-2, AC-3, AC-6, IA-2; pci\_dss\_v4.0: 7.1, 7.2, 8.3; soc2: CC6.1, CC6.3;
...
### CTL.APIGATEWAY.INCOMPLETE.001[​](#ctlapigatewayincomplete001 "Direct link to CTL.APIGATEWAY.INCOMPLETE.001")
...
### CTL.APIGATEWAY.INTEGRATION.HTTP.BACKEND.PUBLIC.001[​](#ctlapigatewayintegrationhttpbackendpublic001 "Direct link to CTL.APIGATEWAY.INTEGRATION.HTTP.BACKEND.PUBLIC.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-7, AC-4; iso\_27001\_2022: A.5.10, A.8.16; nist\_800\_53\_r5: SC-7, AC-4; pci\_dss\_v4.0: 1.2, 1.3, 4.2; soc2: CC6.1, CC6.6;

REST API method has an HTTP\_PROXY or HTTP integration whose backend URL resolves to a public internet endpoint rather than a private resource (VPC endpoint, private DNS, internal IP). API Gateway routes traffic over the public internet to reach the backend — adding a public-internet hop between API Gateway (an AWS service in the same region, often the same account as the backend) and the backend itself. That hop is unnecessary egress, increases attack surface (the backend has a public listener that must accept traffic from arbitrary AWS API Gateway IP ranges), and removes the private-network blast-radius containment that VPC isolation provides.

**Remediation:** Replace the public URL with a VPC Link integration to a private NLB or with a private DNS name resolved within the VPC: aws apigateway update-integration with --patch-operations op=replace,path=/connectionType,value=VPC\_LINK and the appropriate connectionId. For backends that are inherently third-party (an external SaaS API), document the rationale in the triage override — third-party reach legitimately transits the public internet and is not the case this control flags.

***

### CTL.APIGATEWAY.INTEGRATION.HTTP.PLAINTEXT.001[​](#ctlapigatewayintegrationhttpplaintext001 "Direct link to CTL.APIGATEWAY.INTEGRATION.HTTP.PLAINTEXT.001")
...
### CTL.APIGATEWAY.INTEGRATION.HTTP.SENSITIVE.HEADERS.001[​](#ctlapigatewayintegrationhttpsensitiveheaders001 "Direct link to CTL.APIGATEWAY.INTEGRATION.HTTP.SENSITIVE.HEADERS.001")
...
### CTL.APIGATEWAY.INTEGRATION.HTTP.TLS.UNVALIDATED.001[​](#ctlapigatewayintegrationhttptlsunvalidated001 "Direct link to CTL.APIGATEWAY.INTEGRATION.HTTP.TLS.UNVALIDATED.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-8, SC-12, SC-23; iso\_27001\_2022: A.5.10, A.8.20, A.8.24; nist\_800\_53\_r5: SC-8, SC-12, SC-23; pci\_dss\_v4.0: 4.2; soc2: CC6.1, CC6.7;

HTTP / HTTP\_PROXY integration is configured with TLS certificate validation disabled (insecureSkipVerification flag, or an explicit configuration that accepts any certificate). Integration traffic is technically encrypted but the certificate chain is not checked — API Gateway accepts connections to a backend whose certificate is self-signed, expired, or impersonated. An attacker who can redirect traffic in the network path between API Gateway and the backend (DNS hijack, BGP misroute, compromised intermediate) can present any certificate; API Gateway accepts it and forwards traffic. The encryption is cosmetic — confidentiality of credentials and request data is no stronger than plaintext HTTP.
...
### CTL.APIGATEWAY.INTEGRATION.LAMBDA.SCOPE.001[​](#ctlapigatewayintegrationlambdascope001 "Direct link to CTL.APIGATEWAY.INTEGRATION.LAMBDA.SCOPE.001")
...
**Remediation:** Update the Lambda's resource-based policy to add an explicit SourceArn condition pinning the API ID, stage, method, and path — for example, arn:aws:execute-api:REGION:ACCOUNT:API\_ID/STAGE/METHOD/PATH. Use the smallest pattern that covers the intended call sites; avoid trailing wildcards beyond what's necessary. Re-add the permission via aws lambda add-permission with the scoped source-arn rather than editing the policy in place.

***

### CTL.APIGATEWAY.INTEGRATION.TIMEOUT.001[​](#ctlapigatewayintegrationtimeout001 "Direct link to CTL.APIGATEWAY.INTEGRATION.TIMEOUT.001")
...
### CTL.APIGATEWAY.INTEGRATION.VPCLINK.MISSING.001[​](#ctlapigatewayintegrationvpclinkmissing001 "Direct link to CTL.APIGATEWAY.INTEGRATION.VPCLINK.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-7; nist\_800\_53\_r5: SC-7; pci\_dss\_v4.0: 1.3.4; soc2: CC6.6;
...
### CTL.APIGATEWAY.LOG.001[​](#ctlapigatewaylog001 "Direct link to CTL.APIGATEWAY.LOG.001")
...
### CTL.APIGATEWAY.METHOD.ANY.001[​](#ctlapigatewaymethodany001 "Direct link to CTL.APIGATEWAY.METHOD.ANY.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: AC-3, CM-2, SC-7; iso\_27001\_2022: A.5.15, A.8.16; nist\_800\_53\_r5: AC-3, CM-2, SC-7; pci\_dss\_v4.0: 1.2, 6.4.2; soc2: CC6.1, CC8.1;
...
### CTL.APIGATEWAY.METHOD.RESPONSE.MISSING.001[​](#ctlapigatewaymethodresponsemissing001 "Direct link to CTL.APIGATEWAY.METHOD.RESPONSE.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-11, SC-7; iso\_27001\_2022: A.5.10, A.8.16; nist\_800\_53\_r5: SI-11, SC-7; pci\_dss\_v4.0: 6.4.2; soc2: CC6.1, CC6.6;
...
### CTL.APIGATEWAY.METHOD.THROTTLE.MISSING.001[​](#ctlapigatewaymethodthrottlemissing001 "Direct link to CTL.APIGATEWAY.METHOD.THROTTLE.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-5, AC-7; iso\_27001\_2022: A.5.30, A.8.6, A.8.16; nist\_800\_53\_r5: SC-5, AC-7; pci\_dss\_v4.0: 6.4.1, 8.3.4; soc2: A1.1, CC6.6;
...
### CTL.APIGATEWAY.MOCK.PRODUCTION.001[​](#ctlapigatewaymockproduction001 "Direct link to CTL.APIGATEWAY.MOCK.PRODUCTION.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: CM-2, CM-3; iso\_27001\_2022: A.8.9, A.8.32; nist\_800\_53\_r5: CM-2, CM-3, SI-7; pci\_dss\_v4.0: 6.4.1, 6.4.2; soc2: CC6.1, CC8.1;
...
**Remediation:** Replace the MOCK integration with the appropriate AWS, AWS\_PROXY, HTTP, or HTTP\_PROXY integration: aws apigateway update-integration with --patch-operations op=replace,path=/type,value=AWS\_PROXY (or appropriate type) plus the integration URI / role / parameters. Audit the method's response mappings and stage variables for any references that assumed mock behavior.

***

### CTL.APIGATEWAY.MODEL.ADDITIONAL.PROPERTIES.001[​](#ctlapigatewaymodeladditionalproperties001 "Direct link to CTL.APIGATEWAY.MODEL.ADDITIONAL.PROPERTIES.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-10, SC-7; iso\_27001\_2022: A.5.10, A.8.16; nist\_800\_53\_r5: SI-10, SC-7; pci\_dss\_v4.0: 6.4.2; soc2: CC6.1, CC6.6;
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SI-10, CM-2; iso\_27001\_2022: A.5.10, A.8.16; nist\_800\_53\_r5: SI-10, CM-2; pci\_dss\_v4.0: 6.4.2; soc2: CC6.1, CC6.6, CC8.1;
...
**Remediation:** Either associate the model with the method that should enforce it: aws apigateway update-method with --patch-operations op=add,path=/requestModels/application\~1json,value=. Or delete the orphan model if it's leftover from a partial refactor: aws apigateway delete-model --model-name . Pair with a request validator that has --validate-request-body set so the model actually gates traffic.

***

### CTL.APIGATEWAY.MTLS.001[​](#ctlapigatewaymtls001 "Direct link to CTL.APIGATEWAY.MTLS.001")
...
### CTL.APIGATEWAY.NETWORK.CLIENTCERT.EXPIRY.001[​](#ctlapigatewaynetworkclientcertexpiry001 "Direct link to CTL.APIGATEWAY.NETWORK.CLIENTCERT.EXPIRY.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: IA-5; hipaa: 164.312(d); nist\_800\_53\_r5: IA-5; owasp\_nhi: NHI7; soc2: CC6.1;
...
### CTL.APIGATEWAY.NETWORK.CLIENTCERT.STALE.001[​](#ctlapigatewaynetworkclientcertstale001 "Direct link to CTL.APIGATEWAY.NETWORK.CLIENTCERT.STALE.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: IA-5, SC-12, SC-17; iso\_27001\_2022: A.5.16, A.8.24; nist\_800\_53\_r5: IA-5, SC-12, SC-17; pci\_dss\_v4.0: 3.7, 8.3; soc2: CC6.1, CC6.7;
...
**Remediation:** Generate a new client certificate, distribute it to the backends that trust it, and update the stage to use the new certificate: aws apigateway generate-client-certificate followed by aws apigateway update-stage with --patch-operations op=replace,path=/clientCertificateId,value=. Plan rotation in advance — backends typically need a deployment to trust the new certificate before the stage flips. Once rotation is complete, delete the old certificate.

***

### CTL.APIGATEWAY.NETWORK.PRIVATE.POLICY.001[​](#ctlapigatewaynetworkprivatepolicy001 "Direct link to CTL.APIGATEWAY.NETWORK.PRIVATE.POLICY.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-7; hipaa: 164.312(e)(1); nist\_800\_53\_r5: SC-7; pci\_dss\_v4.0: 1.4.2; soc2: CC6.6;
...
### CTL.APIGATEWAY.ORPHAN.API.001[​](#ctlapigatewayorphanapi001 "Direct link to CTL.APIGATEWAY.ORPHAN.API.001")
...
### CTL.APIGATEWAY.ORPHAN.APIKEY.001[​](#ctlapigatewayorphanapikey001 "Direct link to CTL.APIGATEWAY.ORPHAN.APIKEY.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: AC-2, CM-8, IA-5; iso\_27001\_2022: A.5.16, A.8.9; nist\_800\_53\_r5: AC-2, CM-8, IA-5; pci\_dss\_v4.0: 8.3; soc2: CC6.1, CC8.1;
...
**Remediation:** Either associate the key with the usage plan that should govern it: aws apigateway create-usage-plan-key --usage-plan-id --key-id --key-type API\_KEY. Or delete the orphan key: aws apigateway delete-api-key --api-key . Audit the consumer using the key first — deleting in production breaks legitimate clients.

***

### CTL.APIGATEWAY.ORPHAN.AUTHORIZER.001[​](#ctlapigatewayorphanauthorizer001 "Direct link to CTL.APIGATEWAY.ORPHAN.AUTHORIZER.001")
...
### CTL.APIGATEWAY.ORPHAN.CUSTOMDOMAIN.001[​](#ctlapigatewayorphancustomdomain001 "Direct link to CTL.APIGATEWAY.ORPHAN.CUSTOMDOMAIN.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: CM-2, CM-8; iso\_27001\_2022: A.5.10, A.8.9; nist\_800\_53\_r5: CM-2, CM-8; soc2: CC6.1, CC8.1;
...
**Remediation:** Either map the domain to the API and stage that should serve it: aws apigateway create-base-path-mapping --domain-name --rest-api-id --stage . Or delete the orphan domain: aws apigateway delete-domain-name --domain-name . Inspect Route 53 alias records pointing at the domain — they should be cleaned up alongside.

***

### CTL.APIGATEWAY.ORPHAN.NODEPLOYMENT.001[​](#ctlapigatewayorphannodeployment001 "Direct link to CTL.APIGATEWAY.ORPHAN.NODEPLOYMENT.001")
...
**Remediation:** Either deploy the API to a stage if it's intended to be live (aws apigateway create-deployment --rest-api-id --stage-name ), or delete the API if it's leftover: aws apigateway delete-rest-api --rest-api-id . Audit Lambda resource-based policies, VPC Links, and any cross-resource references to confirm the cleanup is complete.

***

### CTL.APIGATEWAY.ORPHAN.USAGEPLAN.001[​](#ctlapigatewayorphanusageplan001 "Direct link to CTL.APIGATEWAY.ORPHAN.USAGEPLAN.001")
...
**Remediation:** Either associate the plan with the API stage that should use it (aws apigateway create-usage-plan-key followed by update-usage-plan adding apiStages) or delete the plan if it's leftover: aws apigateway delete-usage-plan --usage-plan-id . Inspect any API keys associated with the plan first — they may need re-association with a different plan or independent cleanup.

***

### CTL.APIGATEWAY.ORPHAN.VPCLINK.001[​](#ctlapigatewayorphanvpclink001 "Direct link to CTL.APIGATEWAY.ORPHAN.VPCLINK.001")
...
**Remediation:** Audit the VPC Link to confirm no current or pending integration uses it. Either repoint a current integration at the link or delete the link: aws apigateway delete-vpc-link --vpc-link-id . Audit the target NLB and its security group during cleanup — they may need independent decommissioning.

***

### CTL.APIGATEWAY.PAYLOAD.SIZE.UNLIMITED.001[​](#ctlapigatewaypayloadsizeunlimited001 "Direct link to CTL.APIGATEWAY.PAYLOAD.SIZE.UNLIMITED.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-5, SI-10; iso\_27001\_2022: A.5.30, A.8.6, A.8.16; nist\_800\_53\_r5: SC-5, SI-10; pci\_dss\_v4.0: 6.4.1, 6.4.2; soc2: A1.1, CC6.6;
...
### CTL.APIGATEWAY.POLICY.CROSSACCOUNT.OPEN.001[​](#ctlapigatewaypolicycrossaccountopen001 "Direct link to CTL.APIGATEWAY.POLICY.CROSSACCOUNT.OPEN.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** fedramp\_moderate: AC-3, AC-6, SC-7; iso\_27001\_2022: A.5.15, A.8.3; nist\_800\_53\_r5: AC-3, AC-6, SC-7; pci\_dss\_v4.0: 1.2, 7.1; soc2: CC6.1, CC6.3;
...
**Remediation:** Add an aws:SourceAccount or aws:PrincipalOrgID condition to the resource policy alongside the VPC clause: aws apigateway update-rest-api with --patch-operations op=replace,path=/policy,value= where the policy document has both the source-VPC clause and an Account/Org restriction. For private APIs, prefer aws:SourceVpce listing specific VPC endpoint IDs — that's the most restrictive shape and avoids the cross-account VPC ambiguity entirely.

***

### CTL.APIGATEWAY.POLICY.METHODAUTH.CONFLICT.001[​](#ctlapigatewaypolicymethodauthconflict001 "Direct link to CTL.APIGATEWAY.POLICY.METHODAUTH.CONFLICT.001")
...
### CTL.APIGATEWAY.RESPONSE.EXPOSURE.001[​](#ctlapigatewayresponseexposure001 "Direct link to CTL.APIGATEWAY.RESPONSE.EXPOSURE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-11; nist\_800\_53\_r5: SI-11; pci\_dss\_v4.0: 6.5.5; soc2: CC6.6;

API Gateway uses the default gateway-response templates rather than customized responses. Default 4xx and 5xx responses include details useful for reconnaissance: the specific failure type (AUTHORIZER\_FAILURE, INTEGRATION\_FAILURE, INTEGRATION\_TIMEOUT, THROTTLED, MISSING\_AUTHENTICATION\_TOKEN), the request ID, and — for INTEGRATION\_FAILURE responses — backend error messages passed through verbatim. An attacker probing the API distinguishes "no auth" from "wrong auth" from "timeout" from "backend crash" and tailors next steps accordingly. Custom gateway responses collapse all of these into generic messages — "400 Bad Request", "500 Internal Server Error" — without revealing which underlying condition produced the response. The control fires when no customizations are in place; it is medium severity because information disclosure aids reconnaissance but doesn't itself enable exploitation.

**Remediation:** Customize gateway responses for the high-information types — DEFAULT\_4XX, DEFAULT\_5XX, AUTHORIZER\_FAILURE, INTEGRATION\_FAILURE, MISSING\_AUTHENTICATION\_TOKEN, UNAUTHORIZED, ACCESS\_DENIED — with response templates that return only generic error text. Suppress the Server header in the customized responses. Verify by triggering each failure type and confirming the response body contains no implementation specifics.

***

### CTL.APIGATEWAY.STAGE.AUTODEPLOY.001[​](#ctlapigatewaystageautodeploy001 "Direct link to CTL.APIGATEWAY.STAGE.AUTODEPLOY.001")
...
### CTL.APIGATEWAY.STAGE.CROSSENV.001[​](#ctlapigatewaystagecrossenv001 "Direct link to CTL.APIGATEWAY.STAGE.CROSSENV.001")
...
### CTL.APIGATEWAY.STAGE.GHOST.VARS.001[​](#ctlapigatewaystageghostvars001 "Direct link to CTL.APIGATEWAY.STAGE.GHOST.VARS.001")
...
### CTL.APIGATEWAY.STAGE.LIFECYCLE.001[​](#ctlapigatewaystagelifecycle001 "Direct link to CTL.APIGATEWAY.STAGE.LIFECYCLE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: CM-7; hipaa: 164.312(a)(1); nist\_800\_53\_r5: CM-7; pci\_dss\_v4.0: 6.3.2; soc2: CC7.1;
...
### CTL.APIGATEWAY.STAGE.VARS.CREDENTIALS.001[​](#ctlapigatewaystagevarscredentials001 "Direct link to CTL.APIGATEWAY.STAGE.VARS.CREDENTIALS.001")
...
### CTL.APIGATEWAY.THROTTLE.001[​](#ctlapigatewaythrottle001 "Direct link to CTL.APIGATEWAY.THROTTLE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-5; hipaa: 164.308(a)(1)(ii)(B); nist\_800\_53\_r5: SC-5; pci\_dss\_v4.0: 6.4.1; soc2: A1.1;
...
### CTL.APIGATEWAY.THROTTLE.NOPLAN.001[​](#ctlapigatewaythrottlenoplan001 "Direct link to CTL.APIGATEWAY.THROTTLE.NOPLAN.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-5; nist\_800\_53\_r5: SC-5; pci\_dss\_v4.0: 6.4.1; soc2: A1.1;
...
### CTL.APIGATEWAY.TLS.001[​](#ctlapigatewaytls001 "Direct link to CTL.APIGATEWAY.TLS.001")
...
**Remediation:** Set the minimum TLS version on the custom domain or API stage. For REST APIs, configure a security policy of TLS\_1\_2 on the custom domain name.

***

### CTL.APIGATEWAY.TLS.MTLS.TRUSTSTORE.001[​](#ctlapigatewaytlsmtlstruststore001 "Direct link to CTL.APIGATEWAY.TLS.MTLS.TRUSTSTORE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-8; hipaa: 164.312(e)(1); nist\_800\_53\_r5: SC-8; pci\_dss\_v4.0: 8.3.2; soc2: CC6.1;
...
### CTL.APIGATEWAY.TRACING.001[​](#ctlapigatewaytracing001 "Direct link to CTL.APIGATEWAY.TRACING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: AU-12;
...
### CTL.APIGATEWAY.UNAUTH.THROTTLE.MISSING.001[​](#ctlapigatewayunauththrottlemissing001 "Direct link to CTL.APIGATEWAY.UNAUTH.THROTTLE.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-5, AC-7; iso\_27001\_2022: A.5.30, A.8.6, A.8.16; nist\_800\_53\_r5: SC-5, AC-7; pci\_dss\_v4.0: 6.4.1; soc2: A1.1, CC6.6;
...
**Remediation:** Add method-level throttle on every NONE-authorized method: aws apigateway update-stage with --patch-operations op=replace,path=//throttling/rateLimit, value=. Pair with WAF rate-based rules to drop abusive sources at the edge before they reach API Gateway. For signup or other identity-creation routes, also consider CAPTCHA or proof-of-work to raise the abuse cost.

***

### CTL.APIGATEWAY.USAGEPLAN.QUOTA.MISSING.001[​](#ctlapigatewayusageplanquotamissing001 "Direct link to CTL.APIGATEWAY.USAGEPLAN.QUOTA.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-5, SC-6; iso\_27001\_2022: A.5.30, A.8.6; nist\_800\_53\_r5: SC-5, SC-6; pci\_dss\_v4.0: 6.4.1; soc2: A1.1, A1.2, CC6.6;
...
### CTL.APIGATEWAY.USAGEPLAN.RATE.EXCESSIVE.001[​](#ctlapigatewayusageplanrateexcessive001 "Direct link to CTL.APIGATEWAY.USAGEPLAN.RATE.EXCESSIVE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-5, SC-6, CM-2; iso\_27001\_2022: A.5.30, A.8.6; nist\_800\_53\_r5: SC-5, SC-6, CM-2; pci\_dss\_v4.0: 6.4.1; soc2: A1.1, A1.2, CC6.6;
...
### CTL.APIGATEWAY.VALIDATION.001[​](#ctlapigatewayvalidation001 "Direct link to CTL.APIGATEWAY.VALIDATION.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-10; hipaa: 164.312(c)(1); nist\_800\_53\_r5: SI-10; pci\_dss\_v4.0: 6.2.4; soc2: CC6.6;
...
### CTL.APIGATEWAY.VALIDATION.BODYONLY.001[​](#ctlapigatewayvalidationbodyonly001 "Direct link to CTL.APIGATEWAY.VALIDATION.BODYONLY.001")
...
**Remediation:** Define a request model (JSON schema) for the method's body and a parameter schema for query strings and headers, then attach a validator of type BODY\_AND\_PARAMS to the method. Reject obviously malformed requests at the gateway. For HTTP APIs, the equivalent is OpenAPI request validation — not yet covered by this control's predicate; HTTP API methods will not fire this control.

***

### CTL.APIGATEWAY.VALIDATION.PATH.MISSING.001[​](#ctlapigatewayvalidationpathmissing001 "Direct link to CTL.APIGATEWAY.VALIDATION.PATH.MISSING.001")
...
### CTL.APIGATEWAY.VALIDATION.QUERY.MISSING.001[​](#ctlapigatewayvalidationquerymissing001 "Direct link to CTL.APIGATEWAY.VALIDATION.QUERY.MISSING.001")
...
**Remediation:** Configure a request validator that includes query/header validation and attach it to the method: aws apigateway create-request-validator with --validate-request-parameters true, then update-method --request-validator-id . Declare each method query parameter with required=true / false explicitly so the validator has a contract to enforce.

***

### CTL.APIGATEWAY.VPCLINK.SG.BROAD.001[​](#ctlapigatewayvpclinksgbroad001 "Direct link to CTL.APIGATEWAY.VPCLINK.SG.BROAD.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: CP-2, CP-7, SC-7; iso\_27001\_2022: A.5.30, A.8.14, A.8.16; nist\_800\_53\_r5: CP-2, CP-7, SC-7; pci\_dss\_v4.0: 1.2; soc2: A1.1, A1.2, CC6.6;
...
**Remediation:** Add subnets in at least one additional availability zone to the NLB: aws elbv2 set-subnets --load-balancer-arn --subnets subnet-A subnet-B subnet-C. Provision backend targets in the additional AZs so the NLB has healthy targets to route to. Update the VPC Link configuration if it pins specific subnet IDs. For development or non-production VPC Links where AZ redundancy isn't required, document the rationale in the triage override.

***

### CTL.APIGATEWAY.WAF.001[​](#ctlapigatewaywaf001 "Direct link to CTL.APIGATEWAY.WAF.001")
...
### CTL.APIGATEWAY.WAF.BYPASS.CF.001[​](#ctlapigatewaywafbypasscf001 "Direct link to CTL.APIGATEWAY.WAF.BYPASS.CF.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-3, SC-7, SI-4; iso\_27001\_2022: A.5.15, A.8.16; nist\_800\_53\_r5: AC-3, SC-7, SI-4; pci\_dss\_v4.0: 1.2, 6.4.2; soc2: CC6.1, CC6.6, CC8.1;
...
### CTL.APIGATEWAY.WAF.RATELIMIT.MISSING.001[​](#ctlapigatewaywafratelimitmissing001 "Direct link to CTL.APIGATEWAY.WAF.RATELIMIT.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-5, SC-7, SI-4; iso\_27001\_2022: A.5.30, A.8.6, A.8.16; nist\_800\_53\_r5: SC-5, SC-7, SI-4; pci\_dss\_v4.0: 6.4.1, 6.4.2; soc2: A1.1, CC6.6, CC7.2;
...
### CTL.APIGATEWAY.WEBSOCKET.DEFAULT.UNVALIDATED.001[​](#ctlapigatewaywebsocketdefaultunvalidated001 "Direct link to CTL.APIGATEWAY.WEBSOCKET.DEFAULT.UNVALIDATED.001")
...
### CTL.APIGATEWAY.WEBSOCKET.IDLETIMEOUT.MISSING.001[​](#ctlapigatewaywebsocketidletimeoutmissing001 "Direct link to CTL.APIGATEWAY.WEBSOCKET.IDLETIMEOUT.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** resilience
* **Compliance:** fedramp\_moderate: SC-5, AC-12; iso\_27001\_2022: A.5.30, A.8.6; nist\_800\_53\_r5: SC-5, AC-12; pci\_dss\_v4.0: 6.4.1, 8.2; soc2: A1.1, CC6.6;
...
### CTL.APIGATEWAY.WEBSOCKET.ORIGIN.UNVALIDATED.001[​](#ctlapigatewaywebsocketoriginunvalidated001 "Direct link to CTL.APIGATEWAY.WEBSOCKET.ORIGIN.UNVALIDATED.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** fedramp\_moderate: AC-3, IA-2, SC-7; iso\_27001\_2022: A.5.15, A.8.16; nist\_800\_53\_r5: AC-3, IA-2, SC-7; pci\_dss\_v4.0: 6.4.2; soc2: CC6.1, CC6.6;
...
### CTL.APIGATEWAY.WEBSOCKET.THROTTLE.001[​](#ctlapigatewaywebsocketthrottle001 "Direct link to CTL.APIGATEWAY.WEBSOCKET.THROTTLE.001")
