...
RDS instances must have a CloudWatch alarm configured on the DatabaseConnections metric. Connection exhaustion is the most common availability failure mode for managed databases, especially in workloads where Lambda functions connect directly (each cold start opens a new connection, and a cold- start storm can saturate max\_connections in seconds). Once the connection limit is reached, the database refuses new connections with a "too many connections" error — the application's user-facing behavior is "intermittent inability to connect" rather than the kind of explicit database failure that the on-call response is rehearsed for, so the connection- exhaustion incident often runs longer than equivalent CPU-based incidents would. An alarm with a threshold around 80–90% of max\_connections gives the on-call enough time to drain a misbehaving client before the saturation point.

**Remediation:** Create a CloudWatch alarm at 80–90% of max\_connections with an SNS notification action.

***

### CTL.RDS.ALARM.CPU.001[​](#ctlrdsalarmcpu001 "Direct link to CTL.RDS.ALARM.CPU.001")
...
### CTL.RDS.ALARM.REPLICATION.001[​](#ctlrdsalarmreplication001 "Direct link to CTL.RDS.ALARM.REPLICATION.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** nist\_800\_53\_r5: SI-4; soc2: A1.2;
...
### CTL.RDS.ALARM.STORAGE.001[​](#ctlrdsalarmstorage001 "Direct link to CTL.RDS.ALARM.STORAGE.001")
...
### CTL.RDS.AURORA.BACKTRACK.001[​](#ctlrdsaurorabacktrack001 "Direct link to CTL.RDS.AURORA.BACKTRACK.001")
...
### CTL.RDS.AURORA.GLOBAL.UNENCRYPTED.001[​](#ctlrdsauroraglobalunencrypted001 "Direct link to CTL.RDS.AURORA.GLOBAL.UNENCRYPTED.001")
...
* **Type:** unsafe\_state
* **Domain:** encryption
* **Compliance:** hipaa: 164.312(a)(2)(iv); nist\_800\_53\_r5: SC-28; pci\_dss\_v4: 3.4;
...
### CTL.RDS.AURORA.SERVERLESS.V1.001[​](#ctlrdsauroraserverlessv1001 "Direct link to CTL.RDS.AURORA.SERVERLESS.V1.001")
...
### CTL.RDS.AURORA.SINGLEINSTANCE.001[​](#ctlrdsaurorasingleinstance001 "Direct link to CTL.RDS.AURORA.SINGLEINSTANCE.001")
...
### CTL.RDS.AUTH.MASTERPASSWORD.AGE.001[​](#ctlrdsauthmasterpasswordage001 "Direct link to CTL.RDS.AUTH.MASTERPASSWORD.AGE.001")
...
* **Type:** unsafe\_state
* **Domain:** access
* **Compliance:** hipaa: 164.308(a)(5)(ii)(D); nist\_800\_53\_r5: IA-5; pci\_dss\_v4: 8.3;
...
### CTL.RDS.AUTH.MASTERUSER.001[​](#ctlrdsauthmasteruser001 "Direct link to CTL.RDS.AUTH.MASTERUSER.001")
...
* **Type:** unsafe\_state
* **Domain:** access
* **Compliance:** nist\_800\_53\_r5: IA-5; pci\_dss\_v4: 8.3;
...
### CTL.RDS.AUTOUPGRADE.001[​](#ctlrdsautoupgrade001 "Direct link to CTL.RDS.AUTOUPGRADE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 2.3.2; fedramp\_moderate: CM-6; nist\_800\_53\_r5: CM-6; pci\_dss\_v4.0: 2.2.1; soc2: A1.1;
...
**Remediation:** Enable auto minor version upgrade: aws rds modify-db-instance --db-instance-identifier --auto-minor-version-upgrade --apply-immediately

***

### CTL.RDS.BACKUP.001[​](#ctlrdsbackup001 "Direct link to CTL.RDS.BACKUP.001")
...
### CTL.RDS.BACKUP.CROSSREGION.001[​](#ctlrdsbackupcrossregion001 "Direct link to CTL.RDS.BACKUP.CROSSREGION.001")
...
* **Type:** unsafe\_state
* **Domain:** resilience
* **Compliance:** nist\_800\_53\_r5: CP-6;
...
### CTL.RDS.BACKUP.CROSSREGION.ENCRYPT.001[​](#ctlrdsbackupcrossregionencrypt001 "Direct link to CTL.RDS.BACKUP.CROSSREGION.ENCRYPT.001")
...
### CTL.RDS.BACKUP.RETENTION.COMPLIANCE.001[​](#ctlrdsbackupretentioncompliance001 "Direct link to CTL.RDS.BACKUP.RETENTION.COMPLIANCE.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** hipaa: 164.316(b)(2)(i); nist\_800\_53\_r5: CP-9; pci\_dss\_v4: 10.7;
...
### CTL.RDS.CLUSTER.DELETION.PROTECT.001[​](#ctlrdsclusterdeletionprotect001 "Direct link to CTL.RDS.CLUSTER.DELETION.PROTECT.001")
...
* **Type:** unsafe\_state
* **Domain:** resilience
* **Compliance:** aws\_security\_hub: RDS.34; mitre\_attack: TA0040; nist\_800\_53\_r5: CP-9;
...
**Remediation:** aws rds modify-db-cluster --db-cluster-identifier --deletion-protection --apply-immediately

***

### CTL.RDS.CLUSTER.LOGGING.001[​](#ctlrdsclusterlogging001 "Direct link to CTL.RDS.CLUSTER.LOGGING.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** aws\_security\_hub: RDS.36; mitre\_attack: TA0005; nist\_800\_53\_r5: AU-12;
...
**Remediation:** aws rds modify-db-cluster --db-cluster-identifier --cloudwatch-logs-export-configuration EnableLogTypes=audit,error,slowquery --apply-immediately

***

### CTL.RDS.DELETEPROT.001[​](#ctlrdsdeleteprot001 "Direct link to CTL.RDS.DELETEPROT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws: 2.3.3; nist\_800\_53\_r5: CP-9;
...
**Remediation:** aws rds modify-db-instance --db-instance-identifier --deletion-protection --apply-immediately

***

### CTL.RDS.DELETEPROT.NOBACKUP.001[​](#ctlrdsdeleteprotnobackup001 "Direct link to CTL.RDS.DELETEPROT.NOBACKUP.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** hipaa: 164.308(a)(7); nist\_800\_53\_r5: CP-9; soc2: A1.1;
...
**Remediation:** Enable automated backups with at least 7 days retention: aws rds modify-db-instance --db-instance-identifier --backup-retention-period 7 --apply-immediately

***

### CTL.RDS.ENCRYPT.001[​](#ctlrdsencrypt001 "Direct link to CTL.RDS.ENCRYPT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v1.4.0: 2.3.1; cis\_aws\_v3.0: 2.3.1; fedramp\_moderate: SC-28; ffiec: ISH-4; gdpr: Art.32; hipaa: 164.312(a)(2)(iv); iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: SC-28; nist\_csf\_2.0: PR.DS; pci\_dss\_v4.0: 3.4.1; soc2: CC6.7;
...
### CTL.RDS.ENCRYPT.BACKUP.001[​](#ctlrdsencryptbackup001 "Direct link to CTL.RDS.ENCRYPT.BACKUP.001")
...
### CTL.RDS.ENCRYPT.CMK.001[​](#ctlrdsencryptcmk001 "Direct link to CTL.RDS.ENCRYPT.CMK.001")
...
* **Type:** unsafe\_state
* **Domain:** encryption
* **Compliance:** hipaa: 164.312(a)(2)(iv); nist\_800\_53\_r5: SC-12;
...
### CTL.RDS.ENCRYPT.KMS.POLICY.001[​](#ctlrdsencryptkmspolicy001 "Direct link to CTL.RDS.ENCRYPT.KMS.POLICY.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** hipaa: 164.312(a)(2)(iv); nist\_800\_53\_r5: SC-13; pci\_dss\_v4.0: 3.6.1; soc2: CC6.1;

The KMS key used for RDS storage encryption has an overly broad key policy — kms:Decrypt granted to the account root, a wildcard principal, or a broad IAM pattern. An overly broad key policy undermines encryption: any matching principal can decrypt the database's EBS volumes, automated backups, and snapshots regardless of RDS-level access controls. Same cross-property invariant as CTL.S3.ENCRYPT.KMS.POLICY.001 applied to RDS: the resource passes the encryption-enabled check but the key policy makes the encryption cosmetic. The collector pre-computes kms\_key\_policy\_broad by joining the RDS instance's KmsKeyId to the KMS key's policy analysis.
...
### CTL.RDS.ENGINE.EOL.001[​](#ctlrdsengineeol001 "Direct link to CTL.RDS.ENGINE.EOL.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-2; hipaa: 164.312(c)(1); nist\_800\_53\_r5: SI-2; pci\_dss\_v4.0: 6.3.3; soc2: CC7.1;
...
### CTL.RDS.EVENTS.001[​](#ctlrdsevents001 "Direct link to CTL.RDS.EVENTS.001")
...
### CTL.RDS.EVENTS.DELETION.001[​](#ctlrdseventsdeletion001 "Direct link to CTL.RDS.EVENTS.DELETION.001")
...
### CTL.RDS.EVENTS.SECURITY.001[​](#ctlrdseventssecurity001 "Direct link to CTL.RDS.EVENTS.SECURITY.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** nist\_800\_53\_r5: AU-12; pci\_dss\_v4: 10.2;
...
### CTL.RDS.GHOST.EVENTSNS.001[​](#ctlrdsghosteventsns001 "Direct link to CTL.RDS.GHOST.EVENTSNS.001")
...
### CTL.RDS.GHOST.OPTIONGROUP.001[​](#ctlrdsghostoptiongroup001 "Direct link to CTL.RDS.GHOST.OPTIONGROUP.001")
...
### CTL.RDS.GHOST.PARAMGROUP.001[​](#ctlrdsghostparamgroup001 "Direct link to CTL.RDS.GHOST.PARAMGROUP.001")
...
### CTL.RDS.GHOST.PROXYSECRET.001[​](#ctlrdsghostproxysecret001 "Direct link to CTL.RDS.GHOST.PROXYSECRET.001")
...
* **Type:** unsafe\_state
* **Domain:** access
* **Compliance:** nist\_800\_53\_r5: CM-2; pci\_dss\_v4: 8.2;
...
### CTL.RDS.GHOST.SG.001[​](#ctlrdsghostsg001 "Direct link to CTL.RDS.GHOST.SG.001")
...
* **Type:** unsafe\_state
* **Domain:** network
* **Compliance:** nist\_800\_53\_r5: CM-2; pci\_dss\_v4: 1.2;
...
### CTL.RDS.GHOST.SUBNETGROUP.001[​](#ctlrdsghostsubnetgroup001 "Direct link to CTL.RDS.GHOST.SUBNETGROUP.001")
...
### CTL.RDS.HA.REPLICA.CONFIG.001[​](#ctlrdshareplicaconfig001 "Direct link to CTL.RDS.HA.REPLICA.CONFIG.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** nist\_800\_53\_r5: CM-6; pci\_dss\_v4: 1.2;
...
### CTL.RDS.HA.REPLICA.SAMEAZ.001[​](#ctlrdshareplicasameaz001 "Direct link to CTL.RDS.HA.REPLICA.SAMEAZ.001")
...
### CTL.RDS.IAMAUTH.001[​](#ctlrdsiamauth001 "Direct link to CTL.RDS.IAMAUTH.001")
...
### CTL.RDS.INCOMPLETE.001[​](#ctlrdsincomplete001 "Direct link to CTL.RDS.INCOMPLETE.001")
...
RDS instance safety cannot be assessed when encryption status is missing from the snapshot. The extractor must populate database.encryption.storage\_encrypted.

**Remediation:** Re-run the extractor with RDS permissions: rds:DescribeDBInstances, rds:DescribeDBClusters.

***

### CTL.RDS.LIFECYCLE.GENERATION.001[​](#ctlrdslifecyclegeneration001 "Direct link to CTL.RDS.LIFECYCLE.GENERATION.001")
...
### CTL.RDS.LIFECYCLE.STORAGETYPE.001[​](#ctlrdslifecyclestoragetype001 "Direct link to CTL.RDS.LIFECYCLE.STORAGETYPE.001")
...
### CTL.RDS.LOG.001[​](#ctlrdslog001 "Direct link to CTL.RDS.LOG.001")
...
### CTL.RDS.LOG.RETENTION.001[​](#ctlrdslogretention001 "Direct link to CTL.RDS.LOG.RETENTION.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** hipaa: 164.316(b)(2)(i); nist\_800\_53\_r5: AU-11; pci\_dss\_v4: 10.7;
...
### CTL.RDS.LOG.SLOWQUERY.001[​](#ctlrdslogslowquery001 "Direct link to CTL.RDS.LOG.SLOWQUERY.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** nist\_800\_53\_r5: AU-2; pci\_dss\_v4: 10.2;
...
**Remediation:** Enable the engine-appropriate slow-query parameter (slow\_query\_log for MySQL, log\_min\_duration\_statement for PostgreSQL).

***

### CTL.RDS.MINOR.UPGRADE.001[​](#ctlrdsminorupgrade001 "Direct link to CTL.RDS.MINOR.UPGRADE.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** aws\_security\_hub: RDS.13; mitre\_attack: TA0003; nist\_800\_53\_r5: SI-2;
...
**Remediation:** aws rds modify-db-instance --db-instance-identifier --auto-minor-version-upgrade --apply-immediately

***

### CTL.RDS.MONITORING.001[​](#ctlrdsmonitoring001 "Direct link to CTL.RDS.MONITORING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 2.2.1; hipaa: 164.312(b); nist\_800\_53\_r5: SI-4; soc2: CC7.1;
...
### CTL.RDS.MONITORING.INTERVAL.001[​](#ctlrdsmonitoringinterval001 "Direct link to CTL.RDS.MONITORING.INTERVAL.001")
...
### CTL.RDS.MULTIAZ.001[​](#ctlrdsmultiaz001 "Direct link to CTL.RDS.MULTIAZ.001")
...
### CTL.RDS.ORPHAN.SNAPSHOT.001[​](#ctlrdsorphansnapshot001 "Direct link to CTL.RDS.ORPHAN.SNAPSHOT.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** hipaa: 164.310(d)(2)(i); nist\_800\_53\_r5: MP-6; pci\_dss\_v4: 9.4;
...
### CTL.RDS.ORPHAN.SUBNETGROUP.001[​](#ctlrdsorphansubnetgroup001 "Direct link to CTL.RDS.ORPHAN.SUBNETGROUP.001")
...
### CTL.RDS.PARAM.GROUP.001[​](#ctlrdsparamgroup001 "Direct link to CTL.RDS.PARAM.GROUP.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** aws\_security\_hub: RDS.19; mitre\_attack: TA0005; nist\_800\_53\_r5: CM-6;
...
**Remediation:** Create a custom parameter group and attach it to the instance. Then set security parameters such as require\_secure\_transport=ON for MySQL or rds.force\_ssl=1 for PostgreSQL.

***

### CTL.RDS.PARAM.LOGEXPORT.001[​](#ctlrdsparamlogexport001 "Direct link to CTL.RDS.PARAM.LOGEXPORT.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** hipaa: 164.312(b); nist\_800\_53\_r5: AU-12; pci\_dss\_v4: 10.2;
...
### CTL.RDS.PARAM.PASSWORDHASH.001[​](#ctlrdsparampasswordhash001 "Direct link to CTL.RDS.PARAM.PASSWORDHASH.001")
...
PostgreSQL RDS instances must set the password\_encryption parameter to scram-sha-256, not md5. MD5 password hashing on PostgreSQL is unsalted (a static deterministic hash of the password and the username), which makes large-scale rainbow table lookups effective against any database whose pg\_authid contents leak — a scenario that includes routine pg\_dump artifacts, replication snapshots, and cross-account snapshot sharing. scram-sha-256 (RFC 5802 / RFC 7677, supported since PostgreSQL 10) introduces per-user salts, iterative hashing, and a challenge-response authentication exchange that does not expose the password hash to the network. The parameter governs every new password set after the change; existing MD5 hashes are converted on the next password rotation. The control fires only on PostgreSQL engines (a no-op for MySQL / SQL Server / Oracle).

**Remediation:** Set password\_encryption to scram-sha-256 in the parameter group and rotate user passwords.

***

### CTL.RDS.PERFINSIGHTS.RETENTION.001[​](#ctlrdsperfinsightsretention001 "Direct link to CTL.RDS.PERFINSIGHTS.RETENTION.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** nist\_800\_53\_r5: AU-11; soc2: CC7.2;
...
### CTL.RDS.PERFORMANCE.INSIGHTS.001[​](#ctlrdsperformanceinsights001 "Direct link to CTL.RDS.PERFORMANCE.INSIGHTS.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** aws\_security\_hub: RDS.17; mitre\_attack: TA0005; nist\_800\_53\_r5: AU-12;
...
**Remediation:** aws rds modify-db-instance --db-instance-identifier --enable-performance-insights --performance-insights-kms-key-id --performance-insights-retention-period 731 --apply-immediately

***

### CTL.RDS.PROXY.EXPOSURE.001[​](#ctlrdsproxyexposure001 "Direct link to CTL.RDS.PROXY.EXPOSURE.001")
...
* **Type:** unsafe\_state
* **Domain:** network
* **Compliance:** nist\_800\_53\_r5: AC-4; pci\_dss\_v4: 1.4;
...
### CTL.RDS.PROXY.IAM.001[​](#ctlrdsproxyiam001 "Direct link to CTL.RDS.PROXY.IAM.001")
...
* **Type:** unsafe\_state
* **Domain:** access
* **Compliance:** nist\_800\_53\_r5: IA-2; pci\_dss\_v4: 8.2;
...
### CTL.RDS.PROXY.TLS.001[​](#ctlrdsproxytls001 "Direct link to CTL.RDS.PROXY.TLS.001")
...
* **Type:** unsafe\_state
* **Domain:** encryption
* **Compliance:** hipaa: 164.312(e)(1); nist\_800\_53\_r5: SC-8; pci\_dss\_v4: 4.1;
...
### CTL.RDS.PUBLIC.001[​](#ctlrdspublic001 "Direct link to CTL.RDS.PUBLIC.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v1.4.0: 2.3.2; cis\_aws\_v3.0: 2.3.3; fedramp\_moderate: AC-3; ffiec: ISH-4; gdpr: Art.32; hipaa: 164.312(a)(1); iso\_27001\_2022: A.8.3; nist\_800\_53\_r5: AC-3; pci\_dss\_v4.0: 7.2.1; soc2: CC6.1;
...
### CTL.RDS.REPLICA.DELETEPROT.001[​](#ctlrdsreplicadeleteprot001 "Direct link to CTL.RDS.REPLICA.DELETEPROT.001")
...
**Remediation:** Enable deletion protection on the replica: aws rds modify-db-instance --db-instance-identifier --deletion-protection --apply-immediately

***

### CTL.RDS.REPLICA.ENGINE.PARITY.001[​](#ctlrdsreplicaengineparity001 "Direct link to CTL.RDS.REPLICA.ENGINE.PARITY.001")
...
**Remediation:** Upgrade the replica to match the primary's engine version: aws rds modify-db-instance --db-instance-identifier --engine-version --apply-immediately

***

### CTL.RDS.SECRET.EXISTS.001[​](#ctlrdssecretexists001 "Direct link to CTL.RDS.SECRET.EXISTS.001")
...
* **Type:** unsafe\_state
* **Domain:** access
* **Compliance:** hipaa: 164.312(d); nist\_800\_53\_r5: IA-5; pci\_dss\_v4: 8.2;
...
### CTL.RDS.SG.BROAD.001[​](#ctlrdssgbroad001 "Direct link to CTL.RDS.SG.BROAD.001")
...
* **Type:** unsafe\_state
* **Domain:** network
* **Compliance:** fedramp\_moderate: SC-7; iso\_27001\_2022: A.8.20; nist\_800\_53\_r5: SC-7; pci\_dss\_v4.0: 1.3.4; soc2: CC6.6;
...
### CTL.RDS.SNAPSHOT.AWSKEY.SHARED.001[​](#ctlrdssnapshotawskeyshared001 "Direct link to CTL.RDS.SNAPSHOT.AWSKEY.SHARED.001")
...
### CTL.RDS.SNAPSHOT.CROSSENV.001[​](#ctlrdssnapshotcrossenv001 "Direct link to CTL.RDS.SNAPSHOT.CROSSENV.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** hipaa: 164.312(a)(1); nist\_800\_53\_r5: AC-4; pci\_dss\_v4: 9.4;
...
### CTL.RDS.SNAPSHOT.ENCRYPT.001[​](#ctlrdssnapshotencrypt001 "Direct link to CTL.RDS.SNAPSHOT.ENCRYPT.001")
...
* **Type:** unsafe\_state
* **Domain:** encryption
* **Compliance:** aws\_security\_hub: RDS.4; hipaa: 164.312(a)(2)(iv); mitre\_attack: TA0010; nist\_800\_53\_r5: SC-28;
...
### CTL.RDS.SNAPSHOT.EXPORT.001[​](#ctlrdssnapshotexport001 "Direct link to CTL.RDS.SNAPSHOT.EXPORT.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** mitre\_attack: T1005; nist\_800\_53\_r5: AC-3;
...
### CTL.RDS.SNAPSHOT.PUBLIC.001[​](#ctlrdssnapshotpublic001 "Direct link to CTL.RDS.SNAPSHOT.PUBLIC.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** mitre\_attack: T1537; nist\_800\_53\_r5: AC-3;
...
**Remediation:** aws rds modify-db-snapshot-attribute --db-snapshot-identifier --attribute-name restore --values-to-remove all

***

### CTL.RDS.SNAPSHOT.STALE.001[​](#ctlrdssnapshotstale001 "Direct link to CTL.RDS.SNAPSHOT.STALE.001")
...
### CTL.RDS.SNAPSHOT.UNENCRYPTED.SHARED.001[​](#ctlrdssnapshotunencryptedshared001 "Direct link to CTL.RDS.SNAPSHOT.UNENCRYPTED.SHARED.001")
...
### CTL.RDS.SSL.001[​](#ctlrdsssl001 "Direct link to CTL.RDS.SSL.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v1.4.0: 2.3.3; fedramp\_moderate: SC-8; ffiec: ISH-4; gdpr: Art.32; hipaa: 164.312(e)(2)(ii); nist\_800\_53\_r5: SC-8; pci\_dss\_v4.0: 4.2.1; soc2: CC6.6;

RDS instances must enforce SSL/TLS for all client connections. Without require\_ssl, database traffic travels unencrypted over the network, exposing query data and credentials to interception.

**Remediation:** Set the rds.force\_ssl parameter to 1 in the parameter group (PostgreSQL) or require\_secure\_transport to ON (MySQL). For Aurora, use the cluster parameter group.

***

### CTL.RDS.SSL.ENFORCE.001[​](#ctlrdssslenforce001 "Direct link to CTL.RDS.SSL.ENFORCE.001")
...
* **Type:** unsafe\_state
* **Domain:** encryption
* **Compliance:** aws\_security\_hub: RDS.25; hipaa: 164.312(e)(2)(ii); mitre\_attack: TA0006; nist\_800\_53\_r5: SC-8;

RDS connections without SSL/TLS transmit database credentials and query results in plaintext over the network. In a VPC, any compromised instance with network access can capture database passwords and sensitive data via passive network monitoring. SSL enforcement is configured via parameter group (require\_secure\_transport for MySQL, rds.force\_ssl for PostgreSQL/SQL Server).

**Remediation:** Set the appropriate SSL parameter in the parameter group: MySQL: require\_secure\_transport=ON. PostgreSQL: rds.force\_ssl=1. SQL Server: rds.force\_ssl=1.

***

### CTL.RDS.TLS.CACERT.001[​](#ctlrdstlscacert001 "Direct link to CTL.RDS.TLS.CACERT.001")
...
* **Type:** unsafe\_state
* **Domain:** encryption
* **Compliance:** nist\_800\_53\_r5: SC-13; pci\_dss\_v4: 4.1;
