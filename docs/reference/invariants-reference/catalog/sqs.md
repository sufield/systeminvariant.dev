...
### CTL.SQS.ALARM.AGE.001[​](#ctlsqsalarmage001 "Direct link to CTL.SQS.ALARM.AGE.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** fedramp\_moderate: SI-4; iso\_27001\_2022: A.8.16, A.5.30; nist\_800\_53\_r5: SI-4, AU-11; pci\_dss\_v4.0: 10.6; soc2: CC7.2, A1.2;
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** cis\_aws\_v3.0: 4.13; fedramp\_moderate: SI-4; iso\_27001\_2022: A.8.16, A.5.30; nist\_800\_53\_r5: AU-6, IR-4, SI-4, CP-10; pci\_dss\_v4.0: 10.6, 10.7; soc2: CC7.2, CC7.3, A1.2;
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** fedramp\_moderate: SI-4; iso\_27001\_2022: A.8.16, A.8.15; nist\_800\_53\_r5: SI-4, AU-11; pci\_dss\_v4.0: 10.6; soc2: CC7.2, A1.2;
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** cis\_aws\_v3.0: 4.13; fedramp\_moderate: SI-4; iso\_27001\_2022: A.8.16, A.5.30; nist\_800\_53\_r5: AU-6, IR-4, SI-4; pci\_dss\_v4.0: 10.6, 10.7; soc2: CC7.2, CC7.3, A1.2;

No CloudWatch alarm is wired to a CloudTrail metric filter on the PurgeQueue API call. PurgeQueue is mass deletion — a single API call removes every message from the queue immediately, irreversibly, with no DLQ preservation. Without an alarm a queue can be purged accidentally, maliciously, or by automation with no real-time notification; the team discovers the loss only when downstream systems report missing data. Pairs with CTL.SQS.POLICY.PURGE.001 (SQS-2) which checks who can issue PurgeQueue; this control checks whether the issuance is monitored. The dangerous combination is "permitted broadly AND undetected", caught by the sqs\_destructive\_undetected chain.

**Remediation:** Create a CloudTrail metric filter on eventName = PurgeQueue scoped to the queue's ARN, then a CloudWatch alarm with threshold 1 and a 60-second period so a single PurgeQueue call pages on-call within seconds: aws logs put-metric-filter --filter-pattern '{ $.eventName = "PurgeQueue" && $.requestParameters.queueUrl = "**" }' followed by aws cloudwatch put-metric-alarm.

***

### CTL.SQS.ALARM.SENT.001[​](#ctlsqsalarmsent001 "Direct link to CTL.SQS.ALARM.SENT.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** fedramp\_moderate: SI-4; iso\_27001\_2022: A.8.16; nist\_800\_53\_r5: SI-4; pci\_dss\_v4.0: 10.6; soc2: CC7.2, CC7.3;
...
**Remediation:** Use CloudWatch anomaly detection rather than a static threshold so the alarm adapts to the queue's baseline: aws cloudwatch put-metric-alarm --alarm-name SQS-Sent-Anomaly- --metric-name NumberOfMessagesSent --namespace AWS/SQS --statistic Sum --period 300 --evaluation-periods 2 --comparison-operator GreaterThanUpperThreshold --thresholds-metric-id e1 --metrics ... --dimensions Name=QueueName,Value= --alarm-actions . Alternatively, set a percentage-deviation alarm against the same metric's prior-week baseline.

***

### CTL.SQS.AUDIT.DATAEVENTS.001[​](#ctlsqsauditdataevents001 "Direct link to CTL.SQS.AUDIT.DATAEVENTS.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** cis\_aws\_v3.0: 3.2; fedramp\_moderate: AU-2; hipaa: 164.312(b); iso\_27001\_2022: A.8.15, A.8.16; nist\_800\_53\_r5: AU-2, AU-3, AU-12; pci\_dss\_v4.0: 10.1, 10.2, 10.3; soc2: CC7.1, CC7.2;
...
**Remediation:** Add an SQS data-event selector to a CloudTrail trail covering this queue: aws cloudtrail put-event-selectors --trail-name --advanced-event-selectors '\[{"Name":"SQS data events","FieldSelectors": \[{"Field":"eventCategory","Equals":\["Data"]}, {"Field":"resources.type","Equals":\["AWS::SQS::Queue"]}, {"Field":"resources.ARN","Equals":\[""]}]}]'. Restrict the resource ARN selector to security-sensitive queues so the data-event volume cost stays bounded. Verify the trail's S3 destination is in the same organization with appropriate access controls.

***

### CTL.SQS.CONFIG.RETENTION.SHORT.001[​](#ctlsqsconfigretentionshort001 "Direct link to CTL.SQS.CONFIG.RETENTION.SHORT.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: AU-11; iso\_27001\_2022: A.8.15, A.8.32; nist\_800\_53\_r5: CM-6, AU-11, SI-11; pci\_dss\_v4.0: 10.6; soc2: CC6.1, A1.2;
...
**Remediation:** Decide whether short retention is intentional. If the workload is real-time (stale messages have no value), document the choice with a queue tag so the finding is explicitly exempted. Otherwise raise the retention to at least 24 hours, ideally 4 days (the SQS default), so intermittent consumers, replays, and incident-driven processing have a longer recovery window. Apply via aws sqs set-queue-attributes --queue-url --attributes MessageRetentionPeriod=345600.

***

### CTL.SQS.CONFIG.SHORTPOLLING.001[​](#ctlsqsconfigshortpolling001 "Direct link to CTL.SQS.CONFIG.SHORTPOLLING.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: CM-6; iso\_27001\_2022: A.8.32; nist\_800\_53\_r5: CM-6, SA-22; soc2: CC6.1, A1.2;
...
**Remediation:** Set ReceiveMessageWaitTimeSeconds to 20 (the maximum) so polls block until a message arrives or the timeout elapses: aws sqs set-queue-attributes --queue-url --attributes ReceiveMessageWaitTimeSeconds=20. The consumer's ReceiveMessage calls should pass WaitTimeSeconds=20 as well to honor long-polling semantics end-to-end.

***

### CTL.SQS.CONFIG.VISIBILITYTIMEOUT.RETENTION.001[​](#ctlsqsconfigvisibilitytimeoutretention001 "Direct link to CTL.SQS.CONFIG.VISIBILITYTIMEOUT.RETENTION.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: CM-6; iso\_27001\_2022: A.8.32, A.5.30; nist\_800\_53\_r5: CM-6, SI-11, CP-10; pci\_dss\_v4.0: 10.6; soc2: CC6.1, A1.2, CC7.4;
...
**Remediation:** Reduce VisibilityTimeout below MessageRetentionPeriod so every in-flight message is recoverable for at least one full visibility cycle. The standard guidance is visibility = max-expected-processing-time + buffer, while retention = visibility \* retries (matching the redrive policy's maxReceiveCount). Apply via aws sqs set-queue-attributes --queue-url --attributes VisibilityTimeout=300,MessageRetentionPeriod=345600.

***

### CTL.SQS.CROSSACCOUNT.DLQ.001[​](#ctlsqscrossaccountdlq001 "Direct link to CTL.SQS.CROSSACCOUNT.DLQ.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: AC-4; iso\_27001\_2022: A.5.14, A.5.15; nist\_800\_53\_r5: AC-3, AC-4, SC-7; pci\_dss\_v4.0: 1.2, 3.5; soc2: CC6.1, CC6.6;
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SI-11; iso\_27001\_2022: A.5.30, A.8.32; nist\_800\_53\_r5: SI-11, CP-10, AU-2; soc2: PI1.1, A1.2, CC7.4;
...
**Remediation:** Configure a redrive policy targeting a dedicated DLQ: aws sqs set-queue-attributes --queue-url --attributes RedrivePolicy='{"deadLetterTargetArn":"", "maxReceiveCount":"5"}'. Set maxReceiveCount to 3-5 (see CTL.SQS.DLQ.MAXRECEIVE.LOW\.001) and ensure the DLQ has a consumer (see CTL.SQS.DLQ.NOCONSUMER.001). FIFO queues require an FIFO DLQ; standard queues require a standard DLQ.

***

### CTL.SQS.DLQ.MAXRECEIVE.LOW\.001[​](#ctlsqsdlqmaxreceivelow001 "Direct link to CTL.SQS.DLQ.MAXRECEIVE.LOW.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-11; iso\_27001\_2022: A.5.30, A.8.32; nist\_800\_53\_r5: SI-11, CP-10; soc2: A1.2, CC7.4;
...
**Remediation:** Raise maxReceiveCount to 3-5 unless there is a documented reason to keep it at 1 (aws sqs set-queue-attributes --queue-url --attributes RedrivePolicy='{"deadLetterTargetArn":"", "maxReceiveCount":"5"}'). Pair with an alarm on the DLQ's ApproximateNumberOfMessagesVisible so a sudden DLQ surge surfaces quickly regardless of the threshold.

***

### CTL.SQS.DLQ.NOCONSUMER.001[​](#ctlsqsdlqnoconsumer001 "Direct link to CTL.SQS.DLQ.NOCONSUMER.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SI-11; iso\_27001\_2022: A.5.30, A.8.16; nist\_800\_53\_r5: AU-2, SI-11, IR-4; soc2: A1.2, CC7.4, CC7.2;
...
### CTL.SQS.DLQ.RETENTION.MISMATCH.001[​](#ctlsqsdlqretentionmismatch001 "Direct link to CTL.SQS.DLQ.RETENTION.MISMATCH.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: AU-11; iso\_27001\_2022: A.8.15; nist\_800\_53\_r5: AU-11, SI-11; soc2: A1.2, CC7.4;
...
**Remediation:** Raise the DLQ's MessageRetentionPeriod to match or exceed the source queue's (aws sqs set-queue-attributes --queue-url --attributes MessageRetentionPeriod=1209600 for 14 days). Verify against every queue using the DLQ as a target; the DLQ must satisfy the longest source-side retention among its sources.

***

### CTL.SQS.ENCRYPT.001[​](#ctlsqsencrypt001 "Direct link to CTL.SQS.ENCRYPT.001")
...
### CTL.SQS.ENCRYPT.CMK.001[​](#ctlsqsencryptcmk001 "Direct link to CTL.SQS.ENCRYPT.CMK.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 2.1.1; fedramp\_moderate: SC-12; hipaa: 164.312(a)(2)(iv); iso\_27001\_2022: A.8.24; nist\_800\_53\_r5: SC-12, SC-13, SC-28; pci\_dss\_v4.0: 3.5; soc2: CC6.1, CC6.7;
...
**Remediation:** Create or select a CMK and assign it to the queue (aws sqs set-queue-attributes --queue-url --attributes KmsMasterKeyId=arn:aws:kms:...:key/...). Verify the CMK's key policy allows SQS to decrypt (kms:Decrypt for the SQS service principal). The CMK gives the organization key-policy control, audit visibility via CloudTrail KMS events, and the ability to revoke access by disabling the key — none of which are available with SSE-SQS or alias/aws/sqs.

***

### CTL.SQS.ENCRYPT.TRANSPORT.001[​](#ctlsqsencrypttransport001 "Direct link to CTL.SQS.ENCRYPT.TRANSPORT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 2.1.2; fedramp\_moderate: SC-8; hipaa: 164.312(e)(1); iso\_27001\_2022: A.8.20; nist\_800\_53\_r5: SC-8, SC-13; pci\_dss\_v4.0: 4.1, 4.2; soc2: CC6.1, CC6.7;
...
**Remediation:** Add a Deny statement to the queue policy: {"Effect":"Deny","Principal":"*","Action":"sqs:*", "Resource":"","Condition": {"Bool":{"aws:SecureTransport":"false"}}}. Apply via aws sqs set-queue-attributes --queue-url --attributes Policy=<file://policy.json>. Verify all producers and consumers use the HTTPS endpoint (sqs..amazonaws.com, not the legacy HTTP sqs-fips-... or vpce HTTP endpoints).

***

### CTL.SQS.ENCRYPTION.001[​](#ctlsqsencryption001 "Direct link to CTL.SQS.ENCRYPTION.001")
...
* **Type:** unsafe\_state
* **Domain:** encryption
* **Compliance:** aws\_security\_hub: SQS.1; mitre\_attack: T1530; nist\_800\_53\_r5: SC-28;
...
**Remediation:** Enable SSE-KMS on the queue: aws sqs set-queue-attributes --queue-url --attributes KmsMasterKeyId=alias/aws/sqs

***

### CTL.SQS.GHOST.ALARM.001[​](#ctlsqsghostalarm001 "Direct link to CTL.SQS.GHOST.ALARM.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SI-4; iso\_27001\_2022: A.8.16; nist\_800\_53\_r5: CM-2, SI-4; soc2: CC6.1, CC7.2;
...
**Remediation:** Identify the alarm (aws cloudwatch describe-alarms --alarm-names ) and either delete the alarm (aws cloudwatch delete-alarms --alarm-names ) or repoint it to a live queue if the workload is still running against a replacement. Audit the broader monitoring inventory at the same time — a deleted queue often correlates with stale dashboards and stale runbook entries.

***

### CTL.SQS.GHOST.DLQ.001[​](#ctlsqsghostdlq001 "Direct link to CTL.SQS.GHOST.DLQ.001")
...
**Remediation:** Identify the offending queue (aws sqs get-queue-attributes --queue-url --attribute-names RedrivePolicy) and either recreate the DLQ at the original ARN, repoint the redrive policy to a live DLQ (aws sqs set-queue-attributes --attributes RedrivePolicy='{"deadLetterTargetArn":"", "maxReceiveCount":"5"}'), or remove the redrive policy entirely if the workload no longer needs DLQ semantics. Pair with a CloudWatch alarm on ApproximateNumberOfMessagesNotVisible so a future deletion surfaces immediately.

***

### CTL.SQS.GHOST.POLICY.SOURCEARN.001[​](#ctlsqsghostpolicysourcearn001 "Direct link to CTL.SQS.GHOST.POLICY.SOURCEARN.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: CM-2; iso\_27001\_2022: A.5.16, A.8.9; nist\_800\_53\_r5: CM-2, CM-3, AC-3; soc2: CC6.1, CC8.1;
...
### CTL.SQS.LIFECYCLE.DLQ.ORPHAN.001[​](#ctlsqslifecycledlqorphan001 "Direct link to CTL.SQS.LIFECYCLE.DLQ.ORPHAN.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: CM-2; iso\_27001\_2022: A.5.16, A.8.32; nist\_800\_53\_r5: CM-2, CM-3; soc2: CC6.1, CC8.1;
...
**Remediation:** Inspect the DLQ contents (aws sqs receive-message --queue-url --max-number-of-messages 10) to determine whether any accumulated messages still need investigation or reprocessing. After triage — replay, archive, or accept loss — delete the DLQ (aws sqs delete-queue --queue-url ). If the decommission of the source was unintentional and the pipeline should be restored, recreate the source queue and re-attach the redrive policy.

***

### CTL.SQS.LIFECYCLE.DORMANT.001[​](#ctlsqslifecycledormant001 "Direct link to CTL.SQS.LIFECYCLE.DORMANT.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: CM-2; iso\_27001\_2022: A.5.16, A.8.32; nist\_800\_53\_r5: CM-2, CM-3, SA-22; pci\_dss\_v4.0: 1.2, 7.2; soc2: CC6.1, CC8.1;
...
**Remediation:** Audit the queue's CloudTrail history (SendMessage / ReceiveMessage events) to confirm true dormancy. If the queue is truly unused, delete it (aws sqs delete-queue --queue-url ). If the queue is held for future use, restrict the policy to a minimal principal set, attach a CloudWatch alarm on NumberOfMessagesSent so any traffic surfaces immediately, and document the planned reactivation date.

***

### CTL.SQS.LIFECYCLE.NOCONSUMER.001[​](#ctlsqslifecyclenoconsumer001 "Direct link to CTL.SQS.LIFECYCLE.NOCONSUMER.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 1.20; fedramp\_moderate: AC-3; iso\_27001\_2022: A.5.15, A.5.19; nist\_800\_53\_r5: AC-3, AC-4, AC-6; pci\_dss\_v4.0: 1.2, 7.1, 7.2; soc2: CC6.1, CC6.6;
...
### CTL.SQS.POLICY.DELETEBROADLY.001[​](#ctlsqspolicydeletebroadly001 "Direct link to CTL.SQS.POLICY.DELETEBROADLY.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-6; iso\_27001\_2022: A.5.15, A.8.3; nist\_800\_53\_r5: AC-3, AC-6, SI-11; pci\_dss\_v4.0: 1.2, 7.1; soc2: CC6.1, CC6.6, A1.2;
...
### CTL.SQS.POLICY.EVENTS.NOSOURCE.001[​](#ctlsqspolicyeventsnosource001 "Direct link to CTL.SQS.POLICY.EVENTS.NOSOURCE.001")
...
### CTL.SQS.POLICY.GHOSTREF.001[​](#ctlsqspolicyghostref001 "Direct link to CTL.SQS.POLICY.GHOSTREF.001")
...
### CTL.SQS.POLICY.PUBLIC.001[​](#ctlsqspolicypublic001 "Direct link to CTL.SQS.POLICY.PUBLIC.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** aws\_security\_hub: SQS.1; nist\_800\_53\_r5: AC-3; pci\_dss\_v4.0: 7.2.1; soc2: CC6.1;
...
### CTL.SQS.POLICY.PURGE.001[​](#ctlsqspolicypurge001 "Direct link to CTL.SQS.POLICY.PURGE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 1.20; fedramp\_moderate: AC-6; iso\_27001\_2022: A.5.15, A.8.3; nist\_800\_53\_r5: AC-6, SI-11, SI-13; pci\_dss\_v4.0: 1.2, 7.1, 7.2; soc2: CC6.1, CC6.6, A1.2;
...
### CTL.SQS.POLICY.RECEIVEMESSAGE.BROAD.001[​](#ctlsqspolicyreceivemessagebroad001 "Direct link to CTL.SQS.POLICY.RECEIVEMESSAGE.BROAD.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 1.20; fedramp\_moderate: AC-3; iso\_27001\_2022: A.5.15, A.8.3; nist\_800\_53\_r5: AC-3, AC-6; pci\_dss\_v4.0: 1.2, 7.1; soc2: CC6.1, CC6.6;
...
### CTL.SQS.POLICY.S3.NOSOURCE.001[​](#ctlsqspolicys3nosource001 "Direct link to CTL.SQS.POLICY.S3.NOSOURCE.001")
...
### CTL.SQS.POLICY.SNS.NOSOURCE.001[​](#ctlsqspolicysnsnosource001 "Direct link to CTL.SQS.POLICY.SNS.NOSOURCE.001")
...
### CTL.SQS.POLICY.SPRAWL.001[​](#ctlsqspolicysprawl001 "Direct link to CTL.SQS.POLICY.SPRAWL.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: AC-6; iso\_27001\_2022: A.5.15, A.5.19; nist\_800\_53\_r5: AC-6, CM-2; soc2: CC6.1, CC8.1;
