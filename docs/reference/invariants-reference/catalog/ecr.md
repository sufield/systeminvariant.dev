...
### CTL.ECR.ENCRYPT.CMK.001[​](#ctlecrencryptcmk001 "Direct link to CTL.ECR.ENCRYPT.CMK.001")
...
### CTL.ECR.ENHANCED.SCANNING.001[​](#ctlecrenhancedscanning001 "Direct link to CTL.ECR.ENHANCED.SCANNING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: RA-5; nist\_800\_53\_r5: RA-5; pci\_dss\_v4.0: 11.3.1; soc2: CC7.1;
...
### CTL.ECR.FINDINGS.UNRESOLVED.001[​](#ctlecrfindingsunresolved001 "Direct link to CTL.ECR.FINDINGS.UNRESOLVED.001")
...
### CTL.ECR.INCOMPLETE.001[​](#ctlecrincomplete001 "Direct link to CTL.ECR.INCOMPLETE.001")
...
ECR repository safety cannot be proven when access control data is missing from the snapshot. The extractor must populate container\_registry.access.public to evaluate exposure controls.

**Remediation:** Re-run the extractor with ECR permissions: ecr:DescribeRepositories, ecr:GetRepositoryPolicy.

***

### CTL.ECR.LIFECYCLE.001[​](#ctlecrlifecycle001 "Direct link to CTL.ECR.LIFECYCLE.001")
...
**Remediation:** aws ecr put-lifecycle-policy --repository-name --lifecycle-policy-text ''

***

### CTL.ECR.POLICY.BROAD.001[​](#ctlecrpolicybroad001 "Direct link to CTL.ECR.POLICY.BROAD.001")
...
### CTL.ECR.PUBLIC.001[​](#ctlecrpublic001 "Direct link to CTL.ECR.PUBLIC.001")
...
### CTL.ECR.SCAN.001[​](#ctlecrscan001 "Direct link to CTL.ECR.SCAN.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: RA-5; nist\_800\_53\_r5: RA-5; soc2: CC7.1;
...
### CTL.ECR.SIGNING.001[​](#ctlecrsigning001 "Direct link to CTL.ECR.SIGNING.001")
...
### CTL.ECR.TAG.IMMUTABLE.001[​](#ctlecrtagimmutable001 "Direct link to CTL.ECR.TAG.IMMUTABLE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws: 5.4; nist\_800\_53\_r5: SI-7;
...
**Remediation:** aws ecr put-image-tag-mutability --repository-name --image-tag-mutability IMMUTABLE
