...
### CTL.SNS.ALARM.DELETETOPIC.001[​](#ctlsnsalarmdeletetopic001 "Direct link to CTL.SNS.ALARM.DELETETOPIC.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** cis\_aws\_v3.0: 4.4; fedramp\_moderate: SI-4; iso\_27001\_2022: A.8.16; nist\_800\_53\_r5: SI-4, IR-4, IR-5; pci\_dss\_v4.0: 10.6, 10.7; soc2: CC7.2, CC7.3;
...
**Remediation:** Create a CloudWatch alarm on AWS/SNS NumberOfNotificationsFailed dimensioned by the topic ARN with a non-zero threshold and a short evaluation period (5 minutes is a reasonable starting point): aws cloudwatch put-metric-alarm --alarm-name sns--delivery-failures --metric-name NumberOfNotificationsFailed --namespace AWS/SNS --dimensions Name=TopicName,Value= --statistic Sum --threshold 1 --period 300 --evaluation-periods 1 --comparison-operator GreaterThanOrEqualToThreshold.

***

### CTL.SNS.ALARM.PUBLISHED.001[​](#ctlsnsalarmpublished001 "Direct link to CTL.SNS.ALARM.PUBLISHED.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** fedramp\_moderate: SI-4; iso\_27001\_2022: A.8.16; nist\_800\_53\_r5: SI-4, IR-4; pci\_dss\_v4.0: 10.6; soc2: CC7.2, CC7.3;
...
### CTL.SNS.ALARM.SMSSPEND.001[​](#ctlsnsalarmsmsspend001 "Direct link to CTL.SNS.ALARM.SMSSPEND.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SI-4; iso\_27001\_2022: A.5.30, A.8.16; nist\_800\_53\_r5: SI-4, AU-12; pci\_dss\_v4.0: 10.6; soc2: CC7.2, A1.2;
...
**Remediation:** Add an SNS data-event selector to a CloudTrail trail covering this topic: aws cloudtrail put-event-selectors --trail-name --advanced-event-selectors '\[{"Name":"SNS data events","FieldSelectors": \[{"Field":"eventCategory","Equals":\["Data"]}, {"Field":"resources.type","Equals":\["AWS::SNS::Topic"]}, {"Field":"resources.ARN","Equals":\[""]}]}]'. Restrict the resource ARN selector to security-sensitive topics (alarm-notification, financial-event, compliance-event topics) so the data-event volume cost stays bounded. Verify the trail's S3 destination is in the same organization with appropriate access controls.

***

### CTL.SNS.CROSSACCOUNT.SUBSCRIPTION.001[​](#ctlsnscrossaccountsubscription001 "Direct link to CTL.SNS.CROSSACCOUNT.SUBSCRIPTION.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-3; iso\_27001\_2022: A.5.15, A.8.9; nist\_800\_53\_r5: AC-3, AC-4, SC-7; pci\_dss\_v4.0: 1.2, 7.1; soc2: CC6.1, CC6.6;
...
### CTL.SNS.DATAPROTECTION.001[​](#ctlsnsdataprotection001 "Direct link to CTL.SNS.DATAPROTECTION.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: SC-28; scs\_c02: 8.12; soc2: CC6.7;
...
**Remediation:** Add a data protection policy: aws sns put-data-protection-policy --resource-arn --data-protection-policy file://policy.json.

***

### CTL.SNS.DELIVERY.LOG.RETENTION.001[​](#ctlsnsdeliverylogretention001 "Direct link to CTL.SNS.DELIVERY.LOG.RETENTION.001")
...
### CTL.SNS.DELIVERY.STATUS.DISABLED.001[​](#ctlsnsdeliverystatusdisabled001 "Direct link to CTL.SNS.DELIVERY.STATUS.DISABLED.001")
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** fedramp\_moderate: AU-2; iso\_27001\_2022: A.8.15, A.8.16; nist\_800\_53\_r5: AU-2, AU-3, AU-6, AU-11; pci\_dss\_v4.0: 10.1, 10.7; soc2: CC7.1, CC7.2;
...
* **Type:** unsafe\_state
* **Domain:** detection
* **Compliance:** fedramp\_moderate: AU-2; iso\_27001\_2022: A.8.15, A.8.16; nist\_800\_53\_r5: AU-2, AU-3, AU-6; pci\_dss\_v4.0: 10.1, 10.7; soc2: CC7.1, CC7.2;
...
**Remediation:** For each subscription\_protocol used by the topic, configure the matching SuccessFeedbackRoleArn and FailureFeedbackRoleArn on the topic. Aim for parity: every protocol the topic delivers to should record delivery outcomes. Inspect properties.messaging.sns.unlogged\_protocols to identify which protocols are missing coverage.

***

### CTL.SNS.ENCRYPT.001[​](#ctlsnsencrypt001 "Direct link to CTL.SNS.ENCRYPT.001")
...
### CTL.SNS.ENCRYPT.CMK.001[​](#ctlsnsencryptcmk001 "Direct link to CTL.SNS.ENCRYPT.CMK.001")
...
**Remediation:** Create or select a CMK and assign it to the topic (aws sns set-topic-attributes --topic-arn --attribute-name KmsMasterKeyId --attribute-value arn:aws:kms:...:key/...). Verify the CMK's key policy allows SNS to decrypt for the publisher and subscribers that need the message content.

***

### CTL.SNS.ENCRYPT.TRANSPORT.001[​](#ctlsnsencrypttransport001 "Direct link to CTL.SNS.ENCRYPT.TRANSPORT.001")
...
**Remediation:** Add a Deny statement to the topic policy: {"Effect":"Deny","Principal":"*","Action":"sns:*", "Resource":"","Condition": {"Bool":{"aws:SecureTransport":"false"}}}. Apply via aws sns set-topic-attributes --topic-arn --attribute-name Policy --attribute-value . Verify all publishers use the HTTPS endpoint.

***

### CTL.SNS.ENCRYPTION.001[​](#ctlsnsencryption001 "Direct link to CTL.SNS.ENCRYPTION.001")
...
* **Type:** unsafe\_state
* **Domain:** encryption
* **Compliance:** aws\_security\_hub: SNS.1; mitre\_attack: T1530; nist\_800\_53\_r5: SC-28;
...
**Remediation:** Enable SSE-KMS on the topic: aws sns set-topic-attributes --topic-arn --attribute-name KmsMasterKeyId --attribute-value alias/aws/sns

***

### CTL.SNS.FIFO.NONFIFO.SUBSCRIPTION.001[​](#ctlsnsfifononfifosubscription001 "Direct link to CTL.SNS.FIFO.NONFIFO.SUBSCRIPTION.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SI-10; iso\_27001\_2022: A.8.32; nist\_800\_53\_r5: SI-10; pci\_dss\_v4.0: 10.2; soc2: CC6.1, PI1.1;
...
### CTL.SNS.GHOST.ALARM.001[​](#ctlsnsghostalarm001 "Direct link to CTL.SNS.GHOST.ALARM.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** cis\_aws\_v3.0: 4.1, 4.13; fedramp\_moderate: SI-4; iso\_27001\_2022: A.5.16, A.8.16; nist\_800\_53\_r5: CM-2, CM-3, IR-4, SI-4; pci\_dss\_v4.0: 10.6, 10.7; soc2: CC7.2, CC7.3, CC8.1;
...
**Remediation:** Identify the alarm (aws cloudwatch describe-alarms --alarm-names ) and repoint the action to a live SNS topic (aws cloudwatch put-metric-alarm --alarm-name --alarm-actions ). Audit every alarm in the account against the topic inventory at the same time — a deleted topic typically had multiple alarms pointing at it. Add a CloudWatch metric on AWS/SNS NumberOfMessagesPublished == 0 for every notification topic so accidental deletions surface immediately.

***

### CTL.SNS.GHOST.POLICY.SOURCEARN.001[​](#ctlsnsghostpolicysourcearn001 "Direct link to CTL.SNS.GHOST.POLICY.SOURCEARN.001")
...
**Remediation:** Inspect the topic policy (aws sns get-topic-attributes --topic-arn --query 'Attributes.Policy') and either remove the stale sourceArn condition, repoint it to the actual sender that replaced the deleted resource, or delete the topic if it is no longer in use.

***

### CTL.SNS.GHOST.SUBSCRIPTION.DLQ.001[​](#ctlsnsghostsubscriptiondlq001 "Direct link to CTL.SNS.GHOST.SUBSCRIPTION.DLQ.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SI-11; iso\_27001\_2022: A.5.16, A.8.32; nist\_800\_53\_r5: CM-2, CM-3, SI-11; soc2: CC6.1, CC7.4, A1.2;
...
**Remediation:** Recreate the DLQ at the original ARN, repoint the subscription's redrive policy to a live DLQ (aws sns set-subscription-attributes --subscription-arn --attribute-name RedrivePolicy --attribute-value '{"deadLetterTargetArn":""}'), or remove the redrive policy entirely if the workload accepts permanent loss on delivery failure (rare — document the choice).

***

### CTL.SNS.GHOST.SUBSCRIPTION.HTTP.001[​](#ctlsnsghostsubscriptionhttp001 "Direct link to CTL.SNS.GHOST.SUBSCRIPTION.HTTP.001")
...
### CTL.SNS.GHOST.SUBSCRIPTION.LAMBDA.001[​](#ctlsnsghostsubscriptionlambda001 "Direct link to CTL.SNS.GHOST.SUBSCRIPTION.LAMBDA.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: CM-2; iso\_27001\_2022: A.5.16, A.8.32; nist\_800\_53\_r5: CM-2, CM-3, IR-4; soc2: CC6.1, CC8.1, CC7.4;
...
### CTL.SNS.GHOST.SUBSCRIPTION.SQS.001[​](#ctlsnsghostsubscriptionsqs001 "Direct link to CTL.SNS.GHOST.SUBSCRIPTION.SQS.001")
...
### CTL.SNS.LIFECYCLE.DORMANT.001[​](#ctlsnslifecycledormant001 "Direct link to CTL.SNS.LIFECYCLE.DORMANT.001")
...
**Remediation:** Audit the topic's CloudTrail history (Publish events) to confirm true dormancy. If the topic is truly unused, delete it (aws sns delete-topic --topic-arn ) along with all its subscriptions. If the topic is held for future use, restrict the policy to a minimal principal set, remove stale subscriptions, attach a CloudWatch alarm on NumberOfMessagesPublished so any publish activity surfaces immediately, and document the planned reactivation date.

***

### CTL.SNS.LIFECYCLE.NOSUBSCRIBERS.001[​](#ctlsnslifecyclenosubscribers001 "Direct link to CTL.SNS.LIFECYCLE.NOSUBSCRIBERS.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: CM-2; iso\_27001\_2022: A.5.16; nist\_800\_53\_r5: CM-2, CM-3, SA-22; pci\_dss\_v4.0: 1.2; soc2: CC6.1, CC8.1;
...
### CTL.SNS.LIFECYCLE.ORPHAN.ALARM.001[​](#ctlsnslifecycleorphanalarm001 "Direct link to CTL.SNS.LIFECYCLE.ORPHAN.ALARM.001")
...
**Remediation:** Audit the topic's referencing alarms; if all referencing alarms have been deleted and no new alarms are planned to use the topic, delete the topic (aws sns delete-topic --topic-arn ) and clean up its subscriptions. If a replacement alarm is planned, document the dependency so the topic isn't deleted before the new alarm is wired. Pair this control with CTL.SNS.GHOST.ALARM.001 — together they identify both sides of the broken notification-chain pattern.

***

### CTL.SNS.LIFECYCLE.UNCONFIRMED.001[​](#ctlsnslifecycleunconfirmed001 "Direct link to CTL.SNS.LIFECYCLE.UNCONFIRMED.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: CM-2; iso\_27001\_2022: A.5.16, A.8.16; nist\_800\_53\_r5: CM-2, CM-3, SI-4; pci\_dss\_v4.0: 1.2, 10.6; soc2: CC6.1, CC7.2, CC8.1;
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 1.20; fedramp\_moderate: AC-3; iso\_27001\_2022: A.5.15, A.8.16; nist\_800\_53\_r5: AC-3, AC-4, SI-4; pci\_dss\_v4.0: 1.2, 7.1, 10.6; soc2: CC6.1, CC6.6, CC7.2;
...
### CTL.SNS.POLICY.CROSSACCOUNT.001[​](#ctlsnspolicycrossaccount001 "Direct link to CTL.SNS.POLICY.CROSSACCOUNT.001")
...
### CTL.SNS.POLICY.DELETETOPIC.BROAD.001[​](#ctlsnspolicydeletetopicbroad001 "Direct link to CTL.SNS.POLICY.DELETETOPIC.BROAD.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 1.20; fedramp\_moderate: AC-6; iso\_27001\_2022: A.5.15, A.8.3; nist\_800\_53\_r5: AC-6, SI-11, SI-13, IR-4; pci\_dss\_v4.0: 1.2, 7.1, 7.2; soc2: CC6.1, CC6.6, A1.2;
...
**Remediation:** Restrict sns:DeleteTopic to a named topic-admin role or the account root. Audit the policy (aws sns get-topic-attributes --topic-arn --query 'Attributes.Policy') and remove DeleteTopic from consumer roles, integration roles, and cross-account principals. If automation needs DeleteTopic (e.g., an environment-teardown pipeline), grant it to a specific service role rather than to an entire account or wildcard pattern.

***

### CTL.SNS.POLICY.GHOSTREF.001[​](#ctlsnspolicyghostref001 "Direct link to CTL.SNS.POLICY.GHOSTREF.001")
...
### CTL.SNS.POLICY.LAMBDA.NOSOURCE.001[​](#ctlsnspolicylambdanosource001 "Direct link to CTL.SNS.POLICY.LAMBDA.NOSOURCE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 1.20; fedramp\_moderate: AC-3; iso\_27001\_2022: A.5.15, A.8.9; nist\_800\_53\_r5: AC-3, AC-4; pci\_dss\_v4.0: 1.2, 7.1; soc2: CC6.1, CC6.6;
...
### CTL.SNS.POLICY.PUBLIC.001[​](#ctlsnspolicypublic001 "Direct link to CTL.SNS.POLICY.PUBLIC.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** aws\_security\_hub: SNS.1; nist\_800\_53\_r5: AC-3; pci\_dss\_v4.0: 7.2.1; soc2: CC6.1;
...
### CTL.SNS.POLICY.S3.NOSOURCE.001[​](#ctlsnspolicys3nosource001 "Direct link to CTL.SNS.POLICY.S3.NOSOURCE.001")
...
### CTL.SNS.POLICY.SETTOPICATTRS.BROAD.001[​](#ctlsnspolicysettopicattrsbroad001 "Direct link to CTL.SNS.POLICY.SETTOPICATTRS.BROAD.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-6; iso\_27001\_2022: A.5.15, A.8.3; nist\_800\_53\_r5: AC-6, AC-3, CM-3; pci\_dss\_v4.0: 1.2, 7.1, 7.2; soc2: CC6.1, CC6.6;
...
**Remediation:** Restrict sns:SetTopicAttributes to a named topic-admin role or the account root. Audit the policy (aws sns get-topic-attributes --topic-arn --query 'Attributes.Policy') and remove SetTopicAttributes from any non-admin principal. Add CloudTrail metric-filter monitoring on the SetTopicAttributes API event so unexpected modifications surface in real time.

***

### CTL.SNS.POLICY.SPRAWL.001[​](#ctlsnspolicysprawl001 "Direct link to CTL.SNS.POLICY.SPRAWL.001")
...
### CTL.SNS.SIGNATURE.SHA1.001[​](#ctlsnssignaturesha1001 "Direct link to CTL.SNS.SIGNATURE.SHA1.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: SC-13; pci\_dss\_v4.0: 4.2; soc2: CC6.1;
...
**Remediation:** Set the topic's SignatureVersion attribute to 2 (SHA256): aws sns set-topic-attributes --topic-arn --attribute-name SignatureVersion --attribute-value 2. Verify that all subscribers that check message signatures support SHA256 verification before switching.

***

### CTL.SNS.SUBSCRIPTION.HTTP.001[​](#ctlsnssubscriptionhttp001 "Direct link to CTL.SNS.SUBSCRIPTION.HTTP.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 1.20; fedramp\_moderate: SC-8; hipaa: 164.312(e)(1); iso\_27001\_2022: A.8.20; nist\_800\_53\_r5: SC-8, SC-13; pci\_dss\_v4.0: 4.1, 4.2; soc2: CC6.1, CC6.7;
...
### CTL.SNS.SUBSCRIPTION.NODLQ.001[​](#ctlsnssubscriptionnodlq001 "Direct link to CTL.SNS.SUBSCRIPTION.NODLQ.001")
