...
### CTL.SSM.DOCUMENT.PUBLIC.001[​](#ctlssmdocumentpublic001 "Direct link to CTL.SSM.DOCUMENT.PUBLIC.001")
...
### CTL.SSM.DOCUMENT.SECRETS.001[​](#ctlssmdocumentsecrets001 "Direct link to CTL.SSM.DOCUMENT.SECRETS.001")
...
### CTL.SSM.INVENTORY.RESTRICT.001[​](#ctlssminventoryrestrict001 "Direct link to CTL.SSM.INVENTORY.RESTRICT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** mitre\_attack: T1592; nist\_800\_53\_r5: AC-3;
...
### CTL.SSM.OPSCENTER.001[​](#ctlssmopscenter001 "Direct link to CTL.SSM.OPSCENTER.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** nist\_800\_53\_r5: IR-5; scs\_c02: 12.7; soc2: CC7.3;
...
### CTL.SSM.PARAMETER.COLLECT.001[​](#ctlssmparametercollect001 "Direct link to CTL.SSM.PARAMETER.COLLECT.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** mitre\_attack: T1552; nist\_800\_53\_r5: AC-6;
...
### CTL.SSM.PATCH.BASELINE.001[​](#ctlssmpatchbaseline001 "Direct link to CTL.SSM.PATCH.BASELINE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: SI-2; scs\_c02: 8.1; soc2: CC7.1;
...
### CTL.SSM.PATCH.COMPLIANCE.001[​](#ctlssmpatchcompliance001 "Direct link to CTL.SSM.PATCH.COMPLIANCE.001")
...
### CTL.SSM.PATCH.WINDOW\.001[​](#ctlssmpatchwindow001 "Direct link to CTL.SSM.PATCH.WINDOW.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: SI-2; soc2: CC8.1;
...
### CTL.SSM.RUNCOMMAND.APPROVE.001[​](#ctlssmruncommandapprove001 "Direct link to CTL.SSM.RUNCOMMAND.APPROVE.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** mitre\_attack: T1059.004; nist\_800\_53\_r5: CM-3;
...
### CTL.SSM.RUNCOMMAND.RESTRICT.001[​](#ctlssmruncommandrestrict001 "Direct link to CTL.SSM.RUNCOMMAND.RESTRICT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 2.2.1; mitre\_attack: T1059.009; nist\_800\_53\_r5: AC-6;
...
### CTL.SSM.SECURETYPE.001[​](#ctlssmsecuretype001 "Direct link to CTL.SSM.SECURETYPE.001")
...
**Remediation:** Create a new SecureString parameter with the same value and update all references. SSM does not support changing parameter type in place — you must create a new parameter. Use aws ssm put-parameter --name --type SecureString --value --overwrite.

***

### CTL.SSM.SESSION.ENCRYPT.001[​](#ctlssmsessionencrypt001 "Direct link to CTL.SSM.SESSION.ENCRYPT.001")
...
### CTL.SSM.SESSION.LOGGING.001[​](#ctlssmsessionlogging001 "Direct link to CTL.SSM.SESSION.LOGGING.001")
