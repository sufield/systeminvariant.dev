...
### CTL.WAF.CLASSIC.DEPRECATED.001[​](#ctlwafclassicdeprecated001 "Direct link to CTL.WAF.CLASSIC.DEPRECATED.001")
...
### CTL.WAF.EVASION.OBSERVE.001[​](#ctlwafevasionobserve001 "Direct link to CTL.WAF.EVASION.OBSERVE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-4; hipaa: 164.312(b); nist\_800\_53\_r5: SI-4; pci\_dss\_v4.0: 10.2.1; soc2: CC7.1;
...
### CTL.WAF.INCOMPLETE.001[​](#ctlwafincomplete001 "Direct link to CTL.WAF.INCOMPLETE.001")
...
WAF assessment data is incomplete. The extractor must populate waf.rules.has\_managed\_rules to evaluate protection controls.

**Remediation:** Re-run the extractor with WAF permissions: wafv2:GetWebACL, wafv2:ListWebACLs, wafv2:GetLoggingConfiguration.

***

### CTL.WAF.IPSET.EMPTY.001[​](#ctlwafipsetempty001 "Direct link to CTL.WAF.IPSET.EMPTY.001")
...
### CTL.WAF.LOGGING.001[​](#ctlwaflogging001 "Direct link to CTL.WAF.LOGGING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AU-2; nist\_800\_53\_r5: AU-2; soc2: CC7.1;
...
### CTL.WAF.LOGGING.OVERREDACTED.001[​](#ctlwafloggingoverredacted001 "Direct link to CTL.WAF.LOGGING.OVERREDACTED.001")
...
### CTL.WAF.MANAGEDRULE.IPREP.MISSING.001[​](#ctlwafmanagedruleiprepmissing001 "Direct link to CTL.WAF.MANAGEDRULE.IPREP.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-3; nist\_800\_53\_r5: SI-3; pci\_dss\_v4.0: 6.4.1; soc2: CC6.6;
...
### CTL.WAF.METRICS.DISABLED.001[​](#ctlwafmetricsdisabled001 "Direct link to CTL.WAF.METRICS.DISABLED.001")
...
### CTL.WAF.ORIGIN.LOCKDOWN.001[​](#ctlwaforiginlockdown001 "Direct link to CTL.WAF.ORIGIN.LOCKDOWN.001")
...
### CTL.WAF.PARSERLIMIT.PROTECT.001[​](#ctlwafparserlimitprotect001 "Direct link to CTL.WAF.PARSERLIMIT.PROTECT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-10; hipaa: 164.312(e)(1); nist\_800\_53\_r5: SI-10; pci\_dss\_v4.0: 6.4.1; soc2: CC6.6;
...
### CTL.WAF.RATELIMIT.MISSING.001[​](#ctlwafratelimitmissing001 "Direct link to CTL.WAF.RATELIMIT.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SC-5; nist\_800\_53\_r5: SC-5; pci\_dss\_v4.0: 6.4.1; soc2: CC6.6;
...
### CTL.WAF.RULEGROUP.NOMETRICS.001[​](#ctlwafrulegroupnometrics001 "Direct link to CTL.WAF.RULEGROUP.NOMETRICS.001")
...
### CTL.WAF.RULES.001[​](#ctlwafrules001 "Direct link to CTL.WAF.RULES.001")
...
### CTL.WAF.RULES.BLOCKMODE.001[​](#ctlwafrulesblockmode001 "Direct link to CTL.WAF.RULES.BLOCKMODE.001")
...
### CTL.WAF.RULES.OWASP.001[​](#ctlwafrulesowasp001 "Direct link to CTL.WAF.RULES.OWASP.001")
...
### CTL.WAF.WEBACL.DEFAULTALLOW\.001[​](#ctlwafwebacldefaultallow001 "Direct link to CTL.WAF.WEBACL.DEFAULTALLOW.001")
...
### CTL.WAF.WEBACL.NORULES.001[​](#ctlwafwebaclnorules001 "Direct link to CTL.WAF.WEBACL.NORULES.001")
