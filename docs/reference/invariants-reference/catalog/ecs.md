...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SI-4; nist\_800\_53\_r5: SI-4; pci\_dss\_v4.0: 10.7.2; soc2: CC7.2;
...
**Remediation:** Create a CloudWatch alarm on the AWS/ECS namespace metric RunningTaskCount with dimensions ClusterName=, ServiceName=. Threshold typically Less Than DesiredCount; route the alarm to the service's on-call SNS topic. For services with auto-scaling, also alarm on RunningTaskCount falling below the configured minCapacity to catch policy failures rather than legitimate scale-in events.

***

### CTL.ECS.CLUSTER.DOCKERSOCKET.001[​](#ctlecsclusterdockersocket001 "Direct link to CTL.ECS.CLUSTER.DOCKERSOCKET.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-3; hipaa: 164.312(a)(1); nist\_800\_53\_r5: AC-3; pci\_dss\_v4.0: 2.2.5; soc2: CC6.6;
...
**Remediation:** Configure the ECS agent to refuse Docker socket mounts: add the path /var/run/docker.sock to the agent's DOCKER\_VOLUME\_PATH\_DENYLIST (or equivalent instance-level configuration). For workloads that genuinely need Docker API access (CI runners, build agents), move them to a dedicated cluster whose purpose is documented and whose access is restricted, rather than allowing the mount on the general-purpose cluster.

***

### CTL.ECS.CONTAINER.SECCOMP.UNCONFINED.001[​](#ctlecscontainerseccompunconfined001 "Direct link to CTL.ECS.CONTAINER.SECCOMP.UNCONFINED.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** cis\_aws\_v3.0: 7.27; nist\_800\_53\_r5: CM-7; pci\_dss\_v4.0: 2.2.1; soc2: CC6.6;
...
### CTL.ECS.ESCALATION.CHAIN.001[​](#ctlecsescalationchain001 "Direct link to CTL.ECS.ESCALATION.CHAIN.001")
...
### CTL.ECS.EXEC.001[​](#ctlecsexec001 "Direct link to CTL.ECS.EXEC.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: AC-17; hipaa: 164.312(a)(1); mitre\_attack: T1059; nist\_800\_53\_r5: AC-17; pci\_dss\_v4.0: 7.2.1; soc2: CC6.1;
...
**Remediation:** Disable ECS Exec on production services: aws ecs update-service --cluster --service --no-enable-execute-command --force-new-deployment. Restrict ecs:ExecuteCommand via IAM policy to break-glass roles with MFA enforcement; audit usage with CTL.ECS.EXEC.AUDIT.001.

***

### CTL.ECS.EXEC.AUDIT.001[​](#ctlecsexecaudit001 "Direct link to CTL.ECS.EXEC.AUDIT.001")
...
### CTL.ECS.FARGATE.VERSION.001[​](#ctlecsfargateversion001 "Direct link to CTL.ECS.FARGATE.VERSION.001")
...
### CTL.ECS.GHOST.EXECROLE.001[​](#ctlecsghostexecrole001 "Direct link to CTL.ECS.GHOST.EXECROLE.001")
...
### CTL.ECS.GHOST.SSMPARAMETER.001[​](#ctlecsghostssmparameter001 "Direct link to CTL.ECS.GHOST.SSMPARAMETER.001")
...
### CTL.ECS.GHOST.SUBNET.001[​](#ctlecsghostsubnet001 "Direct link to CTL.ECS.GHOST.SUBNET.001")
...
### CTL.ECS.GHOST.TASKROLE.001[​](#ctlecsghosttaskrole001 "Direct link to CTL.ECS.GHOST.TASKROLE.001")
...
### CTL.ECS.IMAGE.001[​](#ctlecsimage001 "Direct link to CTL.ECS.IMAGE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: SI-7; nist\_800\_53\_r5: SI-7; pci\_dss\_v4.0: 6.3.2; soc2: CC8.1;
...
### CTL.ECS.IMAGE.DIGEST.001[​](#ctlecsimagedigest001 "Direct link to CTL.ECS.IMAGE.DIGEST.001")
...
### CTL.ECS.IMAGE.GHOST.001[​](#ctlecsimageghost001 "Direct link to CTL.ECS.IMAGE.GHOST.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: SI-7; pci\_dss\_v4.0: 6.3.2; soc2: CC6.1;
...
### CTL.ECS.IMAGE.UNTRUSTED.001[​](#ctlecsimageuntrusted001 "Direct link to CTL.ECS.IMAGE.UNTRUSTED.001")
...
### CTL.ECS.IMDS.INSTANCEROLE.001[​](#ctlecsimdsinstancerole001 "Direct link to CTL.ECS.IMDS.INSTANCEROLE.001")
...
### CTL.ECS.INCOMPLETE.001[​](#ctlecsincomplete001 "Direct link to CTL.ECS.INCOMPLETE.001")
...
### CTL.ECS.LOG.001[​](#ctlecslog001 "Direct link to CTL.ECS.LOG.001")
...
### CTL.ECS.LOG.ENCRYPT.001[​](#ctlecslogencrypt001 "Direct link to CTL.ECS.LOG.ENCRYPT.001")
...
**Remediation:** Associate a customer-managed KMS key with the log group via aws logs associate-kms-key. Update the KMS key policy to grant logs..amazonaws.com use of the key on behalf of the account. The log group must be re-associated for new log events; existing events remain under the previous encryption.

***

### CTL.ECS.LOG.RETENTION.001[​](#ctlecslogretention001 "Direct link to CTL.ECS.LOG.RETENTION.001")
...
### CTL.ECS.LOG.SIDECAR.001[​](#ctlecslogsidecar001 "Direct link to CTL.ECS.LOG.SIDECAR.001")
...
### CTL.ECS.METADATA.CREDENTIAL.001[​](#ctlecsmetadatacredential001 "Direct link to CTL.ECS.METADATA.CREDENTIAL.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-6(5); hipaa: 164.312(a)(1); nist\_800\_53\_r5: AC-6(5); pci\_dss\_v4.0: 7.2.1; soc2: CC6.1;
...
### CTL.ECS.MONITORING.INSIGHTS.001[​](#ctlecsmonitoringinsights001 "Direct link to CTL.ECS.MONITORING.INSIGHTS.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SI-4; nist\_800\_53\_r5: SI-4; pci\_dss\_v4.0: 10.7.1; soc2: CC7.2;
...
**Remediation:** Enable Container Insights on the cluster: aws ecs put-account-setting --name containerInsights --value enabled (account-level default), or aws ecs update-cluster-settings --cluster --settings name=containerInsights,value=enabled (per-cluster). Container Insights publishes to the /aws/ecs/containerinsights/ log group; verify metrics arrive in CloudWatch within a few minutes of enabling.

***

### CTL.ECS.NETWORK.001[​](#ctlecsnetwork001 "Direct link to CTL.ECS.NETWORK.001")
...
### CTL.ECS.NETWORK.PUBLIC.001[​](#ctlecsnetworkpublic001 "Direct link to CTL.ECS.NETWORK.PUBLIC.001")
...
### CTL.ECS.PRIV.001[​](#ctlecspriv001 "Direct link to CTL.ECS.PRIV.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: CM-7; hipaa: 164.312(a)(1); nist\_800\_53\_r5: CM-7; pci\_dss\_v4.0: 2.2.1; soc2: CC6.6;
...
### CTL.ECS.ROOT.001[​](#ctlecsroot001 "Direct link to CTL.ECS.ROOT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: CM-7; nist\_800\_53\_r5: CM-7; pci\_dss\_v4.0: 2.2.1; soc2: CC6.6;
...
### CTL.ECS.SECRET.GHOST.001[​](#ctlecssecretghost001 "Direct link to CTL.ECS.SECRET.GHOST.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** hipaa: 164.312(d); nist\_800\_53\_r5: IA-5; soc2: CC6.1;
...
### CTL.ECS.SECRETS.001[​](#ctlecssecrets001 "Direct link to CTL.ECS.SECRETS.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: IA-5; hipaa: 164.312(a)(2)(iv); nist\_800\_53\_r5: IA-5; pci\_dss\_v4.0: 3.4.1; soc2: CC6.1;
...
### CTL.ECS.SECURITY.CAPABILITIES.001[​](#ctlecssecuritycapabilities001 "Direct link to CTL.ECS.SECURITY.CAPABILITIES.001")
...
ECS task definitions must not add dangerous Linux capabilities (SYS\_ADMIN, NET\_ADMIN, SYS\_PTRACE, SYS\_RAWIO, DAC\_OVERRIDE, NET\_RAW) and should drop all unnecessary capabilities. Dangerous capabilities grant kernel-level access enabling container escape.
...
### CTL.ECS.SECURITY.ROOTFS.MOUNT.BYPASS.001[​](#ctlecssecurityrootfsmountbypass001 "Direct link to CTL.ECS.SECURITY.ROOTFS.MOUNT.BYPASS.001")
...
### CTL.ECS.SERVICE.CIRCUITBREAKER.001[​](#ctlecsservicecircuitbreaker001 "Direct link to CTL.ECS.SERVICE.CIRCUITBREAKER.001")
...
### CTL.ECS.SERVICE.CIRCUITBREAKER.NOROLLBACK.001[​](#ctlecsservicecircuitbreakernorollback001 "Direct link to CTL.ECS.SERVICE.CIRCUITBREAKER.NOROLLBACK.001")
...
### CTL.ECS.SERVICE.MINHEALTHY.001[​](#ctlecsserviceminhealthy001 "Direct link to CTL.ECS.SERVICE.MINHEALTHY.001")
...
### CTL.ECS.SERVICE.NETWORKMODE.BRIDGE.001[​](#ctlecsservicenetworkmodebridge001 "Direct link to CTL.ECS.SERVICE.NETWORKMODE.BRIDGE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: AC-4; nist\_800\_53\_r5: AC-4; pci\_dss\_v4.0: 1.4.2; soc2: CC6.6;
...
### CTL.ECS.SERVICE.SCALING.MINZERO.001[​](#ctlecsservicescalingminzero001 "Direct link to CTL.ECS.SERVICE.SCALING.MINZERO.001")
...
### CTL.ECS.SERVICE.SCALING.MISSING.001[​](#ctlecsservicescalingmissing001 "Direct link to CTL.ECS.SERVICE.SCALING.MISSING.001")
...
### CTL.ECS.SERVICE.SG.LBONLY.001[​](#ctlecsservicesglbonly001 "Direct link to CTL.ECS.SERVICE.SG.LBONLY.001")
...
### CTL.ECS.TASK.NOEXEC.001[​](#ctlecstasknoexec001 "Direct link to CTL.ECS.TASK.NOEXEC.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** mitre\_attack: T1610; nist\_800\_53\_r5: AC-6;
...
### CTL.ECS.TASKDEF.HEALTHCHECK.MISSING.001[​](#ctlecstaskdefhealthcheckmissing001 "Direct link to CTL.ECS.TASKDEF.HEALTHCHECK.MISSING.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** fedramp\_moderate: SI-4; nist\_800\_53\_r5: SI-4; soc2: A1.1;
...
### CTL.ECS.TASKDEF.HOSTMOUNT.001[​](#ctlecstaskdefhostmount001 "Direct link to CTL.ECS.TASKDEF.HOSTMOUNT.001")
...
### CTL.ECS.TASKDEF.LOG.GHOST.001[​](#ctlecstaskdeflogghost001 "Direct link to CTL.ECS.TASKDEF.LOG.GHOST.001")
...
### CTL.ECS.TASKDEF.NOMEMLIMIT.001[​](#ctlecstaskdefnomemlimit001 "Direct link to CTL.ECS.TASKDEF.NOMEMLIMIT.001")
...
### CTL.ECS.TASKDEF.READONLY.001[​](#ctlecstaskdefreadonly001 "Direct link to CTL.ECS.TASKDEF.READONLY.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: CM-7; nist\_800\_53\_r5: CM-7; pci\_dss\_v4.0: 2.2.5; soc2: CC6.6;
...
### CTL.ECS.TASKDEF.REVISION.STALE.SECRETS.001[​](#ctlecstaskdefrevisionstalesecrets001 "Direct link to CTL.ECS.TASKDEF.REVISION.STALE.SECRETS.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** fedramp\_moderate: IA-5; hipaa: 164.312(d); nist\_800\_53\_r5: IA-5; pci\_dss\_v4.0: 8.3.1; soc2: CC6.1;
...
### CTL.ECS.TASKDEF.SECRET.BROKEN.REF.001[​](#ctlecstaskdefsecretbrokenref001 "Direct link to CTL.ECS.TASKDEF.SECRET.BROKEN.REF.001")
...
### CTL.ECS.TASKDEF.SSM.INSECURE.001[​](#ctlecstaskdefssminsecure001 "Direct link to CTL.ECS.TASKDEF.SSM.INSECURE.001")
...
### CTL.ECS.TASKMETADATA.001[​](#ctlecstaskmetadata001 "Direct link to CTL.ECS.TASKMETADATA.001")
...
### CTL.ECS.TASKMETADATA.002[​](#ctlecstaskmetadata002 "Direct link to CTL.ECS.TASKMETADATA.002")
...
### CTL.ECS.TASKROLE.SHARED.001[​](#ctlecstaskroleshared001 "Direct link to CTL.ECS.TASKROLE.SHARED.001")
