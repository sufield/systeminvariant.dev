...
### CTL.BEDROCK.ACCESS.ADMIN.001[​](#ctlbedrockaccessadmin001 "Direct link to CTL.BEDROCK.ACCESS.ADMIN.001")
...
### CTL.BEDROCK.ACCESS.FULLACCESS.001[​](#ctlbedrockaccessfullaccess001 "Direct link to CTL.BEDROCK.ACCESS.FULLACCESS.001")
...
### CTL.BEDROCK.ACCESS.LONGTERM.001[​](#ctlbedrockaccesslongterm001 "Direct link to CTL.BEDROCK.ACCESS.LONGTERM.001")
...
### CTL.BEDROCK.ACCESS.MODELSCOPE.001[​](#ctlbedrockaccessmodelscope001 "Direct link to CTL.BEDROCK.ACCESS.MODELSCOPE.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** nist\_800\_53\_r5: AC-6, CM-7; soc2: CC6.1;
...
### CTL.BEDROCK.ACCESS.POLICY.INVERTED.001[​](#ctlbedrockaccesspolicyinverted001 "Direct link to CTL.BEDROCK.ACCESS.POLICY.INVERTED.001")
...
### CTL.BEDROCK.AGENT.ACTIONGROUPS.SPRAWL.001[​](#ctlbedrockagentactiongroupssprawl001 "Direct link to CTL.BEDROCK.AGENT.ACTIONGROUPS.SPRAWL.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** nist\_800\_53\_r5: AC-6, CM-2; owasp\_nhi: NHI5; soc2: CC6.1, CC8.1;
...
### CTL.BEDROCK.AGENT.CROSSACCOUNT.001[​](#ctlbedrockagentcrossaccount001 "Direct link to CTL.BEDROCK.AGENT.CROSSACCOUNT.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** nist\_800\_53\_r5: AC-3, AC-6; owasp\_nhi: NHI4; soc2: CC6.1;
...
### CTL.BEDROCK.AGENT.GHOST.LAMBDA.001[​](#ctlbedrockagentghostlambda001 "Direct link to CTL.BEDROCK.AGENT.GHOST.LAMBDA.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** nist\_800\_53\_r5: CM-2, CM-8; owasp\_nhi: NHI1; soc2: CC8.1;
...
### CTL.BEDROCK.AGENT.GUARDRAIL.001[​](#ctlbedrockagentguardrail001 "Direct link to CTL.BEDROCK.AGENT.GUARDRAIL.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: SI-10; soc2: CC6.1;
...
### CTL.BEDROCK.AGENT.LOGGING.001[​](#ctlbedrockagentlogging001 "Direct link to CTL.BEDROCK.AGENT.LOGGING.001")
...
* **Type:** unsafe\_state
* **Domain:** audit
* **Compliance:** hipaa: 164.312(b); nist\_800\_53\_r5: AU-2, AU-12; owasp\_nhi: NHI8; soc2: CC7.2;
...
### CTL.BEDROCK.AGENT.OVERPERM.LAMBDA.001[​](#ctlbedrockagentoverpermlambda001 "Direct link to CTL.BEDROCK.AGENT.OVERPERM.LAMBDA.001")
...
### CTL.BEDROCK.AGENT.OVERPERM.MODEL.001[​](#ctlbedrockagentoverpermmodel001 "Direct link to CTL.BEDROCK.AGENT.OVERPERM.MODEL.001")
...
### CTL.BEDROCK.AGENT.OVERPERM.S3.001[​](#ctlbedrockagentoverperms3001 "Direct link to CTL.BEDROCK.AGENT.OVERPERM.S3.001")
...
### CTL.BEDROCK.AGENT.PUBLIC.INVOCATION.001[​](#ctlbedrockagentpublicinvocation001 "Direct link to CTL.BEDROCK.AGENT.PUBLIC.INVOCATION.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** hipaa: 164.312(a)(1); nist\_800\_53\_r5: AC-3, SC-7; owasp\_nhi: NHI6; soc2: CC6.6;

Bedrock agent's invocation surface is reachable without authenticated AWS principals — for example, an API Gateway fronting InvokeAgent with no authorizer, a public Lambda URL proxying agent invocation, or a CloudFront distribution that forwards directly to the agent without auth. The agent's blast radius is whatever the agent's execution role can reach (knowledge-base contents, Lambda action groups, invoked models). Letting unauthenticated callers reach InvokeAgent turns the agent's internal data and tool surface into an internet-accessible API. The collector pre-computes the boolean from the agent's downstream invocation paths (API Gateway authorizers, Lambda URL auth\_type, public CloudFront distributions pointing at the agent endpoint).

**Remediation:** Front the agent invocation with an authenticated path: either an API Gateway authorizer (Cognito user pool, custom Lambda authorizer, or IAM auth), a Lambda URL with auth\_type=AWS\_IAM, or a private VPC integration. Remove any public Lambda URL or unrestricted API Gateway resource that proxies InvokeAgent.

***

### CTL.BEDROCK.AGENT.SESSION.TTL.001[​](#ctlbedrockagentsessionttl001 "Direct link to CTL.BEDROCK.AGENT.SESSION.TTL.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** hipaa: 164.312(a)(2)(iii); nist\_800\_53\_r5: AC-12; owasp\_nhi: NHI7; soc2: CC6.1;
...
### CTL.BEDROCK.AGENT.SHADOW\.001[​](#ctlbedrockagentshadow001 "Direct link to CTL.BEDROCK.AGENT.SHADOW.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** nist\_800\_53\_r5: CM-2, CM-3, AC-3; owasp\_nhi: NHI1, NHI6; soc2: CC8.1;

Bedrock agent has no infrastructure-as-code management tag (managed\_by, terraform, cloudformation, or equivalent). Agents created outside the IaC pipeline are not subject to code review, approval workflows, or drift detection — their permissions may exceed what the security team has approved, and there is no audit trail tying the agent's existence to a reviewed commit. Shadow agents are the canonical AI-surface ungoverned-configuration failure mode: production agents appear through console clicks or scripted CLI calls without going through change-management. The collector pre-computes the managed\_by\_iac boolean by inspecting the agent's tags against the organisation's IaC tagging convention.

**Remediation:** Either (1) import the agent into your IaC pipeline via terraform import or aws cloudformation import, then tag it with managed\_by=terraform / managed\_by=cloudformation, or (2) delete the agent if it was created for ad-hoc testing and is no longer in active use. Reject any future untagged agents at the SCP / Service Control Policy level with a Deny statement on bedrock:CreateAgent missing the required tag.

***

### CTL.BEDROCK.AGENT.STALE.001[​](#ctlbedrockagentstale001 "Direct link to CTL.BEDROCK.AGENT.STALE.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** nist\_800\_53\_r5: AC-2(3); owasp\_nhi: NHI1; soc2: CC6.1;
...
**Remediation:** Either delete the agent + its execution role if the workload is truly abandoned, or document the agent's expected idle duration with a reviewed\_at tag and a scheduled review date. Reduce blast radius by detaching high-privilege managed policies from the role even while the agent stays.

***

### CTL.BEDROCK.AGENT.TOOLACCESS.BROAD.001[​](#ctlbedrockagenttoolaccessbroad001 "Direct link to CTL.BEDROCK.AGENT.TOOLACCESS.BROAD.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** nist\_800\_53\_r5: AC-6; owasp\_llm: LLM08; scs\_c02: 13.1; soc2: CC6.1;
...
### CTL.BEDROCK.AGENTCORE.CRED.001[​](#ctlbedrockagentcorecred001 "Direct link to CTL.BEDROCK.AGENTCORE.CRED.001")
...
### CTL.BEDROCK.AGENTCORE.GW\.DEBUG.001[​](#ctlbedrockagentcoregwdebug001 "Direct link to CTL.BEDROCK.AGENTCORE.GW.DEBUG.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: SI-11; owasp\_nhi: NHI9; soc2: CC7.2;
...
### CTL.BEDROCK.AGENTCORE.GW\.EGRESS.001[​](#ctlbedrockagentcoregwegress001 "Direct link to CTL.BEDROCK.AGENTCORE.GW.EGRESS.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** hipaa: 164.312(e)(1); nist\_800\_53\_r5: SC-7, SC-8; soc2: CC6.6;
...
### CTL.BEDROCK.AGENTCORE.GW\.ENCRYPT.001[​](#ctlbedrockagentcoregwencrypt001 "Direct link to CTL.BEDROCK.AGENTCORE.GW.ENCRYPT.001")
...
* **Type:** unsafe\_state
* **Domain:** encryption
* **Compliance:** hipaa: 164.312(a)(2)(iv); nist\_800\_53\_r5: SC-12, SC-28; soc2: CC6.1;
...
### CTL.BEDROCK.AGENTCORE.GW\.WAF.001[​](#ctlbedrockagentcoregwwaf001 "Direct link to CTL.BEDROCK.AGENTCORE.GW.WAF.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: SC-7(5); soc2: CC6.6;
...
### CTL.BEDROCK.AGENTCORE.IMDS.001[​](#ctlbedrockagentcoreimds001 "Direct link to CTL.BEDROCK.AGENTCORE.IMDS.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** hipaa: 164.312(a)(1); nist\_800\_53\_r5: AC-3, SC-23; owasp\_nhi: NHI5; soc2: CC6.1;
...
### CTL.BEDROCK.AGENTCORE.LOGGING.001[​](#ctlbedrockagentcorelogging001 "Direct link to CTL.BEDROCK.AGENTCORE.LOGGING.001")
...
### CTL.BEDROCK.AGENTCORE.MEM.ENCRYPT.001[​](#ctlbedrockagentcorememencrypt001 "Direct link to CTL.BEDROCK.AGENTCORE.MEM.ENCRYPT.001")
...
### CTL.BEDROCK.AGENTCORE.NOAUTH.001[​](#ctlbedrockagentcorenoauth001 "Direct link to CTL.BEDROCK.AGENTCORE.NOAUTH.001")
...
* **Type:** unsafe\_state
* **Domain:** identity
* **Compliance:** hipaa: 164.312(d); nist\_800\_53\_r5: AC-3, IA-2; owasp\_nhi: NHI4; soc2: CC6.1;

AgentCore gateway authorizer type is set to NONE — the gateway endpoint accepts unauthenticated requests. Any caller with network access to the gateway can invoke the agent, triggering model inference, tool execution, and memory access without identity attribution. AgentCore supports CUSTOM\_JWT, AWS\_IAM, and AUTHENTICATE\_ONLY authorizer types; NONE should never be used outside development.

**Remediation:** Set the gateway authorizer type to AWS\_IAM (recommended) or configure a JWT authorizer with a trusted identity provider. NONE authorizer is appropriate only for internal development endpoints isolated within a private VPC.

***

### CTL.BEDROCK.AGENTCORE.OVERPERM.001[​](#ctlbedrockagentcoreoverperm001 "Direct link to CTL.BEDROCK.AGENTCORE.OVERPERM.001")
...
### CTL.BEDROCK.AGENTCORE.SESSION.001[​](#ctlbedrockagentcoresession001 "Direct link to CTL.BEDROCK.AGENTCORE.SESSION.001")
...
### CTL.BEDROCK.AGENTCORE.STALE.001[​](#ctlbedrockagentcorestale001 "Direct link to CTL.BEDROCK.AGENTCORE.STALE.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** hipaa: 164.312(e)(1); nist\_800\_53\_r5: SC-7, AC-4; soc2: CC6.6;
...
### CTL.BEDROCK.CUSTOMMODEL.ENCRYPT.001[​](#ctlbedrockcustommodelencrypt001 "Direct link to CTL.BEDROCK.CUSTOMMODEL.ENCRYPT.001")
...
* **Type:** unsafe\_state
* **Domain:** encryption
* **Compliance:** hipaa: 164.312(a)(2)(iv); nist\_800\_53\_r5: SC-28; soc2: CC6.7;
...
### CTL.BEDROCK.GHOST.KNOWLEDGEBASE.001[​](#ctlbedrockghostknowledgebase001 "Direct link to CTL.BEDROCK.GHOST.KNOWLEDGEBASE.001")
...
### CTL.BEDROCK.GUARDRAIL.CONTENT.001[​](#ctlbedrockguardrailcontent001 "Direct link to CTL.BEDROCK.GUARDRAIL.CONTENT.001")
...
### CTL.BEDROCK.GUARDRAIL.PII.001[​](#ctlbedrockguardrailpii001 "Direct link to CTL.BEDROCK.GUARDRAIL.PII.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** hipaa: 164.312(a)(1); nist\_800\_53\_r5: SI-10; soc2: CC6.1;
...
### CTL.BEDROCK.GUARDRAIL.PROMPTATTACK.001[​](#ctlbedrockguardrailpromptattack001 "Direct link to CTL.BEDROCK.GUARDRAIL.PROMPTATTACK.001")
...
### CTL.BEDROCK.GUARDRAIL.TOPIC.001[​](#ctlbedrockguardrailtopic001 "Direct link to CTL.BEDROCK.GUARDRAIL.TOPIC.001")
...
### CTL.BEDROCK.KB.DATASOURCE.CROSSACCOUNT.001[​](#ctlbedrockkbdatasourcecrossaccount001 "Direct link to CTL.BEDROCK.KB.DATASOURCE.CROSSACCOUNT.001")
...
* **Type:** unsafe\_state
* **Domain:** governance
* **Compliance:** hipaa: 164.312(e)(1); nist\_800\_53\_r5: AC-4, AC-6; owasp\_nhi: NHI3, NHI6; soc2: CC6.1, CC6.6;
...
### CTL.BEDROCK.KB.DATASOURCE.UNENCRYPTED.001[​](#ctlbedrockkbdatasourceunencrypted001 "Direct link to CTL.BEDROCK.KB.DATASOURCE.UNENCRYPTED.001")
...
### CTL.BEDROCK.KB.MARKER.INDEXES.001[​](#ctlbedrockkbmarkerindexes001 "Direct link to CTL.BEDROCK.KB.MARKER.INDEXES.001")
...
Fact-recording marker for Bedrock knowledge bases that index a specific S3 bucket. Emits an informational finding (NOT a violation) on every knowledge base whose data source carries a bucket ARN — so cross-resource chains can compose this fact with data-classification markers on the target bucket. Same pattern as CTL.S3.MARKER.PHI.001 + CTL.COGNITO.IDPOOL.UNAUTH.S3 / cognito\_unauth\_phi\_s3 chain: a knowledge base indexing a bucket is the desired state — never a finding to triage. The marker exists so the chain engine can join "knowledge base side: indexes bucket X" with "storage side: bucket X is classified PHI" via scope\_field on the shared bucket ARN.
...
### CTL.BEDROCK.KB.OVERPERM.S3.001[​](#ctlbedrockkboverperms3001 "Direct link to CTL.BEDROCK.KB.OVERPERM.S3.001")
...
### CTL.BEDROCK.KB.RETRIEVAL.OVERBROAD.001[​](#ctlbedrockkbretrievaloverbroad001 "Direct link to CTL.BEDROCK.KB.RETRIEVAL.OVERBROAD.001")
...
### CTL.BEDROCK.KB.RETRIEVAL.SCOPE.001[​](#ctlbedrockkbretrievalscope001 "Direct link to CTL.BEDROCK.KB.RETRIEVAL.SCOPE.001")
...
A Bedrock Knowledge Base declares its data sources (specific S3 prefixes, OpenSearch collections). The retrieval role must not be able to reach data outside that declared set — not through a wildcard S3 prefix that happens to match other buckets, not through an AssumeRole hop to a role with broader access, and not through a resource-based policy on some other bucket that grants the retrieval role. Any such path lets the retrieval connector pull data the Knowledge Base was never scoped to serve. This is a compound (graph-reachability) control over a resource type that bridges IAM to data stores. The reasoning layer parses the KB's declared dataSourceConfiguration, resolves what the retrieval role can actually reach (IAM policies with wildcard expansion + assume chains + resource-based policies), and emits ai.knowledge\_base.retrieval\_exceeds\_declared\_scope when the reachable set is not contained in the declared set. The reasoning spec — Soufflé reachability plus a Z3 cross-check, including wildcard-prefix and resource-policy edges — lives at examples/rag-retrieval-scope/.
...
### CTL.BEDROCK.LOG.CONTENT.001[​](#ctlbedrocklogcontent001 "Direct link to CTL.BEDROCK.LOG.CONTENT.001")
...
* **Type:** unsafe\_state
* **Domain:** exposure
* **Compliance:** nist\_800\_53\_r5: AU-3; owasp\_llm: LLM02; scs\_c02: 13.2; soc2: CC7.1;
...
### CTL.BEDROCK.LOG.ENCRYPT.001[​](#ctlbedrocklogencrypt001 "Direct link to CTL.BEDROCK.LOG.ENCRYPT.001")
...
### CTL.BEDROCK.LOG.INVOCATION.001[​](#ctlbedrockloginvocation001 "Direct link to CTL.BEDROCK.LOG.INVOCATION.001")
...
### CTL.BEDROCK.VPC.ENDPOINTS.001[​](#ctlbedrockvpcendpoints001 "Direct link to CTL.BEDROCK.VPC.ENDPOINTS.001")
