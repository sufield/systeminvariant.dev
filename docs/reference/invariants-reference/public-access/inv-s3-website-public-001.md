...
**ID:** `CTL.S3.WEBSITE.PUBLIC.001` **Category:** Public Access **Severity:** High
...
* [`CTL.S3.PUBLIC.001`](/docs/reference/invariants-reference/public-access/inv-s3-public-001.md) -- General check for public read access; this control adds the website-hosting dimension.
* [`CTL.S3.PUBLIC.005`](/docs/reference/invariants-reference/public-access/inv-s3-public-005.md) -- Detects latent public read exposure, which is especially dangerous for website-hosting buckets.
* [`CTL.S3.CONTROLS.001`](/docs/reference/invariants-reference/public-access/inv-s3-controls-001.md) -- Ensures Public Access Block is enabled as defense-in-depth for website-hosting buckets.
