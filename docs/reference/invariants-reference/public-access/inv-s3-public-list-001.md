...
**ID:** `CTL.S3.PUBLIC.LIST.001` **Category:** Public Access **Severity:** High

## What This Checks[​](#what-this-checks "Direct link to What This Checks")

S3 buckets must not allow anonymous listing of objects. This control fires when `public_list` is `true`, meaning anyone on the internet can enumerate all object keys in the bucket.
...
* [`CTL.S3.PUBLIC.LIST.002`](/docs/reference/invariants-reference/public-access/inv-s3-public-list-002.md) -- Allows public listing only when explicitly tagged as intended, for buckets that serve public content by design.
...
* [`CTL.S3.PUBLIC.001`](/docs/reference/invariants-reference/public-access/inv-s3-public-001.md) -- General public access check that also covers public listing alongside public read.
