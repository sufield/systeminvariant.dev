...
**ID:** `CTL.S3.PUBLIC.004` **Category:** Public Access **Severity:** High
...
* [`CTL.S3.PUBLIC.001`](/docs/reference/invariants-reference/public-access/inv-s3-public-001.md) -- General check for public read access via any mechanism (policy or ACL).
* [`CTL.S3.ACL.WRITE.001`](/docs/reference/invariants-reference/public-access/inv-s3-acl-write-001.md) -- Checks for public write access via ACL, the write counterpart to this control.
* [`CTL.S3.CONTROLS.001`](/docs/reference/invariants-reference/public-access/inv-s3-controls-001.md) -- Ensures IgnorePublicAcls is enabled, which overrides ACL-based public grants.
