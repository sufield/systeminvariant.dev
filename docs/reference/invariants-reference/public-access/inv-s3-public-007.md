...
**ID:** `CTL.S3.PUBLIC.007` **Category:** Public Access **Severity:** High
...
* [`CTL.S3.PUBLIC.008`](/docs/reference/invariants-reference/public-access/inv-s3-public-008.md) -- The listing counterpart: detects public listing granted via bucket policy.
* [`CTL.S3.PUBLIC.001`](/docs/reference/invariants-reference/public-access/inv-s3-public-001.md) -- Broader check for any public read access regardless of mechanism.
