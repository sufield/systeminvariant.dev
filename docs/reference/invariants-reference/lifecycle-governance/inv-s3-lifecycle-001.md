...
**ID:** `CTL.S3.LIFECYCLE.001` **Category:** Lifecycle and Governance **Severity:** Medium
...
* [`CTL.S3.LIFECYCLE.002`](/docs/reference/invariants-reference/lifecycle-governance/inv-s3-lifecycle-002.md) -- Enforces that PHI buckets do not expire data before the 2190-day HIPAA minimum.
* [`CTL.S3.GOVERNANCE.001`](/docs/reference/invariants-reference/lifecycle-governance/inv-s3-governance-001.md) -- Requires the `data-classification` tag that often accompanies retention tagging.
* [`CTL.S3.VERSION.001`](/docs/reference/invariants-reference/lifecycle-governance/inv-s3-version-001.md) -- Versioning complements lifecycle rules by preserving previous versions before expiration.
