...
## Observation file shape[​](#observation-file-shape "Direct link to Observation file shape")
...
## Resource object[​](#resource-object "Direct link to Resource object")
...
## S3 property groups[​](#s3-property-groups "Direct link to S3 property groups")
...
### Policy (network scope)[​](#policy-network-scope "Direct link to Policy (network scope)")
...
### Object Lock[​](#object-lock "Direct link to Object Lock")
...
## Identity object[​](#identity-object "Direct link to Identity object")
...
* [Observation Schema (`obs.v0.1`)](/docs/reference/schema-obs.md) — the schema envelope, validation rules, and what `stave validate` enforces.
* [Create Observation Snapshots](/docs/how-to/getting-started/create-snapshots.md) — recipes for producing these snapshots from AWS, Terraform, or by hand.
