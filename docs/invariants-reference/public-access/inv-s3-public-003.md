---
title: "No Public Write Access"
sidebar_label: "INV.S3.PUBLIC.003"
sidebar_position: 3
description: "S3 buckets must not allow public write or delete access."
---

# No Public Write Access

**ID:** `INV.S3.PUBLIC.003`
**Category:** Public Access
**Severity:** Critical

## What This Checks

S3 buckets must not allow public write or delete access. This invariant fires when any bucket has `public_write` set to `true`, indicating that anonymous users can upload objects to or delete objects from the bucket.
...
```json
{
  "invariant_id": "INV.S3.PUBLIC.003",
  "invariant_name": "No Public Write Access",
...
- [`INV.S3.ACL.WRITE.001`](inv-s3-acl-write-001.md) -- Specifically checks for write access granted through bucket ACLs to AllUsers or AuthenticatedUsers.
- [`INV.S3.PUBLIC.001`](inv-s3-public-001.md) -- Checks for public read and list access, which often accompanies public write.
- [`INV.S3.CONTROLS.001`](inv-s3-controls-001.md) -- Ensures Public Access Block is enabled to prevent accidental public write exposure.
