---
title: "No Wildcard Action Policies"
sidebar_label: "INV.S3.ACCESS.002"
sidebar_position: 2
description: "S3 bucket policies must not use wildcard actions (s3:* or *)."
---

# No Wildcard Action Policies

**ID:** `INV.S3.ACCESS.002`
...
```json
{
  "invariant_id": "INV.S3.ACCESS.002",
  "invariant_name": "No Wildcard Action Policies",
...
- [`INV.S3.ACCESS.001`](./inv-s3-access-001.md) -- No Unauthorized Cross-Account Access (flags external account principals)
- [`INV.S3.ACCESS.003`](./inv-s3-access-003.md) -- No External Write Access (flags write grants to external accounts)
