...
sidebar_label: "INV.S3.NETWORK.001"
sidebar_position: 5
...
```json
{
  "invariant_id": "INV.S3.NETWORK.001",
  "invariant_name": "Public-Principal Policies Must Have Network Conditions",
...
- [`INV.S3.ACCESS.001`](./inv-s3-access-001.md) -- No Unauthorized Cross-Account Access (flags named external account principals)
- [`INV.S3.ACCESS.002`](./inv-s3-access-002.md) -- No Wildcard Action Policies (flags `s3:*` action grants, which compound the risk of unscoped principals)
- [`INV.S3.PUBLIC.001`](../public-access/inv-s3-public-001.md) -- No Public S3 Buckets (flags public read/list access at the visibility level)
