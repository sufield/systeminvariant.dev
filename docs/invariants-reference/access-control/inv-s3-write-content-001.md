...
sidebar_label: "INV.S3.WRITE.CONTENT.001"
sidebar_position: 8
...
```json
{
  "invariant_id": "INV.S3.WRITE.CONTENT.001",
  "invariant_name": "S3 Signed Upload Must Restrict Content Types",
...
- [`INV.S3.WRITE.SCOPE.001`](./inv-s3-write-scope-001.md) -- S3 Signed Upload Must Bind To Exact Object Key (flags prefix-scoped upload keys, a complementary upload hardening check)
