...
sidebar_label: "INV.S3.ACL.RECON.001"
sidebar_position: 2
...
```json
{
  "invariant_id": "INV.S3.ACL.RECON.001",
  "invariant_name": "No Public ACL Readability",
...
- [`INV.S3.ACL.ESCALATION.001`](./inv-s3-acl-escalation-001.md) -- No Public ACL Modification (the escalation that ACL readability enables reconnaissance for)
- [`INV.S3.ACL.FULLCONTROL.001`](./inv-s3-acl-fullcontrol-001.md) -- No FULL_CONTROL ACL Grants to Public (FULL_CONTROL implies READ_ACP)
