...
* **Verdict produced:** NON\_COMPLIANT when the record resolves to a non-existent, claimable bucket. The 404 and `s3_bucket_exists: false` confirm the unsafe latent state rather than clearing it.
