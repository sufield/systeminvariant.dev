...
* **Verdict produced:** NON\_COMPLIANT. The record resolves but the target name is unowned and claimable; under a `.gov` domain the takeover inherits government trust.
...
| Before                                                                          | After Stave                                                          |
| ------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| Decide whether a 404 `.gov` subdomain is cosmetic or a high-trust takeover risk | A control proves the reference is claimable and emits NON\_COMPLIANT |
