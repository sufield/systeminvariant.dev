# The website endpoint that would serve anyone's index.html
...
* **Verdict produced:** NON\_COMPLIANT. The record resolves to a website endpoint whose bucket name is unowned and claimable.
...
| Before                                                                       | After Stave                                                                  |
| ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| Judge whether a 404 content subdomain is dead or a seamless-lookalike risk   | A control proves the website reference is claimable and emits NON\_COMPLIANT |
