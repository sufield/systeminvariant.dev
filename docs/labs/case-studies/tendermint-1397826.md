# The install command pointing at a bucket someone else could fill
...
* **Verdict produced:** NON\_COMPLIANT. The release domain resolves but its target bucket name is unowned and claimable.
...
| Before                                                                          | After Stave                                                                  |
| ------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| Decide whether a 404 install link is a docs bug or a supply-chain hole          | A control proves the release reference is claimable and emits NON\_COMPLIANT |
