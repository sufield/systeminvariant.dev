...
## Pick the engine[​](#pick-the-engine "Direct link to Pick the engine")
...
If the question doesn't fit one row, you probably want to triangulate: run several engines and look at where they disagree. The [`compare-engines/`](https://github.com/sufield/stave/tree/main/examples/compare-engines) harness automates this.

## Three-step workflow[​](#three-step-workflow "Direct link to Three-step workflow")
...
## Worked example: SMT (Z3)[​](#worked-example-smt-z3 "Direct link to Worked example: SMT (Z3)")
...
## Worked example: Datalog (Soufflé)[​](#worked-example-datalog-soufflé "Direct link to Worked example: Datalog (Soufflé)")
...
## Worked example: SAT (PySAT)[​](#worked-example-sat-pysat "Direct link to Worked example: SAT (PySAT)")
...
## Worked example: ASP (Clingo)[​](#worked-example-asp-clingo "Direct link to Worked example: ASP (Clingo)")
...
## Domain-specific rule files[​](#domain-specific-rule-files "Direct link to Domain-specific rule files")
...
## Running them all at once[​](#running-them-all-at-once "Direct link to Running them all at once")
...
**Soufflé errors with `unrecognized predicate`.** The JSONL predicate name doesn't match the `.decl` line in your `.dl` file. Predicate names are stable per the [Fact Export Reference](/docs/reference/fact-export.md) — use the table there.
...
* [Fact Export Reference](/docs/reference/fact-export.md) — the authoritative format / predicate list
* Tutorial: your first multi-engine analysis — end-to-end walk-through
* [Files as the language boundary](/docs/explanation/files-as-the-boundary.md) — why the architecture is shaped this way
* The runnable engine examples under [`stave/examples/`](https://github.com/sufield/stave/tree/main/examples) — every engine has a self-contained `README.md` + `run.sh`
