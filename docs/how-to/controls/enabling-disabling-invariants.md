...
## 1) Directory-based selection[​](#1-directory-based-selection "Direct link to 1) Directory-based selection")
...
## 2) Built-in packs (project config)[​](#2-built-in-packs-project-config "Direct link to 2) Built-in packs (project config)")
...
## 3) Exclude specific IDs[​](#3-exclude-specific-ids "Direct link to 3) Exclude specific IDs")
...
## 4) CLI filters[​](#4-cli-filters "Direct link to 4) CLI filters")
...
## 5) Ignore resources[​](#5-ignore-resources "Direct link to 5) Ignore resources")
...
## 6) Scope exclusions in control YAML[​](#6-scope-exclusions-in-control-yaml "Direct link to 6) Scope exclusions in control YAML")
