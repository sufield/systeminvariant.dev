# How to Create a Custom Compliance Profile

Define your own compliance framework as a YAML file.

***

## Create the Profile File[​](#create-the-profile-file "Direct link to Create the Profile File")
...
## Use with stave apply[​](#use-with-stave-apply "Direct link to Use with stave apply")

```
stave apply --profile-file dora-profile.yaml --input observations.json
```

## Use with stave export[​](#use-with-stave-export "Direct link to Use with stave export")

```
stave export compliance --profile-file dora-profile.yaml --snapshot observations.json
```

## Inherit from a Built-In Profile[​](#inherit-from-a-built-in-profile "Direct link to Inherit from a Built-In Profile")
...
## Add SLA Deadlines[​](#add-sla-deadlines "Direct link to Add SLA Deadlines")
...
## Validate the Profile[​](#validate-the-profile "Direct link to Validate the Profile")
