...
## Standard mode (any domain)[​](#standard-mode-any-domain "Direct link to Standard mode (any domain)")
...
## Mixing domains in one evaluation[​](#mixing-domains-in-one-evaluation "Direct link to Mixing domains in one evaluation")
...
## Writing observations for non-S3 domains[​](#writing-observations-for-non-s3-domains "Direct link to Writing observations for non-S3 domains")

### IAM observation (account-level)[​](#iam-observation-account-level "Direct link to IAM observation (account-level)")
...
### IAM observation (user-level)[​](#iam-observation-user-level "Direct link to IAM observation (user-level)")
...
### GCS observation[​](#gcs-observation "Direct link to GCS observation")
...
### DNS observation[​](#dns-observation "Direct link to DNS observation")
...
## Property namespace reference[​](#property-namespace-reference "Direct link to Property namespace reference")
...
## Verify binary integrity across domains[​](#verify-binary-integrity-across-domains "Direct link to Verify binary integrity across domains")
