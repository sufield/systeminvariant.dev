...
## 1) Extract IAM observations[​](#1-extract-iam-observations "Direct link to 1) Extract IAM observations")
...
## 2) Evaluate observations against the IAM control pack[​](#2-evaluate-observations-against-the-iam-control-pack "Direct link to 2) Evaluate observations against the IAM control pack")
...
## 3) What the IAM pack covers[​](#3-what-the-iam-pack-covers "Direct link to 3) What the IAM pack covers")
...
## 4) New controls added for IAM failure requirements[​](#4-new-controls-added-for-iam-failure-requirements "Direct link to 4) New controls added for IAM failure requirements")
...
## 5) Shadow Admin detection — the entropy family[​](#5-shadow-admin-detection--the-entropy-family "Direct link to 5) Shadow Admin detection — the entropy family")
...
## 6) Observation shapes[​](#6-observation-shapes "Direct link to 6) Observation shapes")

### User with privilege escalation risk[​](#user-with-privilege-escalation-risk "Direct link to User with privilege escalation risk")
...
### Role without permissions boundary[​](#role-without-permissions-boundary "Direct link to Role without permissions boundary")
...
### MFA monitoring observation[​](#mfa-monitoring-observation "Direct link to MFA monitoring observation")
