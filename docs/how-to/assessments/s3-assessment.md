...
## Golden Path[​](#golden-path "Direct link to Golden Path")
...
## 2) Evaluate observations against the S3 control pack[​](#2-evaluate-observations-against-the-s3-control-pack "Direct link to 2) Evaluate observations against the S3 control pack")
...
## 3) Verify remediation (before vs after)[​](#3-verify-remediation-before-vs-after "Direct link to 3) Verify remediation (before vs after)")
...
## Optional: generate enforcement templates[​](#optional-generate-enforcement-templates "Direct link to Optional: generate enforcement templates")
...
## What the S3 pack covers[​](#what-the-s3-pack-covers "Direct link to What the S3 pack covers")
...
## Vendor delegation governance[​](#vendor-delegation-governance "Direct link to Vendor delegation governance")
