...
## 1) Extract OpenSearch observations[​](#1-extract-opensearch-observations "Direct link to 1) Extract OpenSearch observations")
...
### Key field mapping[​](#key-field-mapping "Direct link to Key field mapping")
...
## 2) Evaluate[​](#2-evaluate "Direct link to 2) Evaluate")
...
## 3) What the OpenSearch pack covers[​](#3-what-the-opensearch-pack-covers "Direct link to 3) What the OpenSearch pack covers")
...
## 4) Breach patterns this prevents[​](#4-breach-patterns-this-prevents "Direct link to 4) Breach patterns this prevents")
...
## 5) Example observation (Darkbeam pattern — unsafe)[​](#5-example-observation-darkbeam-pattern--unsafe "Direct link to 5) Example observation (Darkbeam pattern — unsafe)")
