...
## Context File Format[​](#context-file-format "Direct link to Context File Format")
...
## Supported Breach Types[​](#supported-breach-types "Direct link to Supported Breach Types")
...
### Why disclosure first[​](#why-disclosure-first "Direct link to Why disclosure first")
...
### Without `--context`[​](#without---context "Direct link to without---context")
...
### With `--context` and `breach_type: DISC`[​](#with---context-and-breach_type-disc "Direct link to with---context-and-breach_type-disc")
...
### With `--context` and an unsupported breach type[​](#with---context-and-an-unsupported-breach-type "Direct link to with---context-and-an-unsupported-breach-type")
...
## Skipped Controls in Output[​](#skipped-controls-in-output "Direct link to Skipped Controls in Output")
...
## Worked Example: Disclosure Investigation[​](#worked-example-disclosure-investigation "Direct link to Worked Example: Disclosure Investigation")
