...
| ----------------------------- | ---------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `critical-findings`           | Surface critical/high findings for whatever services appear in the snapshot  | Dynamic control selection based on snapshot contents. No configuration needed — the front door.                                                                                              |
...
### `stave recommend`[​](#stave-recommend "Direct link to stave-recommend")
...
### `stave template init`[​](#stave-template-init "Direct link to stave-template-init")
...
### `stave template verify`[​](#stave-template-verify "Direct link to stave-template-verify")
...
### Change parameters[​](#change-parameters "Direct link to Change parameters")

Edit `stave-values.yaml` directly. Change regions, accounts, severity thresholds. Re-run `stave apply --values ./stave-values.yaml`.

### Disable or add controls[​](#disable-or-add-controls "Direct link to Disable or add controls")
...
### Full customization (eject)[​](#full-customization-eject "Direct link to Full customization (eject)")
...
## How Updates Work[​](#how-updates-work "Direct link to How Updates Work")
...
## Air-Gapped Operation[​](#air-gapped-operation "Direct link to Air-Gapped Operation")
...
## Writing Custom Templates[​](#writing-custom-templates "Direct link to Writing Custom Templates")
