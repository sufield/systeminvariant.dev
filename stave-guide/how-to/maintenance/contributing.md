...
See [`stave-workspace/README.md`](https://github.com/sufield/stave/blob/main/stave-workspace/README.md) for
...
their host (see [README Option 3](https://github.com/sufield/stave/blob/main/README.md#option-3--local-install-contributors-and-power-users)
