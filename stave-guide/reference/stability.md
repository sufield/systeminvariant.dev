...
sidebar_position: 2
description: "Stave's stability commitments, schema versioning, and dependency policy."
---
...
See [Release Security](../explanation/release-security.md#reproducible-builds) for instructions.
