...
This page defines the envelope structure and field types. For the stable contract guarantees see [Observation Contract](observation-contract.md); for the S3 property groups see [Export Schema](observation-export-schema.md).
