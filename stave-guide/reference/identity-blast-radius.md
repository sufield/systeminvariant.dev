---
title: "Identity Blast Radius Reference"
sidebar_label: "Identity Blast Radius"
description: "Observation properties, controls, the identity_blast_radius chain, and example output for identity blast radius."
---

# Identity Blast Radius Reference

Specs for the identity blast radius feature: the observation
properties the extractor populates, the four controls Stave
evaluates against them, the compound chain they participate in, and
example output. For the concept and how it works, see
[Identity Blast Radius](../explanation/identity-blast-radius.md).
