---
title: "stave export-controls"
sidebar_label: "export-controls"
sidebar_position: 95
description: "Export the control catalog for external solver consumption"
---
...
Export the control catalog as a JSON document — each entry carries the
