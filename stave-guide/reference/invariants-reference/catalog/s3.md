...
### CTL.S3.ENCRYPT.PUBLIC.COMPOUND.001
...
- **Type:** unsafe_state
- **Domain:** exposure
- **Compliance:** hipaa: 164.312(a)(2)(iv); nist_800_53_r5: SC-28; pci_dss_v4.0: 3.4.1; soc2: CC6.1;
...
### CTL.S3.ENCRYPT.TLS.VERSION.001
...
- **Type:** unsafe_state
- **Domain:** exposure
- **Compliance:** fedramp_moderate: SC-8; nist_800_53_r5: SC-8; pci_dss_v4.0: 4.2.1; soc2: CC6.1;
...
**Remediation:** Either (a) recreate the destination bucket with the original name and restore the replication IAM role policy, or (b) update the replication rule to point at an existing bucket: aws s3api put-bucket-replication --bucket <source> --replication-configuration file://repl.json. If replication is no longer needed, delete the rule entirely rather than leaving a dangling reference. After repointing, verify by uploading a test object to the source and confirming it appears in the destination.
