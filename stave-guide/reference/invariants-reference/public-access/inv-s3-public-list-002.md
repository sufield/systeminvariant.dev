...
sidebar_label: "CTL.S3.PUBLIC.LIST.002"
sidebar_position: 8
...
- [`CTL.S3.PUBLIC.LIST.001`](inv-s3-public-list-001.md) -- Unconditionally blocks public listing; this control is the softer variant that allows listing with an intent tag.
- [`CTL.S3.PUBLIC.006`](inv-s3-public-006.md) -- Detects latent public listing masked only by Public Access Block.
- [`CTL.S3.PUBLIC.001`](inv-s3-public-001.md) -- General public access check that also covers listing.
