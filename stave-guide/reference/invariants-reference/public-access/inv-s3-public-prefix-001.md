...
sidebar_label: "CTL.S3.PUBLIC.PREFIX.001"
sidebar_position: 15
...
- [`CTL.S3.PUBLIC.001`](inv-s3-public-001.md) -- Broad check for any public read access on the entire bucket.
- [`CTL.S3.PUBLIC.007`](inv-s3-public-007.md) -- Detects public read granted via bucket policy (bucket-wide, not prefix-scoped).
