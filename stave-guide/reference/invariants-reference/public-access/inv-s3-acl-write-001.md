...
sidebar_label: "CTL.S3.ACL.WRITE.001"
sidebar_position: 9
...
- [`CTL.S3.PUBLIC.003`](inv-s3-public-003.md) -- General check for public write access via any mechanism (policy or ACL).
- [`CTL.S3.PUBLIC.004`](inv-s3-public-004.md) -- The read counterpart: checks for ACL-based public read access.
- [`CTL.S3.CONTROLS.001`](inv-s3-controls-001.md) -- Ensures BlockPublicAcls and IgnorePublicAcls are enabled, which override ACL-based public grants.
