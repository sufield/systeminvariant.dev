...
sidebar_label: "CTL.S3.PUBLIC.001"
sidebar_position: 1
...
- [`CTL.S3.PUBLIC.002`](inv-s3-public-002.md) -- Stricter variant for buckets tagged with sensitive data classifications (PHI, PII, confidential).
- [`CTL.S3.PUBLIC.004`](inv-s3-public-004.md) -- Specifically checks ACL-based public read access to AllUsers or AuthenticatedUsers.
- [`CTL.S3.PUBLIC.005`](inv-s3-public-005.md) -- Detects latent public read exposure masked only by Public Access Block.
- [`CTL.S3.CONTROLS.001`](inv-s3-controls-001.md) -- Ensures Public Access Block is fully enabled as defense-in-depth.
