...
sidebar_label: "CTL.S3.PUBLIC.008"
sidebar_position: 8
...
- [`CTL.S3.PUBLIC.007`](inv-s3-public-007.md) -- The read counterpart: detects public read granted via bucket policy.
- [`CTL.S3.PUBLIC.LIST.001`](inv-s3-public-list-001.md) -- Broader check for any public listing regardless of mechanism.
