...
sidebar_label: "CTL.S3.PUBLIC.LIST.001"
sidebar_position: 7
...
- [`CTL.S3.PUBLIC.LIST.002`](inv-s3-public-list-002.md) -- Allows public listing only when explicitly tagged as intended, for buckets that serve public content by design.
- [`CTL.S3.PUBLIC.006`](inv-s3-public-006.md) -- Detects latent public listing masked only by Public Access Block.
- [`CTL.S3.PUBLIC.001`](inv-s3-public-001.md) -- General public access check that also covers public listing alongside public read.
