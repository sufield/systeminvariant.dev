...
sidebar_label: "CTL.S3.PUBLIC.002"
sidebar_position: 2
...
- [`CTL.S3.PUBLIC.001`](inv-s3-public-001.md) -- General check for public access on any bucket, regardless of data classification.
- [`CTL.S3.PUBLIC.003`](inv-s3-public-003.md) -- Checks for public write access, which is critical for any bucket but especially sensitive ones.
- [`CTL.S3.CONTROLS.001`](inv-s3-controls-001.md) -- Ensures Public Access Block is fully enabled, providing defense-in-depth for sensitive buckets.
