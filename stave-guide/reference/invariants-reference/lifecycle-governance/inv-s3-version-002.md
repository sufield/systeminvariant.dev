...
sidebar_label: "CTL.S3.VERSION.002"
sidebar_position: 5
...
- [`CTL.S3.VERSION.001`](inv-s3-version-001.md) -- Versioning must be enabled before MFA delete can be configured.
- [`CTL.S3.LOCK.001`](inv-s3-lock-001.md) -- Object Lock provides an alternative WORM protection mechanism for compliance-tagged buckets.
- [`CTL.S3.GOVERNANCE.001`](inv-s3-governance-001.md) -- The `data-classification` tag works alongside the `backup` tag to enable full control coverage.
