...
sidebar_label: "CTL.S3.LIFECYCLE.002"
sidebar_position: 3
...
- [`CTL.S3.LIFECYCLE.001`](inv-s3-lifecycle-001.md) -- Ensures retention-tagged buckets have lifecycle rules at all; this control checks the rules are long enough.
- [`CTL.S3.LOCK.003`](inv-s3-lock-003.md) -- Enforces the same 2190-day minimum on Object Lock retention for PHI buckets.
- [`CTL.S3.LOCK.002`](inv-s3-lock-002.md) -- Requires COMPLIANCE mode Object Lock for PHI, complementing lifecycle retention with WORM protection.
