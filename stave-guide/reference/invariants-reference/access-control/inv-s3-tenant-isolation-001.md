...
sidebar_label: "CTL.S3.TENANT.ISOLATION.001"
sidebar_position: 6
...
- [`CTL.S3.WRITE.SCOPE.001`](inv-s3-write-scope-001.md) -- S3 Signed Upload Must Bind To Exact Object Key (flags prefix-wide write grants in upload policies)
- [`CTL.S3.ACCESS.003`](inv-s3-access-003.md) -- No External Write Access (flags external write grants that compound tenant isolation failures)
- [`CTL.S3.ACCESS.001`](inv-s3-access-001.md) -- No Unauthorized Cross-Account Access (flags external account access that could bypass tenant boundaries)
