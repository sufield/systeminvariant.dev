...
sidebar_label: "CTL.S3.ACCESS.001"
sidebar_position: 1
...
- [`CTL.S3.ACCESS.003`](inv-s3-access-003.md) -- No External Write Access (stricter: flags write/delete grants to external accounts)
- [`CTL.S3.NETWORK.001`](inv-s3-network-001.md) -- Public-Principal Policies Must Have Network Conditions (flags `Principal: *` without network scoping)
- [`CTL.S3.ACCESS.002`](inv-s3-access-002.md) -- No Wildcard Action Policies (flags overly broad action grants)
