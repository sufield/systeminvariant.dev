...
sidebar_label: "CTL.S3.ACCESS.002"
sidebar_position: 2
...
- [`CTL.S3.ACCESS.001`](inv-s3-access-001.md) -- No Unauthorized Cross-Account Access (flags external account principals)
- [`CTL.S3.ACCESS.003`](inv-s3-access-003.md) -- No External Write Access (flags write grants to external accounts)
