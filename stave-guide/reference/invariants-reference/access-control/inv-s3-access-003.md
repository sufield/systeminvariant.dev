...
sidebar_label: "CTL.S3.ACCESS.003"
sidebar_position: 3
...
- [`CTL.S3.ACCESS.001`](inv-s3-access-001.md) -- No Unauthorized Cross-Account Access (flags any cross-account access, including read)
- [`CTL.S3.WRITE.SCOPE.001`](inv-s3-write-scope-001.md) -- S3 Signed Upload Must Bind To Exact Object Key (flags overly broad write scope in signed upload policies)
