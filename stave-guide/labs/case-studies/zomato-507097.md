...
sidebar_label: "Zomato #507097"
sidebar_position: 5
description: "A bucket of user chat images is open by both ACL and policy, with listing on — can you tell from the config that the privacy harm comes from enumeration, not just read?"
---
...
Stave normalizes this into a bucket asset carrying the ACL grants and the policy
statement, with the read action and the list action evaluated as distinct
grants against their respective ARNs.
